...
namespace ACRealms.Tests.Fixtures.Network
{
    class FakeSession : ISession
    {
        ...
        public FakeSession(ConnectionListener connectionListener, IPEndPoint endPoint, ushort clientId, ushort serverId)
        {
            EndPointC2S = endPoint;
            Network = new FakeNetworkSession(this, connectionListener, clientId, serverId);
        }
