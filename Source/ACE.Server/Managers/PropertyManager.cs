...
namespace ACE.Server.Managers
{
    ...
    public static class DefaultPropertyManager
    {
        ...
        public static readonly ReadOnlyDictionary<string, Property<string>> DefaultStringProperties =
            DictOf(
                ("content_folder", new Property<string>("C:\\Users\\node_\\projects\\escape-from-dereth\\packages\\content\\ac-realms-content", "for content creators to live edit weenies. defaults to Content folder found in same directory as ACE.Server.dll")),
