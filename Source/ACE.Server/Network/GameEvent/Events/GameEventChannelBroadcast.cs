...
namespace ACE.Server.Network.GameEvent.Events
{
    ...
    {
        public GameEventChannelBroadcast(ISession session, Channel chatChannel, string senderName, string messageText) : base(GameEventType.ChannelBroadcast, GameMessageGroup.UIQueue, session)
        {
