...
namespace ACE.Server.Network.GameEvent
{
    public abstract class GameEventMessage : GameMessage
    {
        ...
        protected GameEventMessage(GameEventType eventType, GameMessageGroup group, ISession session) : base(GameMessageOpcode.GameEvent, group)
        {
            EventType = eventType;
            Session = session;
        ...
        /// </param>
        protected GameEventMessage(GameEventType eventType, GameMessageGroup group, ISession session, int dataInitialCapacity) : base(GameMessageOpcode.GameEvent, group, dataInitialCapacity)
        {
            EventType = eventType;
            Session = session;
