...
public readonly partial struct RealmPropertySchema
{
    ...
    /// </summary>
    public readonly partial struct ObjPropEntity : IJsonObject<ObjPropEntity>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "ObjPropEntity"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ObjPropEntity(ImmutableList<JsonObjectProperty> value)
        {
        ...
        public static implicit operator ObjPropEntity(JsonObject value)
        {
        ...
        public static ObjPropEntity FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
        {
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static ObjPropEntity FromProperties(ImmutableList<JsonObjectProperty> source)
        {
            return new(source);
        }
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static ObjPropEntity FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
        {
        ...
        /// <inheritdoc/>
        public ObjPropEntity SetProperty<TValue>(in JsonPropertyName name, TValue value)
        ...
        /// <inheritdoc/>
        public ObjPropEntity RemoveProperty(in JsonPropertyName name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public ObjPropEntity RemoveProperty(string name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public ObjPropEntity RemoveProperty(ReadOnlySpan<char> name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public ObjPropEntity RemoveProperty(ReadOnlySpan<byte> utf8Name)
        {
