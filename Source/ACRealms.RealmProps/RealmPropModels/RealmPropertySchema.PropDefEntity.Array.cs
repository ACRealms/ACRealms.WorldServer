...
[CollectionBuilder(typeof(PropDefEntity), "Create")]
public readonly partial struct PropDefEntity : IJsonArray<PropDefEntity>, IReadOnlyCollection<JsonAny>
#else
    public readonly partial struct PropDefEntity : IJsonArray<PropDefEntity>, IReadOnlyCollection<JsonAny>
#endif
    {
        ...
        /// Gets an empty array.
        /// </summary>
        public static readonly PropDefEntity EmptyArray = From(ImmutableList<JsonAny>.Empty);
        /// <summary>
        /// Initializes a new instance of the <see cref = "PropDefEntity"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public PropDefEntity(ImmutableList<JsonAny> value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public PropDefEntity(IEnumerable<JsonAny> value)
        {
            this.jsonElementBacking = default;
            this.backing = Backing.Array;
            this.stringBacking = string.Empty;
        ...
        public static implicit operator ImmutableList<JsonAny>(PropDefEntity value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator PropDefEntity(ImmutableList<JsonAny> value)
        {
            return new(value);
        }
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator PropDefEntity(JsonArray value)
        {
        ...
        public static PropDefEntity From(ImmutableList<JsonAny> items)
        {
            return new(items);
        }
        ...
        public static PropDefEntity Create(ReadOnlySpan<JsonAny> items)
        {
            return new([..items]);
        }
        ...
        public static PropDefEntity FromItems(params JsonAny[] value)
        {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A PropDefEntity instantiated from the given items.</returns>
        public static PropDefEntity FromItems<TItem>(params TItem[] value)
        ...
        /// <returns>A PropDefEntity instantiated from the given items.</returns>
        public static PropDefEntity FromItems<TItem1>(in TItem1 value1)
        ...
        /// <returns>A PropDefEntity instantiated from the given items.</returns>
        public static PropDefEntity FromItems<TItem1, TItem2>(in TItem1 value1, in TItem2 value2)
        ...
        /// <returns>A PropDefEntity instantiated from the given items.</returns>
        public static PropDefEntity FromItems<TItem1, TItem2, TItem3>(in TItem1 value1, in TItem2 value2, in TItem3 value3)
        ...
        /// </remarks>
        public static PropDefEntity From<T>(IEnumerable<T> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            return new PropDefEntity(builder.ToImmutable());
        }
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static PropDefEntity FromRange(IEnumerable<JsonAny> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static PropDefEntity FromRange<T>(IEnumerable<T> items)
        ...
        /// <param name = "items">The items from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static PropDefEntity FromRange(IEnumerable<string> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// <param name = "items">The items from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static PropDefEntity FromRange(IEnumerable<double> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// <param name = "items">The items from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static PropDefEntity FromRange(IEnumerable<float> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// <param name = "items">The items from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static PropDefEntity FromRange(IEnumerable<int> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// <param name = "items">The items from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static PropDefEntity FromRange(IEnumerable<long> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// <param name = "items">The items from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static PropDefEntity FromRange(IEnumerable<bool> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// <param name = "value1">The first value from which to construct the instance.</param>
        /// <returns>A PropDefEntity instantiated from the given items.</returns>
        public static PropDefEntity FromItems(in JsonAny value1)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1);
            return new(builder.ToImmutable());
        ...
        /// <param name = "value2">The second value from which to construct the instance.</param>
        /// <returns>A PropDefEntity instantiated from the given items.</returns>
        public static PropDefEntity FromItems(in JsonAny value1, in JsonAny value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1);
            builder.Add(value2);
        ...
        /// <param name = "value3">The thirdvalue from which to construct the instance.</param>
        /// <returns>A PropDefEntity instantiated from the given items.</returns>
        public static PropDefEntity FromItems(in JsonAny value1, in JsonAny value2, in JsonAny value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1);
            builder.Add(value2);
