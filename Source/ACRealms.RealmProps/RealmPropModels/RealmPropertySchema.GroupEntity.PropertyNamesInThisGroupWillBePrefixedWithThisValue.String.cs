...
public readonly partial struct RealmPropertySchema
{
    ...
    : IJsonString<PropertyNamesInThisGroupWillBePrefixedWithThisValue>, ISpanFormattable
#else
        : IJsonString<PropertyNamesInThisGroupWillBePrefixedWithThisValue>
#endif
        {
            /// <summary>
            ...
            /// <summary>
            /// Concatenate two JSON values, producing an instance of the string type PropertyNamesInThisGroupWillBePrefixedWithThisValue.
            /// </summary>
            ...
            public static PropertyNamesInThisGroupWillBePrefixedWithThisValue Concatenate<T1, T2>(Span<byte> buffer, in T1 firstValue, in T2 secondValue)
            ...
            /// <summary>
            /// Concatenate three JSON values, producing an instance of the string type PropertyNamesInThisGroupWillBePrefixedWithThisValue.
            /// </summary>
            /// <typeparam name = "T1">The type of the first value.</typeparam>
            /// <typeparam name = "T2">The type of the second value.</typeparam>
            ...
            /// <returns>An instance of this string type.</returns>
            public static PropertyNamesInThisGroupWillBePrefixedWithThisValue Concatenate<T1, T2, T3>(Span<byte> buffer, in T1 firstValue, in T2 secondValue, in T3 thirdValue)
            ...
            /// <summary>
            /// Concatenate four JSON values, producing an instance of the string type PropertyNamesInThisGroupWillBePrefixedWithThisValue.
            /// </summary>
            /// <typeparam name = "T1">The type of the first value.</typeparam>
            /// <typeparam name = "T2">The type of the second value.</typeparam>
            /// <typeparam name = "T3">The type of the third value.</typeparam>
            ...
            /// <returns>An instance of this string type.</returns>
            public static PropertyNamesInThisGroupWillBePrefixedWithThisValue Concatenate<T1, T2, T3, T4>(Span<byte> buffer, in T1 firstValue, in T2 secondValue, in T3 thirdValue, in T4 fourthValue)
            ...
            /// <summary>
            /// Concatenate five JSON values, producing an instance of the string type PropertyNamesInThisGroupWillBePrefixedWithThisValue.
            /// </summary>
            /// <typeparam name = "T1">The type of the first value.</typeparam>
            /// <typeparam name = "T2">The type of the second value.</typeparam>
            /// <typeparam name = "T3">The type of the third value.</typeparam>
            ...
            /// <returns>An instance of this string type.</returns>
            public static PropertyNamesInThisGroupWillBePrefixedWithThisValue Concatenate<T1, T2, T3, T4, T5>(Span<byte> buffer, in T1 firstValue, in T2 secondValue, in T3 thirdValue, in T4 fourthValue, in T5 fifthValue)
            ...
            /// <summary>
            /// Concatenate six JSON values, producing an instance of the string type PropertyNamesInThisGroupWillBePrefixedWithThisValue.
            /// </summary>
            /// <typeparam name = "T1">The type of the first value.</typeparam>
            /// <typeparam name = "T2">The type of the second value.</typeparam>
            /// <typeparam name = "T3">The type of the third value.</typeparam>
            ...
            /// <returns>An instance of this string type.</returns>
            public static PropertyNamesInThisGroupWillBePrefixedWithThisValue Concatenate<T1, T2, T3, T4, T5, T6>(Span<byte> buffer, in T1 firstValue, in T2 secondValue, in T3 thirdValue, in T4 fourthValue, in T5 fifthValue, in T6 sixthValue)
            ...
            /// <summary>
            /// Concatenate seven JSON values, producing an instance of the string type PropertyNamesInThisGroupWillBePrefixedWithThisValue.
            /// </summary>
            /// <typeparam name = "T1">The type of the first value.</typeparam>
            /// <typeparam name = "T2">The type of the second value.</typeparam>
            /// <typeparam name = "T3">The type of the third value.</typeparam>
            ...
            /// <returns>An instance of this string type.</returns>
            public static PropertyNamesInThisGroupWillBePrefixedWithThisValue Concatenate<T1, T2, T3, T4, T5, T6, T7>(Span<byte> buffer, in T1 firstValue, in T2 secondValue, in T3 thirdValue, in T4 fourthValue, in T5 fifthValue, in T6 sixthValue, in T7 seventhValue)
            ...
            /// <summary>
            /// Concatenate eight JSON values, producing an instance of the string type PropertyNamesInThisGroupWillBePrefixedWithThisValue.
            /// </summary>
            /// <typeparam name = "T1">The type of the first value.</typeparam>
            /// <typeparam name = "T2">The type of the second value.</typeparam>
            /// <typeparam name = "T3">The type of the third value.</typeparam>
            ...
            /// <returns>An instance of this string type.</returns>
            public static PropertyNamesInThisGroupWillBePrefixedWithThisValue Concatenate<T1, T2, T3, T4, T5, T6, T7, T8>(Span<byte> buffer, in T1 firstValue, in T2 secondValue, in T3 thirdValue, in T4 fourthValue, in T5 fifthValue, in T6 sixthValue, in T7 seventhValue, in T8 eighthValue)
