...
[CollectionBuilder(typeof(ObjPropListForGroupEntity), "Create")]
public readonly partial struct ObjPropListForGroupEntity : IJsonArray<ObjPropListForGroupEntity>, IReadOnlyCollection<JsonAny>
#else
    public readonly partial struct ObjPropListForGroupEntity : IJsonArray<ObjPropListForGroupEntity>, IReadOnlyCollection<JsonAny>
#endif
    {
        ...
        /// Gets an empty array.
        /// </summary>
        public static readonly ObjPropListForGroupEntity EmptyArray = From(ImmutableList<JsonAny>.Empty);
        /// <summary>
        /// Initializes a new instance of the <see cref = "ObjPropListForGroupEntity"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ObjPropListForGroupEntity(ImmutableList<JsonAny> value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ObjPropListForGroupEntity(IEnumerable<JsonAny> value)
        {
            this.jsonElementBacking = default;
            this.backing = Backing.Array;
        ...
        public static implicit operator ImmutableList<JsonAny>(ObjPropListForGroupEntity value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ObjPropListForGroupEntity(ImmutableList<JsonAny> value)
        {
            return new(value);
        }
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ObjPropListForGroupEntity(JsonArray value)
        {
        ...
        public static ObjPropListForGroupEntity From(ImmutableList<JsonAny> items)
        {
            return new(items);
        }
        ...
        public static ObjPropListForGroupEntity Create(ReadOnlySpan<JsonAny> items)
        {
            return new([..items]);
        }
        ...
        public static ObjPropListForGroupEntity FromItems(params JsonAny[] value)
        {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A ObjPropListForGroupEntity instantiated from the given items.</returns>
        public static ObjPropListForGroupEntity FromItems<TItem>(params TItem[] value)
        ...
        /// <returns>A ObjPropListForGroupEntity instantiated from the given items.</returns>
        public static ObjPropListForGroupEntity FromItems<TItem1>(in TItem1 value1)
        ...
        /// <returns>A ObjPropListForGroupEntity instantiated from the given items.</returns>
        public static ObjPropListForGroupEntity FromItems<TItem1, TItem2>(in TItem1 value1, in TItem2 value2)
        ...
        /// <returns>A ObjPropListForGroupEntity instantiated from the given items.</returns>
        public static ObjPropListForGroupEntity FromItems<TItem1, TItem2, TItem3>(in TItem1 value1, in TItem2 value2, in TItem3 value3)
        ...
        /// </remarks>
        public static ObjPropListForGroupEntity From<T>(IEnumerable<T> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            return new ObjPropListForGroupEntity(builder.ToImmutable());
        }
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static ObjPropListForGroupEntity FromRange(IEnumerable<JsonAny> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static ObjPropListForGroupEntity FromRange<T>(IEnumerable<T> items)
        ...
        /// <param name = "items">The items from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static ObjPropListForGroupEntity FromRange(IEnumerable<string> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// <param name = "items">The items from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static ObjPropListForGroupEntity FromRange(IEnumerable<double> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// <param name = "items">The items from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static ObjPropListForGroupEntity FromRange(IEnumerable<float> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// <param name = "items">The items from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static ObjPropListForGroupEntity FromRange(IEnumerable<int> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// <param name = "items">The items from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static ObjPropListForGroupEntity FromRange(IEnumerable<long> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// <param name = "items">The items from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static ObjPropListForGroupEntity FromRange(IEnumerable<bool> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// <param name = "value1">The first value from which to construct the instance.</param>
        /// <returns>A ObjPropListForGroupEntity instantiated from the given items.</returns>
        public static ObjPropListForGroupEntity FromItems(in JsonAny value1)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1);
            return new(builder.ToImmutable());
        ...
        /// <param name = "value2">The second value from which to construct the instance.</param>
        /// <returns>A ObjPropListForGroupEntity instantiated from the given items.</returns>
        public static ObjPropListForGroupEntity FromItems(in JsonAny value1, in JsonAny value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1);
            builder.Add(value2);
        ...
        /// <param name = "value3">The thirdvalue from which to construct the instance.</param>
        /// <returns>A ObjPropListForGroupEntity instantiated from the given items.</returns>
        public static ObjPropListForGroupEntity FromItems(in JsonAny value1, in JsonAny value2, in JsonAny value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1);
            builder.Add(value2);
