...
/// </summary>
public readonly partial struct RealmPropertySchema : IJsonObject<RealmPropertySchema>
{
    /// <summary>
    ...
    /// <inheritdoc/>
    public RealmPropertySchema RemoveProperty(ReadOnlySpan<byte> utf8Name)
    {
