...
public readonly partial struct RealmPropertySchema
{
    public readonly partial struct ObjPropOrGroupEntity
    {
        ...
        public readonly partial struct RerollRestrictedToEntity
        {
            ...
            public static implicit operator RerollRestrictedToEntity(in JsonAny value)
            {
            ...
            /// <param name = "value">The value from which to convert.</param>
            /// <exception cref = "InvalidOperationException">The value was not compatible with this type.</exception>
            public static implicit operator JsonAny(in RerollRestrictedToEntity value)
            {
                return value.AsAny;
            }
    ...
    /// <remarks>This will be RerollRestrictedToEntity.Undefined if the type is not compatible.</remarks>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    static RerollRestrictedToEntity IJsonValue<RerollRestrictedToEntity>.FromObject<TValue>(in TValue value)
    {
        ...
        return Undefined;
...
#endif
            /// <summary>
            /// Parses a JSON string into a RerollRestrictedToEntity.
            /// </summary>
            /// <param name = "json">The json string to parse.</param>
            /// <param name = "options">The (optional) JsonDocumentOptions.</param>
            /// <returns>A <see cref = "RerollRestrictedToEntity"/> instance built from the JSON string.</returns>
            public static RerollRestrictedToEntity Parse(string json, JsonDocumentOptions options = default)
            {
                using var jsonDocument = JsonDocument.Parse(json, options);
                return new RerollRestrictedToEntity(jsonDocument.RootElement.Clone());
            }
            ...
            /// <param name = "options">The (optional) JsonDocumentOptions.</param>
            /// <returns>A <see cref = "RerollRestrictedToEntity"/> instance built from the JSON string.</returns>
            public static RerollRestrictedToEntity Parse(Stream utf8Json, JsonDocumentOptions options = default)
            {
            ...
            /// <param name = "options">The (optional) JsonDocumentOptions.</param>
            /// <returns>A <see cref = "RerollRestrictedToEntity"/> instance built from the JSON string.</returns>
            public static RerollRestrictedToEntity Parse(ReadOnlyMemory<byte> utf8Json, JsonDocumentOptions options = default)
            {
                using var jsonDocument = JsonDocument.Parse(utf8Json, options);
                return new RerollRestrictedToEntity(jsonDocument.RootElement.Clone());
            }
            ...
            /// <param name = "options">The (optional) JsonDocumentOptions.</param>
            /// <returns>A <see cref = "RerollRestrictedToEntity"/> instance built from the JSON string.</returns>
            public static RerollRestrictedToEntity Parse(ReadOnlyMemory<char> json, JsonDocumentOptions options = default)
            {
                using var jsonDocument = JsonDocument.Parse(json, options);
                return new RerollRestrictedToEntity(jsonDocument.RootElement.Clone());
            }
            ...
            /// <param name = "options">The (optional) JsonDocumentOptions.</param>
            /// <returns>A <see cref = "RerollRestrictedToEntity"/> instance built from the JSON string.</returns>
            public static RerollRestrictedToEntity Parse(ReadOnlySequence<byte> utf8Json, JsonDocumentOptions options = default)
            {
                using var jsonDocument = JsonDocument.Parse(utf8Json, options);
                return new RerollRestrictedToEntity(jsonDocument.RootElement.Clone());
            }
            ...
            static RerollRestrictedToEntity ParseValue(ReadOnlySpan<char> buffer)
            {
#if NET8_0_OR_GREATER
        return IJsonValue<RerollRestrictedToEntity>.ParseValue(buffer);
#else
                return JsonValueHelpers.ParseValue<RerollRestrictedToEntity>(buffer);
#endif
            }
            ...
            /// <param name = "buffer">The buffer from which to parse the value.</param>
            /// <returns>The parsed value.</returns>
            static RerollRestrictedToEntity ParseValue(ReadOnlySpan<byte> buffer)
            {
#if NET8_0_OR_GREATER
        return IJsonValue<RerollRestrictedToEntity>.ParseValue(buffer);
#else
            ...
            /// <returns>The parsed value.</returns>
            static RerollRestrictedToEntity ParseValue(ref Utf8JsonReader reader)
            {
#if NET8_0_OR_GREATER
        return IJsonValue<RerollRestrictedToEntity>.ParseValue(ref reader);
#else
                return JsonValueHelpers.ParseValue<RerollRestrictedToEntity>(ref reader);
#endif
            }
