    ...
    public readonly partial struct ObjPropListEntity
    {
        ...
        public readonly partial struct PropertyNamesEntity
        {
            private ValidationContext ValidateAllOf(in ValidationContext validationContext, ValidationLevel level)
            {
                ...
                ValidationContext allOfResult0 = this.As<ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.PropNameEntity>().Validate(childContext0.CreateChildContext(), level);
