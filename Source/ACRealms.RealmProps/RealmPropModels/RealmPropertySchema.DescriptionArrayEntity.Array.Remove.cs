...
public readonly partial struct RealmPropertySchema
{
    ...
    public readonly partial struct DescriptionArrayEntity
    {
        ...
        DescriptionArrayEntity IJsonArray<DescriptionArrayEntity>.Remove(in JsonAny item1)
        {
        ...
        public DescriptionArrayEntity Remove(in ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.DescriptionArrayEntity.DescriptionArrayDescriptionArrayEntity item)
        {
        ...
        /// <inheritdoc/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public DescriptionArrayEntity RemoveAt(int index)
        {
        ...
        /// <inheritdoc/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public DescriptionArrayEntity RemoveRange(int index, int count)
        {
