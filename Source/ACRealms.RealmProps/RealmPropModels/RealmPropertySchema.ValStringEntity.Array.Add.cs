...
public readonly partial struct RealmPropertySchema
{
    ...
    {
        /// <inheritdoc/>
        public ValStringEntity Add(in JsonAny item1)
        {
        ...
        /// <inheritdoc/>
        public ValStringEntity Add(params JsonAny[] items)
        {
            ImmutableList<JsonAny>.Builder builder = this.GetImmutableListBuilder();
        ...
        /// <inheritdoc/>
        public ValStringEntity AddRange<TArray>(in TArray items)
        ...
        /// <inheritdoc/>
        public ValStringEntity AddRange<TItem>(IEnumerable<TItem> items)
        ...
        /// <inheritdoc/>
        public ValStringEntity AddRange(IEnumerable<JsonAny> items)
        {
            ImmutableList<JsonAny>.Builder builder = this.GetImmutableListBuilder();
            builder.AddRange(items);
            return new(builder.ToImmutable());
        ...
        /// <inheritdoc/>
        public ValStringEntity Insert(int index, in JsonAny item1)
        {
            return new(this.GetImmutableListWith(index, item1));
        }

        /// <inheritdoc/>
        public ValStringEntity InsertRange<TArray>(int index, in TArray items)
            where TArray : struct, IJsonArray<TArray>
        {
        ...
        /// <inheritdoc/>
        public ValStringEntity InsertRange<TItem>(int index, IEnumerable<TItem> items)
            where TItem : struct, IJsonValue<TItem>
        {
        ...
        /// <inheritdoc/>
        public ValStringEntity InsertRange(int index, IEnumerable<JsonAny> items)
        {
            return new(this.GetImmutableListWith(index, items));
        }

        /// <inheritdoc/>
        public ValStringEntity Replace(in JsonAny oldValue, in JsonAny newValue)
        {
            return new(this.GetImmutableListReplacing(oldValue.AsAny, newValue.AsAny));
        }

        /// <inheritdoc/>
        public ValStringEntity SetItem(int index, in JsonAny value)
        {
