...
public readonly partial struct RealmPropertySchema
{
    ...
    /// </summary>
    public readonly partial struct PropDefEntity : IJsonObject<PropDefEntity>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "PropDefEntity"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public PropDefEntity(ImmutableList<JsonObjectProperty> value)
        {
        ...
        public static implicit operator PropDefEntity(JsonObject value)
        {
        ...
        public static PropDefEntity FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
        {
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static PropDefEntity FromProperties(ImmutableList<JsonObjectProperty> source)
        {
            return new(source);
        }
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static PropDefEntity FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
        {
        ...
        /// <inheritdoc/>
        public PropDefEntity SetProperty<TValue>(in JsonPropertyName name, TValue value)
        ...
        /// <inheritdoc/>
        public PropDefEntity RemoveProperty(in JsonPropertyName name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public PropDefEntity RemoveProperty(string name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public PropDefEntity RemoveProperty(ReadOnlySpan<char> name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public PropDefEntity RemoveProperty(ReadOnlySpan<byte> utf8Name)
        {
