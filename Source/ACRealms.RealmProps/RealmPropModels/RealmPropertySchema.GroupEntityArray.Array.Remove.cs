...
public readonly partial struct RealmPropertySchema
{
    ...
    public readonly partial struct GroupEntityArray
    {
        ...
        GroupEntityArray IJsonArray<GroupEntityArray>.Remove(in JsonAny item1)
        {
        ...
        public GroupEntityArray Remove(in ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.GroupEntity item)
        {
        ...
        /// <inheritdoc/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public GroupEntityArray RemoveAt(int index)
        {
        ...
        /// <inheritdoc/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public GroupEntityArray RemoveRange(int index, int count)
        {
