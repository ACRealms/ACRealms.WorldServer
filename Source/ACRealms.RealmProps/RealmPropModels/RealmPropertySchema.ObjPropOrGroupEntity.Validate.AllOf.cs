...
public readonly partial struct RealmPropertySchema
{
    ...
    public readonly partial struct ObjPropOrGroupEntity
    {
        private ValidationContext ValidateAllOf(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext allOfResult0 = this.As<ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.ObjPropOrGroupEntity.AllOf0Entity>().Validate(childContext0.CreateChildContext(), level);
            ...
            ValidationContext allOfResult1 = this.As<ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.ObjPropOrGroupEntity.AllOf1Entity>().Validate(childContext1.CreateChildContext(), level);
            ...
            ValidationContext allOfResult2 = this.As<ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.ObjPropOrGroupEntity.AllOf2Entity>().Validate(childContext2.CreateChildContext(), level);
            ...
            ValidationContext allOfResult3 = this.As<ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.ObjPropOrGroupEntity.AllOf3Entity>().Validate(childContext3.CreateChildContext(), level);
            ...
            ValidationContext allOfResult4 = this.As<ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.ObjPropOrGroupEntity.AllOf4Entity>().Validate(childContext4.CreateChildContext(), level);
            ...
            ValidationContext allOfResult5 = this.As<ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.ObjPropOrGroupEntity.AllOf5Entity>().Validate(childContext5.CreateChildContext(), level);
            ...
            ValidationContext allOfResult6 = this.As<ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.ObjPropOrGroupEntity.AllOf6Entity>().Validate(childContext6.CreateChildContext(), level);
