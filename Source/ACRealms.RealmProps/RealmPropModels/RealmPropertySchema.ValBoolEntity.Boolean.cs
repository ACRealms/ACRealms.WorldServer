...
public readonly partial struct RealmPropertySchema
{
    ...
    /// </summary>
    public readonly partial struct ValBoolEntity : IJsonBoolean<ValBoolEntity>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "ValBoolEntity"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ValBoolEntity(bool value)
        {
        ...
        public static implicit operator ValBoolEntity(JsonBoolean value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ValBoolEntity(bool value)
        {
            return new(value);
        }
        ...
        public static implicit operator bool (ValBoolEntity value)
        {
