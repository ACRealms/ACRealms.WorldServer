    ...
    public readonly partial struct ObjPropOrGroupEntity
    {
        public readonly partial struct AllOf2Entity
        {
            ...
            public readonly partial struct ThenEntity
            {
                ...
                /// </summary>
                public static ThenEntity Create(ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.ValIntEntity? @default = null, ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.ValIntEntity? maxValue = null, ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.ValIntEntity? minValue = null)
                {
                ...
                public ThenEntity WithDefault(in ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.ValIntEntity value)
                {
                ...
                /// <param name = "value">The value to set.</param>
                /// <returns>The entity with the updated property.</returns>
                public ThenEntity WithMaxValue(in ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.ValIntEntity value)
                {
                ...
                /// <param name = "value">The value to set.</param>
                /// <returns>The entity with the updated property.</returns>
                public ThenEntity WithMinValue(in ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.ValIntEntity value)
                {
                ...
                {
                    return property.ValueAs<ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.ValIntEntity>().Validate(validationContext, level);
                }
