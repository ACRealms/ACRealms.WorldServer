...
public readonly partial struct RealmPropertySchema
{
    ...
    public readonly partial struct ValDescriptionEntity
    {
        ...
        public ValDescriptionEntity Remove(in JsonAny item1)
        {
        ...
        /// <inheritdoc/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public ValDescriptionEntity RemoveAt(int index)
        {
        ...
        /// <inheritdoc/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public ValDescriptionEntity RemoveRange(int index, int count)
        {
