...
public readonly partial struct RealmPropertySchema
{
    public readonly partial struct GroupEntity
    {
        ...
        public readonly partial struct PropertyNamesInThisGroupWillBeSuffixedWithThisValue
        {
            ...
            public static implicit operator ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.PropNameEntity(PropertyNamesInThisGroupWillBeSuffixedWithThisValue value)
            {
            ...
            /// </summary>
            /// <param name = "value">The value from which to convert.</param>
            public static explicit operator PropertyNamesInThisGroupWillBeSuffixedWithThisValue(ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.PropNameEntity value)
            {
