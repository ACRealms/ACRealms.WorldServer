...
: IJsonNumber<ValFloatEntity>,
  IAdditionOperators<ValFloatEntity, ValFloatEntity, ValFloatEntity>,
  ISubtractionOperators<ValFloatEntity, ValFloatEntity, ValFloatEntity>,
  IMultiplyOperators<ValFloatEntity, ValFloatEntity, ValFloatEntity>,
  IDivisionOperators<ValFloatEntity, ValFloatEntity, ValFloatEntity>,
  IIncrementOperators<ValFloatEntity>,
  IDecrementOperators<ValFloatEntity>
#else
    : IJsonNumber<ValFloatEntity>
#endif
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "ValFloatEntity"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ValFloatEntity(in BinaryJsonNumber value)
        {
        ...
        public ValFloatEntity(double value) : this(new BinaryJsonNumber(value))
        {
        }
        ...
        public static implicit operator ValFloatEntity(JsonNumber value)
        {
        ...
        public static explicit operator byte (ValFloatEntity value)
        {
        ...
        public static explicit operator decimal (ValFloatEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        public static explicit operator double (ValFloatEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        public static explicit operator short (ValFloatEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        public static explicit operator int (ValFloatEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        public static explicit operator long (ValFloatEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
    ...
    /// <exception cref="InvalidOperationException">The value was not a number.</exception>
    /// <exception cref="FormatException">The value was not formatted as an Int64.</exception>
    public static explicit operator Int128(ValFloatEntity value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
        ...
        public static explicit operator sbyte (ValFloatEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
    ...
    public static explicit operator Half(ValFloatEntity value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
        ...
        /// <exception cref = "InvalidOperationException">The value was not a number.</exception>
        /// <exception cref = "FormatException">The value was not formatted as a Single.</exception>
        public static explicit operator float (ValFloatEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        public static explicit operator ushort (ValFloatEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        public static explicit operator uint (ValFloatEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        public static explicit operator ulong (ValFloatEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
    ...
    /// <exception cref="InvalidOperationException">The value was not a number.</exception>
    /// <exception cref="FormatException">The value was not formatted as an UInt64.</exception>
    public static explicit operator UInt128(ValFloatEntity value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static explicit operator ValFloatEntity(decimal value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static explicit operator ValFloatEntity(double value)
        {
            return new(new BinaryJsonNumber(value));
        }
    ...
    /// </summary>
    /// <param name="value">The value to convert.</param>
    public static explicit operator ValFloatEntity(Half value)
    {
        return new(new BinaryJsonNumber(value));
    }
#endif
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static explicit operator ValFloatEntity(float value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static explicit operator ValFloatEntity(byte value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static explicit operator ValFloatEntity(short value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static explicit operator ValFloatEntity(int value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static explicit operator ValFloatEntity(long value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static explicit operator ValFloatEntity(sbyte value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static explicit operator ValFloatEntity(ushort value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static explicit operator ValFloatEntity(uint value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static explicit operator ValFloatEntity(ulong value)
        {
            return new(new BinaryJsonNumber(value));
        }
    ...
    /// </summary>
    /// <param name="value">The value to convert.</param>
    public static explicit operator ValFloatEntity(Int128 value)
    {
        return new(new BinaryJsonNumber(value));
    }
    ...
    /// </summary>
    /// <param name="value">The value to convert.</param>
    public static explicit operator ValFloatEntity(UInt128 value)
    {
        return new(new BinaryJsonNumber(value));
    }
#endif
        ...
        public static bool operator <(in ValFloatEntity left, in ValFloatEntity right)
        {
        ...
        public static ValFloatEntity operator +(ValFloatEntity left, ValFloatEntity right)
        {
        ...
        /// <returns>The resulting value.</returns>
        public static ValFloatEntity operator ++(ValFloatEntity value)
        {
        ...
        public static int Compare(in ValFloatEntity lhs, in ValFloatEntity rhs)
        {
