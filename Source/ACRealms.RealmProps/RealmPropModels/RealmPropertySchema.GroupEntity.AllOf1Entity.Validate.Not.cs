    ...
    public readonly partial struct GroupEntity
    {
        ...
        public readonly partial struct AllOf1Entity
        {
            private ValidationContext ValidateNot(ValidationContext validationContext, ValidationLevel level)
            {
                ...
                ValidationContext notResult = this.As<ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.GroupEntity.AllOf1Entity.RequiredDefaultFromServerProperty>().Validate(validationContext.CreateChildContext(), level);
