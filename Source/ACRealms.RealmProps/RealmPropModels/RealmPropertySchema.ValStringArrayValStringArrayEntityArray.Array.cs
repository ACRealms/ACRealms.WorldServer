...
[CollectionBuilder(typeof(ValStringArrayValStringArrayEntityArray), "Create")]
public readonly partial struct ValStringArrayValStringArrayEntityArray : IJsonArray<ValStringArrayValStringArrayEntityArray>, IReadOnlyCollection<ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.ValStringArrayValStringArrayEntityArray.ValStringArrayValStringArrayEntity>
#else
    public readonly partial struct ValStringArrayValStringArrayEntityArray : IJsonArray<ValStringArrayValStringArrayEntityArray>, IReadOnlyCollection<ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.ValStringArrayValStringArrayEntityArray.ValStringArrayValStringArrayEntity>
#endif
    {
        ...
        /// Gets an empty array.
        /// </summary>
        public static readonly ValStringArrayValStringArrayEntityArray EmptyArray = From(ImmutableList<JsonAny>.Empty);
        /// <summary>
        /// Initializes a new instance of the <see cref = "ValStringArrayValStringArrayEntityArray"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ValStringArrayValStringArrayEntityArray(ImmutableList<JsonAny> value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ValStringArrayValStringArrayEntityArray(IEnumerable<JsonAny> value)
        {
            this.jsonElementBacking = default;
            this.backing = Backing.Array;
        ...
        /// <inheritdoc/>
        JsonAny IJsonArray<ValStringArrayValStringArrayEntityArray>.this[int index]
        {
            get
            {
        ...
        public ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.ValStringArrayValStringArrayEntityArray.ValStringArrayValStringArrayEntity this[int index]
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    return new ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.ValStringArrayValStringArrayEntityArray.ValStringArrayValStringArrayEntity(this.jsonElementBacking[index]);
                }
                ...
                if ((this.backing & Backing.Array) != 0)
                {
                    try
                    {
                        return this.arrayBacking[index].As<ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.ValStringArrayValStringArrayEntityArray.ValStringArrayValStringArrayEntity>();
                    }
                    catch (ArgumentOutOfRangeException ex)
                    {
                        throw new IndexOutOfRangeException(ex.Message, ex);
        ...
        public static implicit operator ImmutableList<JsonAny>(ValStringArrayValStringArrayEntityArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ValStringArrayValStringArrayEntityArray(ImmutableList<JsonAny> value)
        {
            return new(value);
        }
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ValStringArrayValStringArrayEntityArray(JsonArray value)
        {
        ...
        public static ValStringArrayValStringArrayEntityArray From(ImmutableList<JsonAny> items)
        {
            return new(items);
        }
        ...
        public static ValStringArrayValStringArrayEntityArray Create(ReadOnlySpan<ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.ValStringArrayValStringArrayEntityArray.ValStringArrayValStringArrayEntity> items)
        {
            return new([..items]);
        }
        ...
        /// <returns>A ValStringArrayValStringArrayEntityArray instantiated from the given items.</returns>
        public static ValStringArrayValStringArrayEntityArray FromItems(in ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.ValStringArrayValStringArrayEntityArray.ValStringArrayValStringArrayEntity value1)
        {
        ...
        /// <returns>A ValStringArrayValStringArrayEntityArray instantiated from the given items.</returns>
        public static ValStringArrayValStringArrayEntityArray FromItems(in ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.ValStringArrayValStringArrayEntityArray.ValStringArrayValStringArrayEntity value1, in ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.ValStringArrayValStringArrayEntityArray.ValStringArrayValStringArrayEntity value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A ValStringArrayValStringArrayEntityArray instantiated from the given items.</returns>
        public static ValStringArrayValStringArrayEntityArray FromItems(in ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.ValStringArrayValStringArrayEntityArray.ValStringArrayValStringArrayEntity value1, in ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.ValStringArrayValStringArrayEntityArray.ValStringArrayValStringArrayEntity value2, in ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.ValStringArrayValStringArrayEntityArray.ValStringArrayValStringArrayEntity value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static ValStringArrayValStringArrayEntityArray FromItems(params ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.ValStringArrayValStringArrayEntityArray.ValStringArrayValStringArrayEntity[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.ValStringArrayValStringArrayEntityArray.ValStringArrayValStringArrayEntity item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static ValStringArrayValStringArrayEntityArray FromRange(IEnumerable<ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.ValStringArrayValStringArrayEntityArray.ValStringArrayValStringArrayEntity> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.ValStringArrayValStringArrayEntityArray.ValStringArrayValStringArrayEntity item in value)
            {
        ...
        /// </remarks>
        public static ValStringArrayValStringArrayEntityArray From<T>(IEnumerable<T> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            return new ValStringArrayValStringArrayEntityArray(builder.ToImmutable());
        }
        ...
        /// <param name = "items">The items from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static ValStringArrayValStringArrayEntityArray FromRange(IEnumerable<JsonAny> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// <param name = "items">The items from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static ValStringArrayValStringArrayEntityArray FromRange<T>(IEnumerable<T> items)
        ...
        /// <inheritdoc/>
        IEnumerator<ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.ValStringArrayValStringArrayEntityArray.ValStringArrayValStringArrayEntity> IEnumerable<ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.ValStringArrayValStringArrayEntityArray.ValStringArrayValStringArrayEntity>.GetEnumerator()
        {
        ...
        /// <inheritdoc/>
        int IReadOnlyCollection<ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.ValStringArrayValStringArrayEntityArray.ValStringArrayValStringArrayEntity>.Count => this.GetArrayLength();
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.ValStringArrayValStringArrayEntityArray.ValStringArrayValStringArrayEntity> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.ValStringArrayValStringArrayEntityArray.ValStringArrayValStringArrayEntity>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.ValStringArrayValStringArrayEntityArray.ValStringArrayValStringArrayEntity>(this.arrayBacking);
            }
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator IJsonArray<ValStringArrayValStringArrayEntityArray>.EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator<TItem> IJsonArray<ValStringArrayValStringArrayEntityArray>.EnumerateArray<TItem>()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
