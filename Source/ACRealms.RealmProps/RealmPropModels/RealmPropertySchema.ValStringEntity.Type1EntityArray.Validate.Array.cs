    ...
    public readonly partial struct ValStringEntity
    {
        ...
        public readonly partial struct Type1EntityArray
        {
            private ValidationContext ValidateArray(JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level)
            {
                ...
                int arrayLength = 0;
                using JsonArrayEnumerator<ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.ValStringEntity.Type1EntityArray.Type1Entity> arrayEnumerator = this.EnumerateArray();
