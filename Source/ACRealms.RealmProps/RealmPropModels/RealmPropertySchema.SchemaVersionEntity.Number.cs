...
: IJsonNumber<SchemaVersionEntity>,
  IAdditionOperators<SchemaVersionEntity, SchemaVersionEntity, SchemaVersionEntity>,
  ISubtractionOperators<SchemaVersionEntity, SchemaVersionEntity, SchemaVersionEntity>,
  IMultiplyOperators<SchemaVersionEntity, SchemaVersionEntity, SchemaVersionEntity>,
  IDivisionOperators<SchemaVersionEntity, SchemaVersionEntity, SchemaVersionEntity>,
  IIncrementOperators<SchemaVersionEntity>,
  IDecrementOperators<SchemaVersionEntity>
#else
    : IJsonNumber<SchemaVersionEntity>
#endif
    {
        ...
        public SchemaVersionEntity(in BinaryJsonNumber value)
        {
        ...
        public SchemaVersionEntity(long value) : this(new BinaryJsonNumber(value))
        {
        }
        ...
        public static explicit operator long (SchemaVersionEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
    ...
    public static explicit operator SchemaVersionEntity(Half value)
    {
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static explicit operator SchemaVersionEntity(long value)
        {
            return new(new BinaryJsonNumber(value));
        }
