...
public readonly partial struct RealmPropertySchema
{
    public readonly partial struct ObjPropOrGroupEntity
    {
        ...
        public readonly partial struct AllOf1Entity
        {
            ...
            public bool MatchIfWithTypeEnum(out ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.ObjPropOrGroupEntity.AllOf1Entity.RequiredEnum result)
            {
                if (this.As<ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.ObjPropOrGroupEntity.AllOf1Entity.WithTypeEnum>().IsValid())
                {
                    result = this.As<ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.ObjPropOrGroupEntity.AllOf1Entity.RequiredEnum>();
                    return true;
                }

                result = ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.ObjPropOrGroupEntity.AllOf1Entity.RequiredEnum.Undefined;
                return false;
            }
        }
    }
