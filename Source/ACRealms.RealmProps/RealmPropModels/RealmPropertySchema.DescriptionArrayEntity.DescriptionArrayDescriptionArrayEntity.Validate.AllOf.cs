    ...
    public readonly partial struct DescriptionArrayEntity
    {
        ...
        public readonly partial struct DescriptionArrayDescriptionArrayEntity
        {
            private ValidationContext ValidateAllOf(in ValidationContext validationContext, ValidationLevel level)
            {
                ...
                ValidationContext allOfResult0 = this.As<ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.DescriptionPatternEntity>().Validate(childContext0.CreateChildContext(), level);
