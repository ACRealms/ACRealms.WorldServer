...
public readonly partial struct RealmPropertySchema
{
    ...
    public readonly partial struct DescriptionArrayEntity
    {
        ...
        public static implicit operator ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.ValStringArrayValStringArrayEntityArray(DescriptionArrayEntity value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static explicit operator DescriptionArrayEntity(ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.ValStringArrayValStringArrayEntityArray value)
        {
