...
[CollectionBuilder(typeof(DefaultEntity), "Create")]
public readonly partial struct DefaultEntity : IJsonArray<DefaultEntity>, IReadOnlyCollection<JsonAny>
#else
        public readonly partial struct DefaultEntity : IJsonArray<DefaultEntity>, IReadOnlyCollection<JsonAny>
#endif
        {
            ...
            /// Gets an empty array.
            /// </summary>
            public static readonly DefaultEntity EmptyArray = From(ImmutableList<JsonAny>.Empty);
            /// <summary>
            /// Initializes a new instance of the <see cref = "DefaultEntity"/> struct.
            /// </summary>
            /// <param name = "value">The value from which to construct the instance.</param>
            public DefaultEntity(ImmutableList<JsonAny> value)
            {
            ...
            /// </summary>
            /// <param name = "value">The value from which to construct the instance.</param>
            public DefaultEntity(IEnumerable<JsonAny> value)
            {
                this.jsonElementBacking = default;
                this.backing = Backing.Array;
                this.stringBacking = string.Empty;
            ...
            public static implicit operator ImmutableList<JsonAny>(DefaultEntity value)
            {
            ...
            /// </summary>
            /// <param name = "value">The value from which to convert.</param>
            public static implicit operator DefaultEntity(ImmutableList<JsonAny> value)
            {
                return new(value);
            }
            ...
            /// </summary>
            /// <param name = "value">The value from which to convert.</param>
            public static implicit operator DefaultEntity(JsonArray value)
            {
            ...
            public static DefaultEntity From(ImmutableList<JsonAny> items)
            {
                return new(items);
            }
            ...
            public static DefaultEntity Create(ReadOnlySpan<JsonAny> items)
            {
                return new([..items]);
            }
            ...
            public static DefaultEntity FromItems(params JsonAny[] value)
            {
            ...
            /// <param name = "value">The value from which to construct the instance.</param>
            /// <returns>A DefaultEntity instantiated from the given items.</returns>
            public static DefaultEntity FromItems<TItem>(params TItem[] value)
            ...
            /// <returns>A DefaultEntity instantiated from the given items.</returns>
            public static DefaultEntity FromItems<TItem1>(in TItem1 value1)
            ...
            /// <returns>A DefaultEntity instantiated from the given items.</returns>
            public static DefaultEntity FromItems<TItem1, TItem2>(in TItem1 value1, in TItem2 value2)
            ...
            /// <returns>A DefaultEntity instantiated from the given items.</returns>
            public static DefaultEntity FromItems<TItem1, TItem2, TItem3>(in TItem1 value1, in TItem2 value2, in TItem3 value3)
            ...
            /// </remarks>
            public static DefaultEntity From<T>(IEnumerable<T> items)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                ...
                return new DefaultEntity(builder.ToImmutable());
            }
            ...
            /// other overloads which avoid this serialization step.
            /// </remarks>
            public static DefaultEntity FromRange(IEnumerable<JsonAny> items)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            /// other overloads which avoid this serialization step.
            /// </remarks>
            public static DefaultEntity FromRange<T>(IEnumerable<T> items)
            ...
            /// <param name = "items">The items from which to create the array.</param>
            /// <returns>The new array created from the items.</returns>
            public static DefaultEntity FromRange(IEnumerable<string> items)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            /// <param name = "items">The items from which to create the array.</param>
            /// <returns>The new array created from the items.</returns>
            public static DefaultEntity FromRange(IEnumerable<double> items)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            /// <param name = "items">The items from which to create the array.</param>
            /// <returns>The new array created from the items.</returns>
            public static DefaultEntity FromRange(IEnumerable<float> items)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            /// <param name = "items">The items from which to create the array.</param>
            /// <returns>The new array created from the items.</returns>
            public static DefaultEntity FromRange(IEnumerable<int> items)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            /// <param name = "items">The items from which to create the array.</param>
            /// <returns>The new array created from the items.</returns>
            public static DefaultEntity FromRange(IEnumerable<long> items)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            /// <param name = "items">The items from which to create the array.</param>
            /// <returns>The new array created from the items.</returns>
            public static DefaultEntity FromRange(IEnumerable<bool> items)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            /// <param name = "value1">The first value from which to construct the instance.</param>
            /// <returns>A DefaultEntity instantiated from the given items.</returns>
            public static DefaultEntity FromItems(in JsonAny value1)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                builder.Add(value1);
                return new(builder.ToImmutable());
            ...
            /// <param name = "value2">The second value from which to construct the instance.</param>
            /// <returns>A DefaultEntity instantiated from the given items.</returns>
            public static DefaultEntity FromItems(in JsonAny value1, in JsonAny value2)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                builder.Add(value1);
                builder.Add(value2);
            ...
            /// <param name = "value3">The thirdvalue from which to construct the instance.</param>
            /// <returns>A DefaultEntity instantiated from the given items.</returns>
            public static DefaultEntity FromItems(in JsonAny value1, in JsonAny value2, in JsonAny value3)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                builder.Add(value1);
                builder.Add(value2);
