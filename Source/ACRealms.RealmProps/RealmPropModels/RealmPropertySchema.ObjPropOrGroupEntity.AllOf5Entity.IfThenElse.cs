...
public readonly partial struct RealmPropertySchema
{
    public readonly partial struct ObjPropOrGroupEntity
    {
        ...
        public readonly partial struct AllOf5Entity
        {
            ...
            public bool MatchIfWithTypeBoolean(out ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.ObjPropOrGroupEntity.AllOf5Entity.ThenEntity result)
            {
                if (this.As<ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.ObjPropOrGroupEntity.AllOf5Entity.WithTypeBoolean>().IsValid())
                {
                    result = this.As<ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.ObjPropOrGroupEntity.AllOf5Entity.ThenEntity>();
                    return true;
                }

                result = ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.ObjPropOrGroupEntity.AllOf5Entity.ThenEntity.Undefined;
                return false;
            }
        }
    }
