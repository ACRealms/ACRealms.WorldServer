...
public readonly partial struct RealmPropertySchema
{
    ...
    /// </summary>
    public readonly partial struct ObjPropOrGroupEntity : IJsonObject<ObjPropOrGroupEntity>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "ObjPropOrGroupEntity"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ObjPropOrGroupEntity(ImmutableList<JsonObjectProperty> value)
        {
        ...
        public static implicit operator ObjPropOrGroupEntity(JsonObject value)
        {
        ...
        public static ObjPropOrGroupEntity FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
        {
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static ObjPropOrGroupEntity FromProperties(ImmutableList<JsonObjectProperty> source)
        {
            return new(source);
        }
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static ObjPropOrGroupEntity FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
        {
        ...
        /// <inheritdoc/>
        public ObjPropOrGroupEntity SetProperty<TValue>(in JsonPropertyName name, TValue value)
        ...
        /// <inheritdoc/>
        public ObjPropOrGroupEntity RemoveProperty(in JsonPropertyName name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public ObjPropOrGroupEntity RemoveProperty(string name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public ObjPropOrGroupEntity RemoveProperty(ReadOnlySpan<char> name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public ObjPropOrGroupEntity RemoveProperty(ReadOnlySpan<byte> utf8Name)
        {
