    ...
    public readonly partial struct DescriptionArrayEntity
    {
        private ValidationContext ValidateArray(JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            while (arrayEnumerator.MoveNext())
            {
                ...
                result = arrayEnumerator.Current.As<ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.DescriptionArrayEntity.DescriptionArrayDescriptionArrayEntity>().Validate(result, level);
