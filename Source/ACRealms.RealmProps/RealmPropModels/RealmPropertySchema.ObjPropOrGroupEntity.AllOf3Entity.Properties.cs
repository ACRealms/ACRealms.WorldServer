...
public readonly partial struct RealmPropertySchema
{
    public readonly partial struct ObjPropOrGroupEntity
    {
        ...
        public readonly partial struct AllOf3Entity
        {
            ...
            /// </summary>
            public static AllOf3Entity Create(ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.ValLongEntity? @default = null, ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.ValLongEntity? maxValue = null, ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.ValLongEntity? minValue = null)
            {
            ...
            public AllOf3Entity WithDefault(in ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.ValLongEntity value)
            {
            ...
            /// <param name = "value">The value to set.</param>
            /// <returns>The entity with the updated property.</returns>
            public AllOf3Entity WithMaxValue(in ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.ValLongEntity value)
            {
            ...
            /// <param name = "value">The value to set.</param>
            /// <returns>The entity with the updated property.</returns>
            public AllOf3Entity WithMinValue(in ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.ValLongEntity value)
            {
