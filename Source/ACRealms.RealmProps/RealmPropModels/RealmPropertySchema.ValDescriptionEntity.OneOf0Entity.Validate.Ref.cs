    ...
    public readonly partial struct ValDescriptionEntity
    {
        ...
        public readonly partial struct OneOf0Entity
        {
            private ValidationContext ValidateRef(in ValidationContext validationContext, ValidationLevel level)
            {
                ...
                ValidationContext refResult = this.As<ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.DescriptionPatternEntity>().Validate(validationContext.CreateChildContext(), level);
