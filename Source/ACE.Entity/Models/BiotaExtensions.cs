...
namespace ACE.Entity.Models
{
    public static class BiotaExtensions
    {
        ...
        public static Position GetPosition(this Biota biota, PositionType property, ReaderWriterLockSlim rwLock)
        {
            ...
            {
                if (biota.PropertiesPosition.TryGetValue(property, out var value))
                    return new Position(value.ObjCellId, value.PositionX, value.PositionY, value.PositionZ, value.RotationX, value.RotationY, value.RotationZ, value.RotationW, value.Instance ?? 0, property == PositionType.RelativeDestination);
