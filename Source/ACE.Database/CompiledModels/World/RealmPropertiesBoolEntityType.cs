...
{
    internal partial class RealmPropertiesBoolEntityType
    {
        public static RuntimeEntityType Create(RuntimeModel model, RuntimeEntityType baseEntityType = null)
        {
            var runtimeEntityType = model.AddEntityType(
                "ACE.Database.Models.World.RealmPropertiesBool",
                typeof(RealmPropertiesBool),
                baseEntityType);
            ...
            var value = runtimeEntityType.AddProperty(
                "Value",
                typeof(bool),
                propertyInfo: typeof(RealmPropertiesBool).GetProperty("Value", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                fieldInfo: typeof(RealmPropertiesBool).GetField("<Value>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                sentinel: false);
            ...
            value.AddAnnotation("Relational:ColumnType", "bit(1)");
        ...
        public static RuntimeForeignKey CreateForeignKey1(RuntimeEntityType declaringEntityType, RuntimeEntityType principalEntityType)
        {
            ...
            var realmPropertiesBool = principalEntityType.AddNavigation("RealmPropertiesBool",
                runtimeForeignKey,
                onDependent: false,
                typeof(IList<RealmPropertiesBool>),
                propertyInfo: typeof(Realm).GetProperty("RealmPropertiesBool", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                fieldInfo: typeof(Realm).GetField("<RealmPropertiesBool>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly));

            runtimeForeignKey.AddAnnotation("Relational:Name", "realm_bool");
        ...
        public static void CreateAnnotations(RuntimeEntityType runtimeEntityType)
        {
            ...
            runtimeEntityType.AddAnnotation("Relational:TableName", "realm_properties_bool");
