...
{
    internal partial class RealmPropertiesFloatEntityType
    {
        public static RuntimeEntityType Create(RuntimeModel model, RuntimeEntityType baseEntityType = null)
        {
            var runtimeEntityType = model.AddEntityType(
                "ACE.Database.Models.World.RealmPropertiesFloat",
                typeof(RealmPropertiesFloat),
                baseEntityType);
            ...
            var compositionType = runtimeEntityType.AddProperty(
                "CompositionType",
                typeof(byte),
                propertyInfo: typeof(RealmPropertiesFloat).GetProperty("CompositionType", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                fieldInfo: typeof(RealmPropertiesFloat).GetField("<CompositionType>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                sentinel: (byte)0);
            ...
            var randomHighRange = runtimeEntityType.AddProperty(
                "RandomHighRange",
                typeof(double?),
                propertyInfo: typeof(RealmPropertiesFloat).GetProperty("RandomHighRange", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                fieldInfo: typeof(RealmPropertiesFloat).GetField("<RandomHighRange>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                nullable: true);
            randomHighRange.TypeMapping = MySqlDoubleTypeMapping.Default.Clone(
                comparer: new ValueComparer<double?>(
                    (Nullable<double> v1, Nullable<double> v2) => v1.HasValue && v2.HasValue && ((double)v1).Equals((double)v2) || !v1.HasValue && !v2.HasValue,
                    (Nullable<double> v) => v.HasValue ? ((double)v).GetHashCode() : 0,
                    (Nullable<double> v) => v.HasValue ? (Nullable<double>)(double)v : default(Nullable<double>)),
            ...
            var randomLowRange = runtimeEntityType.AddProperty(
                "RandomLowRange",
                typeof(double?),
                propertyInfo: typeof(RealmPropertiesFloat).GetProperty("RandomLowRange", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                fieldInfo: typeof(RealmPropertiesFloat).GetField("<RandomLowRange>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                nullable: true);
            randomLowRange.TypeMapping = MySqlDoubleTypeMapping.Default.Clone(
                comparer: new ValueComparer<double?>(
                    (Nullable<double> v1, Nullable<double> v2) => v1.HasValue && v2.HasValue && ((double)v1).Equals((double)v2) || !v1.HasValue && !v2.HasValue,
                    (Nullable<double> v) => v.HasValue ? ((double)v).GetHashCode() : 0,
                    (Nullable<double> v) => v.HasValue ? (Nullable<double>)(double)v : default(Nullable<double>)),
            ...
            var randomType = runtimeEntityType.AddProperty(
                "RandomType",
                typeof(byte),
                propertyInfo: typeof(RealmPropertiesFloat).GetProperty("RandomType", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                fieldInfo: typeof(RealmPropertiesFloat).GetField("<RandomType>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                sentinel: (byte)0);
            ...
            var value = runtimeEntityType.AddProperty(
                "Value",
                typeof(double?),
                propertyInfo: typeof(RealmPropertiesFloat).GetProperty("Value", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                fieldInfo: typeof(RealmPropertiesFloat).GetField("<Value>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                nullable: true);
        ...
        public static RuntimeForeignKey CreateForeignKey1(RuntimeEntityType declaringEntityType, RuntimeEntityType principalEntityType)
        {
            ...
            var realmPropertiesFloat = principalEntityType.AddNavigation("RealmPropertiesFloat",
                runtimeForeignKey,
                onDependent: false,
                typeof(IList<RealmPropertiesFloat>),
                propertyInfo: typeof(Realm).GetProperty("RealmPropertiesFloat", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                fieldInfo: typeof(Realm).GetField("<RealmPropertiesFloat>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly));

            runtimeForeignKey.AddAnnotation("Relational:Name", "realm_float");
        ...
        public static void CreateAnnotations(RuntimeEntityType runtimeEntityType)
        {
            ...
            runtimeEntityType.AddAnnotation("Relational:TableName", "realm_properties_float");
