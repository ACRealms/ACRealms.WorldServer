...
public partial class WorldDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<CookBook>(entity =>
        {
            ...
            entity
                .ToTable("cook_book", tb => tb.HasComment("Cook Book for Recipes"))
                .HasCharSet("utf8mb3")
        ...
        modelBuilder.Entity<Encounter>(entity =>
        {
            ...
            entity
                .ToTable("encounter", tb => tb.HasComment("Encounters"))
                .HasCharSet("utf8mb3")
                .UseCollation("utf8mb3_general_ci");
        ...
        modelBuilder.Entity<Event>(entity =>
        {
            ...
            entity
                .ToTable("event", tb => tb.HasComment("Events"))
                .HasCharSet("utf8mb3")
                .UseCollation("utf8mb3_general_ci");
        ...
        modelBuilder.Entity<HousePortal>(entity =>
        {
            ...
            entity
                .ToTable("house_portal", tb => tb.HasComment("House Portal Destinations"))
                .HasCharSet("utf8mb3")
                .UseCollation("utf8mb3_general_ci");
        ...
        modelBuilder.Entity<LandblockInstance>(entity =>
        {
            ...
            entity
                .ToTable("landblock_instance", tb => tb.HasComment("Weenie Instances for each Landblock"))
                .HasCharSet("utf8mb3")
                .UseCollation("utf8mb3_general_ci");
        ...
        modelBuilder.Entity<LandblockInstanceLink>(entity =>
        {
            ...
            entity
                .ToTable("landblock_instance_link", tb => tb.HasComment("Weenie Instance Links"))
                .HasCharSet("utf8mb3")
                .UseCollation("utf8mb3_general_ci");
        ...
        modelBuilder.Entity<PointsOfInterest>(entity =>
        {
            ...
            entity
                .ToTable("points_of_interest", tb => tb.HasComment("Points of Interest for @telepoi command"))
                .HasCharSet("utf8mb3")
                .UseCollation("utf8mb3_general_ci");
        ...
        modelBuilder.Entity<Quest>(entity =>
        {
            ...
            entity
                .ToTable("quest", tb => tb.HasComment("Quests"))
                .HasCharSet("utf8mb3")
                .UseCollation("utf8mb3_general_ci");
        ...
        modelBuilder.Entity<Realm>(entity =>
        {
            ...
            entity.ToTable("realm", tb => tb.HasComment("Dynamic Realm of a Shard/World"));
        ...
        modelBuilder.Entity<RealmPropertiesBool>(entity =>
        {
            ...
            entity.ToTable("realm_properties_bool", tb => tb.HasComment("Bool Properties of Realms"));
            ...
            entity.HasOne(d => d.Realm).WithMany(p => p.RealmPropertiesBool)
        ...
        modelBuilder.Entity<RealmPropertiesFloat>(entity =>
        {
            ...
            entity.ToTable("realm_properties_float", tb => tb.HasComment("Float Properties of Realms"));
            ...
            entity.HasOne(d => d.Realm).WithMany(p => p.RealmPropertiesFloat)
                .HasForeignKey(d => d.RealmId)
        ...
        modelBuilder.Entity<RealmPropertiesInt>(entity =>
        {
            ...
            entity.ToTable("realm_properties_int", tb => tb.HasComment("Int Properties of Realms"));
            ...
            entity.HasOne(d => d.Realm).WithMany(p => p.RealmPropertiesInt)
                .HasForeignKey(d => d.RealmId)
        ...
        modelBuilder.Entity<RealmPropertiesInt64>(entity =>
        {
            ...
            entity.ToTable("realm_properties_int64", tb => tb.HasComment("Int64 Properties of Realms"));
            ...
            entity.HasOne(d => d.Realm).WithMany(p => p.RealmPropertiesInt64)
                .HasForeignKey(d => d.RealmId)
        ...
        modelBuilder.Entity<RealmPropertiesString>(entity =>
        {
            ...
            entity.ToTable("realm_properties_string", tb => tb.HasComment("String Properties of Realms"));
            ...
            entity.HasOne(d => d.Realm).WithMany(p => p.RealmPropertiesString)
                .HasForeignKey(d => d.RealmId)
        ...
        modelBuilder.Entity<RealmRulesetLinks>(entity =>
        {
            ...
            entity.HasIndex(e => e.LinkedRealmId, "realm_link_child");
            ...
            entity.HasOne(d => d.LinkedRealm).WithMany(p => p.RealmRulesetLinksLinkedRealm)
                .HasForeignKey(d => d.LinkedRealmId)
                .HasConstraintName("realm_link_child");

            entity.HasOne(d => d.Realm).WithMany(p => p.RealmRulesetLinksRealm)
                .HasForeignKey(d => d.RealmId)
        ...
        modelBuilder.Entity<Recipe>(entity =>
        {
            ...
            entity
                .ToTable("recipe", tb => tb.HasComment("Recipes"))
                .HasCharSet("utf8mb3")
                .UseCollation("utf8mb3_general_ci");
        ...
        modelBuilder.Entity<RecipeMod>(entity =>
        {
            ...
            entity
                .ToTable("recipe_mod", tb => tb.HasComment("Recipe Mods"))
                .HasCharSet("utf8mb3")
                .UseCollation("utf8mb3_general_ci");
        ...
        modelBuilder.Entity<RecipeModsBool>(entity =>
        {
            ...
            entity
                .ToTable("recipe_mods_bool", tb => tb.HasComment("Recipe Bool Mods"))
                .HasCharSet("utf8mb3")
                .UseCollation("utf8mb3_general_ci");
        ...
        modelBuilder.Entity<RecipeModsDID>(entity =>
        {
            ...
            entity
                .ToTable("recipe_mods_d_i_d", tb => tb.HasComment("Recipe DID Mods"))
                .HasCharSet("utf8mb3")
                .UseCollation("utf8mb3_general_ci");
        ...
        modelBuilder.Entity<RecipeModsFloat>(entity =>
        {
            ...
            entity
                .ToTable("recipe_mods_float", tb => tb.HasComment("Recipe Float Mods"))
                .HasCharSet("utf8mb3")
                .UseCollation("utf8mb3_general_ci");
        ...
        modelBuilder.Entity<RecipeModsIID>(entity =>
        {
            ...
            entity
                .ToTable("recipe_mods_i_i_d", tb => tb.HasComment("Recipe IID Mods"))
                .HasCharSet("utf8mb3")
                .UseCollation("utf8mb3_general_ci");
        ...
        modelBuilder.Entity<RecipeModsInt>(entity =>
        {
            ...
            entity
                .ToTable("recipe_mods_int", tb => tb.HasComment("Recipe Int Mods"))
                .HasCharSet("utf8mb3")
                .UseCollation("utf8mb3_general_ci");
        ...
        modelBuilder.Entity<RecipeModsString>(entity =>
        {
            ...
            entity
                .ToTable("recipe_mods_string", tb => tb.HasComment("Recipe String Mods"))
                .HasCharSet("utf8mb3")
                .UseCollation("utf8mb3_general_ci");
        ...
        modelBuilder.Entity<RecipeRequirementsBool>(entity =>
        {
            ...
            entity
                .ToTable("recipe_requirements_bool", tb => tb.HasComment("Recipe Bool Requirments"))
                .HasCharSet("utf8mb3")
                .UseCollation("utf8mb3_general_ci");
        ...
        modelBuilder.Entity<RecipeRequirementsDID>(entity =>
        {
            ...
            entity
                .ToTable("recipe_requirements_d_i_d", tb => tb.HasComment("Recipe DID Requirments"))
                .HasCharSet("utf8mb3")
                .UseCollation("utf8mb3_general_ci");
        ...
        modelBuilder.Entity<RecipeRequirementsFloat>(entity =>
        {
            ...
            entity
                .ToTable("recipe_requirements_float", tb => tb.HasComment("Recipe Float Requirments"))
                .HasCharSet("utf8mb3")
                .UseCollation("utf8mb3_general_ci");
        ...
        modelBuilder.Entity<RecipeRequirementsIID>(entity =>
        {
            ...
            entity
                .ToTable("recipe_requirements_i_i_d", tb => tb.HasComment("Recipe IID Requirments"))
                .HasCharSet("utf8mb3")
                .UseCollation("utf8mb3_general_ci");
        ...
        modelBuilder.Entity<RecipeRequirementsInt>(entity =>
        {
            ...
            entity
                .ToTable("recipe_requirements_int", tb => tb.HasComment("Recipe Int Requirments"))
                .HasCharSet("utf8mb3")
                .UseCollation("utf8mb3_general_ci");
        ...
        modelBuilder.Entity<RecipeRequirementsString>(entity =>
        {
            ...
            entity
                .ToTable("recipe_requirements_string", tb => tb.HasComment("Recipe String Requirments"))
                .HasCharSet("utf8mb3")
                .UseCollation("utf8mb3_general_ci");
        ...
        modelBuilder.Entity<Spell>(entity =>
        {
            ...
            entity
                .ToTable("spell", tb => tb.HasComment("Spell Table Extended Data"))
                .HasCharSet("utf8mb3")
                .UseCollation("utf8mb3_general_ci");
        ...
        modelBuilder.Entity<TreasureDeath>(entity =>
        {
            ...
            entity
                .ToTable("treasure_death", tb => tb.HasComment("Death Treasure"))
                .HasCharSet("utf8mb3")
                .UseCollation("utf8mb3_general_ci");
        ...
        modelBuilder.Entity<TreasureMaterialBase>(entity =>
        {
            ...
            entity
                .ToTable("treasure_material_base")
                .HasCharSet("utf8mb3")
                .UseCollation("utf8mb3_general_ci");
        ...
        modelBuilder.Entity<TreasureMaterialColor>(entity =>
        {
            ...
            entity
                .ToTable("treasure_material_color")
                .HasCharSet("utf8mb3")
                .UseCollation("utf8mb3_general_ci");
        ...
        modelBuilder.Entity<TreasureMaterialGroups>(entity =>
        {
            ...
            entity
                .ToTable("treasure_material_groups")
                .HasCharSet("utf8mb3")
                .UseCollation("utf8mb3_general_ci");
        ...
        modelBuilder.Entity<TreasureWielded>(entity =>
        {
            ...
            entity
                .ToTable("treasure_wielded", tb => tb.HasComment("Wielded Treasure"))
                .HasCharSet("utf8mb3")
                .UseCollation("utf8mb3_general_ci");
        ...
        modelBuilder.Entity<Version>(entity =>
        {
            ...
            entity
                .ToTable("version", tb => tb.HasComment("Version Information"))
                .HasCharSet("utf8mb3")
                .UseCollation("utf8mb3_general_ci");
        ...
        modelBuilder.Entity<Weenie>(entity =>
        {
            ...
            entity
                .ToTable("weenie", tb => tb.HasComment("Weenies"))
                .HasCharSet("utf8mb3")
                .UseCollation("utf8mb3_general_ci");
        ...
        modelBuilder.Entity<WeeniePropertiesAnimPart>(entity =>
        {
            ...
            entity
                .ToTable("weenie_properties_anim_part", tb => tb.HasComment("Animation Part Changes (from PCAPs) of Weenies"))
                .HasCharSet("utf8mb3")
                .UseCollation("utf8mb3_general_ci");
        ...
        modelBuilder.Entity<WeeniePropertiesAttribute>(entity =>
        {
            ...
            entity
                .ToTable("weenie_properties_attribute", tb => tb.HasComment("Attribute Properties of Weenies"))
                .HasCharSet("utf8mb3")
                .UseCollation("utf8mb3_general_ci");
        ...
        modelBuilder.Entity<WeeniePropertiesAttribute2nd>(entity =>
        {
            ...
            entity
                .ToTable("weenie_properties_attribute_2nd", tb => tb.HasComment("Attribute2nd (Vital) Properties of Weenies"))
                .HasCharSet("utf8mb3")
                .UseCollation("utf8mb3_general_ci");
        ...
        modelBuilder.Entity<WeeniePropertiesBodyPart>(entity =>
        {
            ...
            entity
                .ToTable("weenie_properties_body_part", tb => tb.HasComment("Body Part Properties of Weenies"))
                .HasCharSet("utf8mb3")
                .UseCollation("utf8mb3_general_ci");
        ...
        modelBuilder.Entity<WeeniePropertiesBook>(entity =>
        {
            ...
            entity
                .ToTable("weenie_properties_book", tb => tb.HasComment("Book Properties of Weenies"))
                .HasCharSet("utf8mb3")
                .UseCollation("utf8mb3_general_ci");
        ...
        modelBuilder.Entity<WeeniePropertiesBookPageData>(entity =>
        {
            ...
            entity
                .ToTable("weenie_properties_book_page_data", tb => tb.HasComment("Page Properties of Weenies"))
                .HasCharSet("utf8mb3")
                .UseCollation("utf8mb3_general_ci");
        ...
        modelBuilder.Entity<WeeniePropertiesBool>(entity =>
        {
            ...
            entity
                .ToTable("weenie_properties_bool", tb => tb.HasComment("Bool Properties of Weenies"))
                .HasCharSet("utf8mb3")
                .UseCollation("utf8mb3_general_ci");
        ...
        modelBuilder.Entity<WeeniePropertiesCreateList>(entity =>
        {
            ...
            entity
                .ToTable("weenie_properties_create_list", tb => tb.HasComment("CreateList Properties of Weenies"))
                .HasCharSet("utf8mb3")
                .UseCollation("utf8mb3_general_ci");
        ...
        modelBuilder.Entity<WeeniePropertiesDID>(entity =>
        {
            ...
            entity
                .ToTable("weenie_properties_d_i_d", tb => tb.HasComment("DataID Properties of Weenies"))
                .HasCharSet("utf8mb3")
                .UseCollation("utf8mb3_general_ci");
        ...
        modelBuilder.Entity<WeeniePropertiesEmote>(entity =>
        {
            ...
            entity
                .ToTable("weenie_properties_emote", tb => tb.HasComment("Emote Properties of Weenies"))
                .HasCharSet("utf8mb3")
                .UseCollation("utf8mb3_general_ci");
        ...
        modelBuilder.Entity<WeeniePropertiesEmoteAction>(entity =>
        {
            ...
            entity
                .ToTable("weenie_properties_emote_action", tb => tb.HasComment("EmoteAction Properties of Weenies"))
                .HasCharSet("utf8mb3")
                .UseCollation("utf8mb3_general_ci");
        ...
        modelBuilder.Entity<WeeniePropertiesEventFilter>(entity =>
        {
            ...
            entity
                .ToTable("weenie_properties_event_filter", tb => tb.HasComment("EventFilter Properties of Weenies"))
                .HasCharSet("utf8mb3")
                .UseCollation("utf8mb3_general_ci");
        ...
        modelBuilder.Entity<WeeniePropertiesFloat>(entity =>
        {
            ...
            entity
                .ToTable("weenie_properties_float", tb => tb.HasComment("Float Properties of Weenies"))
                .HasCharSet("utf8mb3")
                .UseCollation("utf8mb3_general_ci");
        ...
        modelBuilder.Entity<WeeniePropertiesGenerator>(entity =>
        {
            ...
            entity
                .ToTable("weenie_properties_generator", tb => tb.HasComment("Generator Properties of Weenies"))
                .HasCharSet("utf8mb3")
                .UseCollation("utf8mb3_general_ci");
        ...
        modelBuilder.Entity<WeeniePropertiesIID>(entity =>
        {
            ...
            entity
                .ToTable("weenie_properties_i_i_d", tb => tb.HasComment("InstanceID Properties of Weenies"))
                .HasCharSet("utf8mb3")
                .UseCollation("utf8mb3_general_ci");
        ...
        modelBuilder.Entity<WeeniePropertiesInt>(entity =>
        {
            ...
            entity
                .ToTable("weenie_properties_int", tb => tb.HasComment("Int Properties of Weenies"))
                .HasCharSet("utf8mb3")
                .UseCollation("utf8mb3_general_ci");
        ...
        modelBuilder.Entity<WeeniePropertiesInt64>(entity =>
        {
            ...
            entity
                .ToTable("weenie_properties_int64", tb => tb.HasComment("Int64 Properties of Weenies"))
                .HasCharSet("utf8mb3")
                .UseCollation("utf8mb3_general_ci");
        ...
        modelBuilder.Entity<WeeniePropertiesPalette>(entity =>
        {
            ...
            entity
                .ToTable("weenie_properties_palette", tb => tb.HasComment("Palette Changes (from PCAPs) of Weenies"))
                .HasCharSet("utf8mb3")
                .UseCollation("utf8mb3_general_ci");
        ...
        modelBuilder.Entity<WeeniePropertiesPosition>(entity =>
        {
            ...
            entity
                .ToTable("weenie_properties_position", tb => tb.HasComment("Position Properties of Weenies"))
                .HasCharSet("utf8mb3")
                .UseCollation("utf8mb3_general_ci");
        ...
        modelBuilder.Entity<WeeniePropertiesSkill>(entity =>
        {
            ...
            entity
                .ToTable("weenie_properties_skill", tb => tb.HasComment("Skill Properties of Weenies"))
                .HasCharSet("utf8mb3")
                .UseCollation("utf8mb3_general_ci");
        ...
        modelBuilder.Entity<WeeniePropertiesSpellBook>(entity =>
        {
            ...
            entity
                .ToTable("weenie_properties_spell_book", tb => tb.HasComment("SpellBook Properties of Weenies"))
                .HasCharSet("utf8mb3")
                .UseCollation("utf8mb3_general_ci");
        ...
        modelBuilder.Entity<WeeniePropertiesString>(entity =>
        {
            ...
            entity
                .ToTable("weenie_properties_string", tb => tb.HasComment("String Properties of Weenies"))
                .HasCharSet("utf8mb3")
                .UseCollation("utf8mb3_general_ci");
        ...
        modelBuilder.Entity<WeeniePropertiesTextureMap>(entity =>
        {
            ...
            entity
                .ToTable("weenie_properties_texture_map", tb => tb.HasComment("Texture Map Changes (from PCAPs) of Weenies"))
                .HasCharSet("utf8mb3")
                .UseCollation("utf8mb3_general_ci");
