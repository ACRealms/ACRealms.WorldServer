...
namespace ACRealms.Roslyn.Analyzer.Generators
{
    ...
    public class ACR20XX_RealmProps : DiagnosticAnalyzer
    {
        ...
        private static readonly FrozenDictionary<DescriptorType, DiagnosticDescriptor> Descriptors = new Dictionary<DescriptorType, IntermediateDescriptor>()
        {
            ...
            { DescriptorType.JSONValidation, new IntermediateDescriptor() { MessageFormat = "Validation Error: {0} (Opening in vscode may give more accurate errors - If no errors, and schemas were updated recently, see ACRealms.Roslyn.RealmProps\\RealmPropModels.cs for regeneration instructions)" } },
