    ...
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        ...
        IncrementalValuesProvider<NamespaceData> realmPropNamespaces = realmPropFiles
            .Select(static (file, cancellationToken) =>
            {
                ...
                try
                {
                    string commentsRemoved = RemoveJsonComments(file.Contents, cancellationToken);
                    step++;
                    ...
                    IEnumerable<ObjPropInfo> props = GetProps(namespaceRaw, namespaceObj);
                    step++;
        ...
        context.RegisterSourceOutput(realmPropNamespaces, (spc, data) =>
        {
            ...
            string? sourceCode = GenerateSourceCode(data);
        ...
        context.RegisterSourceOutput(corePropsSource, (spc, data) =>
        {
            ...
            string? sourceCode = GenerateCoreEnumClass(data.TargetEnumTypeName, data.PropsOfType);
