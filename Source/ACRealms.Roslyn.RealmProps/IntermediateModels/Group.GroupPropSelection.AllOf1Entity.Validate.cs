        ...
        public readonly partial struct AllOf1Entity
        {
            ...
            public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
            {
                ...
                if (level > ValidationLevel.Basic)
                {
                    ...
                    result = result.PushSchemaLocation("realm-props/group.json#/definitions/groupPropSelection/allOf/1");
                }
            ...
            public static partial class CorvusValidation
            {
                    ...
                    ValidationLevel level = ValidationLevel.Flag)
                {
                    ...
                    ValidationContext ifResult = value.As<ACRealms.Roslyn.RealmProps.IntermediateModels.Group.PropDefsAreLongForm>().Validate(validationContext.CreateChildContext(), level);
                    ...
                    if (ifResult.IsValid)
                    {
                        ...
                        ValidationContext thenResult = value.As<ACRealms.Roslyn.RealmProps.IntermediateModels.Group.TypedPropDefs>().Validate(validationContext.CreateChildContext(), level);
