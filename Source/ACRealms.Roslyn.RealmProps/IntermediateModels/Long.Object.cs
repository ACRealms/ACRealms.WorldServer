    ...
    : IJsonObject<ACRealms.Roslyn.RealmProps.IntermediateModels.Long>
{
    ...
    /// </para>
    /// </remarks>
    public ACRealms.Roslyn.RealmProps.IntermediateModels.Long.RepresentsARealmPropertyInt64LongInteger Type
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            ...
            if ((this.backing & Backing.Object) != 0)
            {
                ...
                {
                    return result.As<ACRealms.Roslyn.RealmProps.IntermediateModels.Long.RepresentsARealmPropertyInt64LongInteger>();
                }
            }
    ...
    /// </summary>
    public static Long Create(in ACRealms.Roslyn.RealmProps.IntermediateModels.Long.RepresentsARealmPropertyInt64LongInteger? type = null)
    {
    ...
    /// </para>
    /// </remarks>
    public Long WithType(in ACRealms.Roslyn.RealmProps.IntermediateModels.Long.RepresentsARealmPropertyInt64LongInteger value)
    {
