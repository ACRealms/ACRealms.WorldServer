...
public readonly partial struct RealmPropertySchema
{
    ...
    /// </para>
    /// </remarks>
    public readonly partial struct ValInt
#if NET8_0_OR_GREATER
        : IJsonNumber<ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.ValInt>,
          IAdditionOperators<ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.ValInt, ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.ValInt, ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.ValInt>,
          ISubtractionOperators<ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.ValInt, ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.ValInt, ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.ValInt>,
          IMultiplyOperators<ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.ValInt, ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.ValInt, ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.ValInt>,
          IDivisionOperators<ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.ValInt, ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.ValInt, ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.ValInt>,
          IIncrementOperators<ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.ValInt>,
          IDecrementOperators<ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.ValInt>
#else
        : IJsonNumber<ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.ValInt>
#endif
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "ValInt"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        public ValInt(long value)
        ...
        public static implicit operator ValInt(JsonNumber value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator JsonNumber(ValInt value)
        {
            return
                value.AsNumber;
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator JsonInteger(ValInt value)
        {
            return
        ...
        public static explicit operator byte(ValInt value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="ValInt"/>.</returns>
        public static explicit operator ValInt(byte value)
        {
        ...
        public static explicit operator decimal(ValInt value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="ValInt"/>.</returns>
        public static explicit operator ValInt(decimal value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator double(ValInt value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="ValInt"/>.</returns>
        public static explicit operator ValInt(double value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator short(ValInt value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="ValInt"/>.</returns>
        public static explicit operator ValInt(short value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator int(ValInt value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="ValInt"/>.</returns>
        public static explicit operator ValInt(int value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static implicit operator long(ValInt value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="ValInt"/>.</returns>
        public static implicit operator ValInt(long value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator Int128(ValInt value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="ValInt"/>.</returns>
        public static explicit operator ValInt(Int128 value)
        {
            return new(new BinaryJsonNumber(value));
        }
#endif
        ...
        public static explicit operator sbyte(ValInt value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="ValInt"/>.</returns>
        public static explicit operator ValInt(sbyte value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator Half(ValInt value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="ValInt"/>.</returns>
        public static explicit operator ValInt(Half value)
        {
            return new(new BinaryJsonNumber(value));
        }
#endif
        ...
        public static explicit operator float(ValInt value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="ValInt"/>.</returns>
        public static explicit operator ValInt(float value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator ushort(ValInt value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="ValInt"/>.</returns>
        public static explicit operator ValInt(ushort value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator uint(ValInt value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="ValInt"/>.</returns>
        public static explicit operator ValInt(uint value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator ulong(ValInt value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="ValInt"/>.</returns>
        public static explicit operator ValInt(ulong value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator UInt128(ValInt value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="ValInt"/>.</returns>
        public static explicit operator ValInt(UInt128 value)
        {
            return new(new BinaryJsonNumber(value));
        }
#endif
        ...
        /// </returns>
        public static bool operator <(ValInt left, ValInt right)
        {
        ...
        public static ValInt operator +(ValInt left, ValInt right)
        {
        ...
        /// <returns>The result of the operation.</returns>
        public static ValInt operator ++(ValInt value)
        {
        ...
        /// </returns>
        public static int Compare(in ValInt lhs, in ValInt rhs)
        {
