...
public readonly partial struct ArrayShortPropList
{
    ...
    public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
    {
        ...
        if (level > ValidationLevel.Basic)
        {
            ...
            result = result.PushSchemaLocation("realm-props/group/array-short-prop-list.json");
        }
    ...
    public static partial class CorvusValidation
    {
            ...
            ValidationLevel level)
        {
            ...
            int length = 0;
            using JsonArrayEnumerator<ACRealms.Roslyn.RealmProps.IntermediateModels.PropDefKeyPart> arrayEnumerator = value.EnumerateArray();
