...
public readonly partial struct UngroupedPropObj
{
    ...
    public readonly partial struct ObjPropSelection
    {
        ...
        public readonly partial struct Typed
        {
            ...
            /// Generated from JSON Schema.
            /// </summary>
            [System.Text.Json.Serialization.JsonConverter(typeof(Corvus.Json.Internal.JsonValueConverter<Bool>))]
            public readonly partial struct Bool
                : IJsonValue<ACRealms.Roslyn.RealmProps.IntermediateModels.UngroupedPropObj.ObjPropSelection.Typed.Bool>
            {
                ...
                public Bool(in JsonElement value)
                {
                ...
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                public Bool(ImmutableList<JsonObjectProperty> value)
                {
                ...
                /// </summary>
                public static Bool Null { get; } = new(JsonValueHelpers.NullElement);

                /// <summary>
                /// Gets an Undefined instance.
                /// </summary>
                public static Bool Undefined { get; }

                /// <summary>
                /// Gets the default instance.
                /// </summary>
                public static Bool DefaultInstance { get; }
                ...
                /// </returns>
                public static bool operator ==(in Bool left, in Bool right)
                {
                ...
                public static Bool FromJson(in JsonElement value)
                {
                    return new(value);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static Bool FromAny(in JsonAny value)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                static Bool IJsonValue<Bool>.FromBoolean<TValue>(in TValue value)
                {
                    if (value.HasJsonElementBacking)
                    {
                        return new(value.AsJsonElement);
                ...
                /// <returns>An instance of this type, initialized from the provided value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                static Bool IJsonValue<Bool>.FromString<TValue>(in TValue value)
                {
                    if (value.HasJsonElementBacking)
                    {
                        return new(value.AsJsonElement);
                ...
                /// <returns>An instance of this type, initialized from the provided value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                static Bool IJsonValue<Bool>.FromNumber<TValue>(in TValue value)
                {
                    if (value.HasJsonElementBacking)
                    {
                        return new(value.AsJsonElement);
                ...
                /// <returns>An instance of this type, initialized from the provided value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static Bool FromObject<TValue>(in TValue value)
                ...
                /// <returns>An instance of this type, initialized from the provided value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                static Bool IJsonValue<Bool>.FromArray<TValue>(in TValue value)
                {
                    if (value.HasJsonElementBacking)
                    {
                        return new(value.AsJsonElement);
                ...
                public static Bool Parse(string source, JsonDocumentOptions options = default)
                {
                ...
                /// <param name="source">The source of the JSON string to parse.</param>
                /// <param name="options">The (optional) JsonDocumentOptions.</param>
                public static Bool Parse(Stream source, JsonDocumentOptions options = default)
                {
                    using var jsonDocument = JsonDocument.Parse(source, options);
                    return new(jsonDocument.RootElement.Clone());
                }
                ...
                /// <param name="source">The source of the JSON string to parse.</param>
                /// <param name="options">The (optional) JsonDocumentOptions.</param>
                public static Bool Parse(ReadOnlyMemory<byte> source, JsonDocumentOptions options = default)
                {
                    using var jsonDocument = JsonDocument.Parse(source, options);
                    return new(jsonDocument.RootElement.Clone());
                }
                ...
                /// <param name="source">The source of the JSON string to parse.</param>
                /// <param name="options">The (optional) JsonDocumentOptions.</param>
                public static Bool Parse(ReadOnlyMemory<char> source, JsonDocumentOptions options = default)
                {
                    using var jsonDocument = JsonDocument.Parse(source, options);
                    return new(jsonDocument.RootElement.Clone());
                }
                ...
                /// <param name="source">The source of the JSON string to parse.</param>
                /// <param name="options">The (optional) JsonDocumentOptions.</param>
                public static Bool Parse(ReadOnlySequence<byte> source, JsonDocumentOptions options = default)
                {
                    using var jsonDocument = JsonDocument.Parse(source, options);
                    return new(jsonDocument.RootElement.Clone());
                }
                ...
                /// </summary>
                /// <param name="source">The source of the JSON string to parse.</param>
                public static Bool ParseValue(string source)
                {
#if NET8_0_OR_GREATER
                    return IJsonValue<Bool>.ParseValue(source);
#else
                    return JsonValueHelpers.ParseValue<Bool>(source.AsSpan());
#endif
                }
                ...
                /// </summary>
                /// <param name="source">The source of the JSON string to parse.</param>
                public static Bool ParseValue(ReadOnlySpan<char> source)
                {
#if NET8_0_OR_GREATER
                    return IJsonValue<Bool>.ParseValue(source);
#else
                    return JsonValueHelpers.ParseValue<Bool>(source);
#endif
                }
                ...
                /// </summary>
                /// <param name="source">The source of the JSON string to parse.</param>
                public static Bool ParseValue(ReadOnlySpan<byte> source)
                {
#if NET8_0_OR_GREATER
                    return IJsonValue<Bool>.ParseValue(source);
#else
                ...
                /// </summary>
                /// <param name="source">The source of the JSON string to parse.</param>
                public static Bool ParseValue(ref Utf8JsonReader source)
                {
#if NET8_0_OR_GREATER
                    return IJsonValue<Bool>.ParseValue(ref source);
#else
                    return JsonValueHelpers.ParseValue<Bool>(ref source);
#endif
                }
                ...
                {
                    return
                        (obj is IJsonValue jv && this.Equals(jv.As<Bool>())) ||
                ...
                {
                    return this.Equals(other.As<Bool>());
                }
                ...
                public bool Equals(in Bool other)
                {
