            ...
            ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            foreach (JsonObjectProperty property in value.EnumerateObject())
            {
                ...
                else if (property.NameEquals(JsonPropertyNames.RerollRestrictedToUtf8, JsonPropertyNames.RerollRestrictedTo))
                {
                    ...
                    ValidationContext propertyResult = property.Value.As<ACRealms.Roslyn.RealmProps.IntermediateModels.PropMinmax.RerollRestrictedToEntity>().Validate(result.CreateChildContext(), level);
                    if (level == ValidationLevel.Flag && !propertyResult.IsValid)
                    {
                        return propertyResult;
                    }
