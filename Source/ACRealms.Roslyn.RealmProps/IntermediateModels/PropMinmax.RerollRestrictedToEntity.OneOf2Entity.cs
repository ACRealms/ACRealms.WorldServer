...
public readonly partial struct PropMinmax
{
    ...
    public readonly partial struct RerollRestrictedToEntity
    {
...

        {
            ...
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            public OneOf2Entity(string value)
            {
            ...
            /// <returns>An instance of this type, initialized from the provided value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OneOf2Entity FromString<TValue>(in TValue value)
            ...
            /// <returns>An instance of this type, initialized from the provided value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            static OneOf2Entity IJsonValue<OneOf2Entity>.FromObject<TValue>(in TValue value)
            {
                if (value.HasJsonElementBacking)
                {
                    return new(value.AsJsonElement);
