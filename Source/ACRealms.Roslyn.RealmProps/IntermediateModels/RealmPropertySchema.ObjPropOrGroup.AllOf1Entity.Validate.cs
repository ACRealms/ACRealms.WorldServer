        ...
        public readonly partial struct AllOf1Entity
        {
            ...
            public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
            {
                ...
                if (level > ValidationLevel.Basic)
                {
                    ...
                    result = result.PushSchemaLocation("https://realm.ac/schema/v1/realm-property-schema.json#/definitions/objPropOrGroup/allOf/1");
                }
            ...
            public static partial class CorvusValidation
            {
                    ...
                    ValidationLevel level = ValidationLevel.Flag)
                {
                    ...
                    ValidationContext ifResult = value.As<ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.ObjPropOrGroup.AllOf1Entity.WithTypeEnum>().Validate(validationContext.CreateChildContext(), level);
                    ...
                    if (ifResult.IsValid)
                    {
                        ...
                        ValidationContext thenResult = value.As<ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.ObjPropOrGroup.AllOf1Entity.RequiredEnum>().Validate(validationContext.CreateChildContext(), level);
