    ...
    public readonly partial struct StringForm
    {
        ...
        public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            if (level > ValidationLevel.Basic)
            {
                ...
                result = result.PushSchemaLocation("components/description.json#/oneOf/0");
            }
        ...
        public static partial class CorvusValidation
        {
                ...
                ValidationLevel level = ValidationLevel.Flag)
            {
                ...
                refResult = value.As<ACRealms.Roslyn.RealmProps.IntermediateModels.DescriptionPattern>().Validate(refResult, level);
                ...
                allOfResult0 = value.As<ACRealms.Roslyn.RealmProps.IntermediateModels.ValStringSimple>().Validate(allOfResult0, level);
