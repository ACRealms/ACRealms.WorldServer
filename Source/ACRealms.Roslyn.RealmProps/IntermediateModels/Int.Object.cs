    ...
    : IJsonObject<ACRealms.Roslyn.RealmProps.IntermediateModels.Int>
{
    ...
    /// </para>
    /// </remarks>
    public ACRealms.Roslyn.RealmProps.IntermediateModels.Int.RepresentsARealmPropertyIntInteger Type
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            ...
            if ((this.backing & Backing.Object) != 0)
            {
                ...
                {
                    return result.As<ACRealms.Roslyn.RealmProps.IntermediateModels.Int.RepresentsARealmPropertyIntInteger>();
                }
            }
    ...
    /// </summary>
    public static Int Create(in ACRealms.Roslyn.RealmProps.IntermediateModels.Int.RepresentsARealmPropertyIntInteger? type = null)
    {
    ...
    /// </para>
    /// </remarks>
    public Int WithType(in ACRealms.Roslyn.RealmProps.IntermediateModels.Int.RepresentsARealmPropertyIntInteger value)
    {
