...
public readonly partial struct Contexts
{
    ...
    public readonly partial struct OneOf0Entity
    {
        ...
        /// </summary>
        public static OneOf0Entity ConstInstance => CorvusValidation.Const.As<OneOf0Entity>();
                ...
                ValidationLevel level = ValidationLevel.Flag)
            {
                    ...
                    ValidationLevel level = ValidationLevel.Flag)
                {
                    ...
                    if (value.Equals(CorvusValidation.Const))
                    {
                        ...
                        {
                            result = result.WithResult(isValid: true, validationLocationReducedPathModifier: new JsonReference("const"), $"Validation const - the value '{value}' matched 'false'.");
                        }
                    ...
                    {
                        result = result.WithResult(isValid: false, validationLocationReducedPathModifier: new JsonReference("const"), $"Validation const - the value '{value}' did not match 'false'.");
                    }
                    else
                    {
                        result = result.WithResult(isValid: false, validationLocationReducedPathModifier: new JsonReference("const"), "Validation const - the value did not match 'false'.");
                    }
