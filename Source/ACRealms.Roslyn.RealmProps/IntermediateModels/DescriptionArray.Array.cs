      ...
      IReadOnlyCollection<ACRealms.Roslyn.RealmProps.IntermediateModels.DescriptionArray.ItemsEntity>
{
    ...
    /// <inheritdoc/>
    Corvus.Json.JsonAny IJsonArray<DescriptionArray>.this[int index]
    {
        get
        {
    ...
    /// <param name="items">The items from which to construct the instance.</param>
    /// <returns>An instance of the array constructed from the items .</returns>
    static DescriptionArray IJsonArray<DescriptionArray>.FromRange(IEnumerable<JsonAny> items)
    {
        return new([..items]);
    }
    ...
    /// <param name="items">The items from which to construct the instance.</param>
    /// <returns>An instance of the array constructed from the items.</returns>
    static DescriptionArray IJsonArray<DescriptionArray>.FromRange<T>(IEnumerable<T> items)
    {
    ...
    /// <inheritdoc/>
    JsonArrayEnumerator IJsonArray<DescriptionArray>.EnumerateArray()
    {
        if ((this.backing & Backing.JsonElement) != 0)
        {
            return new(this.jsonElementBacking);
    ...
    /// <inheritdoc/>
    JsonArrayEnumerator<TItem> IJsonArray<DescriptionArray>.EnumerateArray<TItem>()
    {
        if ((this.backing & Backing.JsonElement) != 0)
        {
            return new(this.jsonElementBacking);
    ...
    /// <inheritdoc/>
    DescriptionArray IJsonArray<DescriptionArray>.Add(in JsonAny item1)
    {
    ...
    /// <inheritdoc/>
    DescriptionArray IJsonArray<DescriptionArray>.Add(params JsonAny[] items)
    {
        ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
    ...
    /// <inheritdoc/>
    DescriptionArray IJsonArray<DescriptionArray>.AddRange<TArray>(in TArray items)
    {
        ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
    ...
    /// <inheritdoc/>
    DescriptionArray IJsonArray<DescriptionArray>.AddRange<TItem>(IEnumerable<TItem> items)
    {
        ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
    ...
    /// <inheritdoc/>
    DescriptionArray IJsonArray<DescriptionArray>.AddRange(IEnumerable<JsonAny> items)
    {
        ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
    ...
    /// <inheritdoc/>
    DescriptionArray IJsonArray<DescriptionArray>.Insert(int index, in JsonAny item1)
    {
        return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, item1));
    }

    /// <inheritdoc/>
    DescriptionArray IJsonArray<DescriptionArray>.InsertRange<TArray>(int index, in TArray items)
    {
        return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.EnumerateArray()));
    }

    /// <inheritdoc/>
    DescriptionArray IJsonArray<DescriptionArray>.InsertRange<TItem>(int index, IEnumerable<TItem> items)
    {
        return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.Select(item => item.AsAny)));
    }

    /// <inheritdoc/>
    DescriptionArray IJsonArray<DescriptionArray>.InsertRange(int index, IEnumerable<JsonAny> items)
    {
        return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items));
    }

    /// <inheritdoc/>
    DescriptionArray IJsonArray<DescriptionArray>.Replace(in JsonAny oldValue, in JsonAny newValue)
    {
        return new(__CorvusArrayHelpers.GetImmutableListReplacing(this, oldValue, newValue));
    }

    /// <inheritdoc/>
    DescriptionArray IJsonArray<DescriptionArray>.SetItem(int index, in JsonAny value)
    {
    ...
    /// <inheritdoc/>
    DescriptionArray IJsonArray<DescriptionArray>.Remove(in JsonAny oldValue)
    {
        return new(__CorvusArrayHelpers.GetImmutableListWithout(this, oldValue));
    }

    /// <inheritdoc/>
    DescriptionArray IJsonArray<DescriptionArray>.RemoveAt(int index)
    {
        return new(__CorvusArrayHelpers.GetImmutableListWithoutRange(this, index, 1));
    }

    /// <inheritdoc/>
    DescriptionArray IJsonArray<DescriptionArray>.RemoveRange(int index, int count)
    {
