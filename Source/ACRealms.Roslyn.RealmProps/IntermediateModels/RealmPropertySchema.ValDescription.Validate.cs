    ...
    public readonly partial struct ValDescription
    {
        ...
        public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            if (level > ValidationLevel.Basic)
            {
                ...
                result = result.PushSchemaLocation("https://realm.ac/schema/v1/realm-property-schema.json#/definitions/valDescription");
            }
        ...
        public static partial class CorvusValidation
        {
                ...
                ValidationLevel level = ValidationLevel.Flag)
            {
                ...
                ValidationContext oneOfResult0 = value.As<ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.ValDescription.OneOf0Entity>().Validate(oneOfChildContext0, level);
                ...
                ValidationContext oneOfResult1 = value.As<ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.DescriptionArray>().Validate(oneOfChildContext1, level);
