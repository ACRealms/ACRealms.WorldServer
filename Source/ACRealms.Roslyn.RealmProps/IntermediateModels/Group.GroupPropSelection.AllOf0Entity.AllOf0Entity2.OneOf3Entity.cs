        ...
        public readonly partial struct AllOf0Entity
        {
            ...
            public readonly partial struct AllOf0Entity2
            {
                ...
                public readonly partial struct OneOf3Entity
                    : IJsonValue<ACRealms.Roslyn.RealmProps.IntermediateModels.Group.GroupPropSelection.AllOf0Entity.AllOf0Entity2.OneOf3Entity>
                {
                    ...
                    /// <summary>
                    /// Parses the OneOf3Entity.
                    /// </summary>
                    /// <param name="source">The source of the JSON string to parse.</param>
                    /// <param name="options">The (optional) JsonDocumentOptions.</param>
                    public static OneOf3Entity Parse(string source, JsonDocumentOptions options = default)
                    {
                    ...
                    /// <param name="source">The source of the JSON string to parse.</param>
                    /// <param name="options">The (optional) JsonDocumentOptions.</param>
                    public static OneOf3Entity Parse(Stream source, JsonDocumentOptions options = default)
                    {
                        using var jsonDocument = JsonDocument.Parse(source, options);
                        return new(jsonDocument.RootElement.Clone());
                    }
                    ...
                    /// <param name="source">The source of the JSON string to parse.</param>
                    /// <param name="options">The (optional) JsonDocumentOptions.</param>
                    public static OneOf3Entity Parse(ReadOnlyMemory<byte> source, JsonDocumentOptions options = default)
                    {
                        using var jsonDocument = JsonDocument.Parse(source, options);
                        return new(jsonDocument.RootElement.Clone());
                    }
                    ...
                    /// <param name="source">The source of the JSON string to parse.</param>
                    /// <param name="options">The (optional) JsonDocumentOptions.</param>
                    public static OneOf3Entity Parse(ReadOnlyMemory<char> source, JsonDocumentOptions options = default)
                    {
                        using var jsonDocument = JsonDocument.Parse(source, options);
                        return new(jsonDocument.RootElement.Clone());
                    }
                    ...
                    /// <param name="source">The source of the JSON string to parse.</param>
                    /// <param name="options">The (optional) JsonDocumentOptions.</param>
                    public static OneOf3Entity Parse(ReadOnlySequence<byte> source, JsonDocumentOptions options = default)
                    {
                        using var jsonDocument = JsonDocument.Parse(source, options);
                        return new(jsonDocument.RootElement.Clone());
                    }
                    ...
                    /// </summary>
                    /// <param name="source">The source of the JSON string to parse.</param>
                    public static OneOf3Entity ParseValue(string source)
                    {
#if NET8_0_OR_GREATER
                        return IJsonValue<OneOf3Entity>.ParseValue(source);
#else
                        return JsonValueHelpers.ParseValue<OneOf3Entity>(source.AsSpan());
#endif
                    }
                    ...
                    /// </summary>
                    /// <param name="source">The source of the JSON string to parse.</param>
                    public static OneOf3Entity ParseValue(ReadOnlySpan<char> source)
                    {
#if NET8_0_OR_GREATER
                        return IJsonValue<OneOf3Entity>.ParseValue(source);
#else
                        return JsonValueHelpers.ParseValue<OneOf3Entity>(source);
#endif
                    }
                    ...
                    /// </summary>
                    /// <param name="source">The source of the JSON string to parse.</param>
                    public static OneOf3Entity ParseValue(ReadOnlySpan<byte> source)
                    {
#if NET8_0_OR_GREATER
                        return IJsonValue<OneOf3Entity>.ParseValue(source);
#else
                    ...
                    /// </summary>
                    /// <param name="source">The source of the JSON string to parse.</param>
                    public static OneOf3Entity ParseValue(ref Utf8JsonReader source)
                    {
#if NET8_0_OR_GREATER
                        return IJsonValue<OneOf3Entity>.ParseValue(ref source);
#else
                        return JsonValueHelpers.ParseValue<OneOf3Entity>(ref source);
#endif
                    }
                    ...
                    {
                        return
                            (obj is IJsonValue jv && this.Equals(jv.As<OneOf3Entity>())) ||
                    ...
                    {
                        return this.Equals(other.As<OneOf3Entity>());
                    }
