...
public readonly partial struct RealmPropertySchema
{
    ...
    public readonly partial struct ValBool
        : IJsonBoolean<ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.ValBool>
    {
        /// <summary>
        /// Conversion from <see cref="bool"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator ValBool(bool value)
        {
            return new(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator ValBool(JsonBoolean value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator JsonBoolean(ValBool value)
        {
            return
                value.AsBoolean;
        }
        ...
        public static implicit operator bool(ValBool value)
        {
