...
public readonly partial struct StringSplitArray
{
    ...
    public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
    {
        ...
        if (level > ValidationLevel.Basic)
        {
            ...
            result = result.PushSchemaLocation("components/string-split-array.json");
        }
    ...
    public static partial class CorvusValidation
    {
            ...
            ValidationLevel level)
        {
            ...
            int length = 0;
            using JsonArrayEnumerator<ACRealms.Roslyn.RealmProps.IntermediateModels.StringSplitArray.ItemsEntity> arrayEnumerator = value.EnumerateArray();
