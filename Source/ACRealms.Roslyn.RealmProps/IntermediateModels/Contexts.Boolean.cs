...
public readonly partial struct Contexts
    : IJsonBoolean<ACRealms.Roslyn.RealmProps.IntermediateModels.Contexts>
{
    /// <summary>
    /// Conversion from <see cref="bool"/>.
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator Contexts(bool value)
    {
        return new(value);
    }
    ...
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator Contexts(JsonBoolean value)
    {
    ...
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator JsonBoolean(Contexts value)
    {
        return
            value.AsBoolean;
    }
    ...
    public static implicit operator bool(Contexts value)
    {
