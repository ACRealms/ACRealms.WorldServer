...
/// <remarks>
/// <para>
/// A list of property ShortKeys, all inheriting the parameters defined by the group
/// </para>
/// </remarks>
#if NET8_0_OR_GREATER
[CollectionBuilder(typeof(ArrayShortPropList), "Create")]
#endif
      ...
      IReadOnlyCollection<ACRealms.Roslyn.RealmProps.IntermediateModels.PropDefKeyPart>
{
    ...
    /// Gets an empty array.
    /// </summary>
    public static ArrayShortPropList EmptyArray { get; } = From(ImmutableList<JsonAny>.Empty);
    ...
    /// <inheritdoc/>
    Corvus.Json.JsonAny IJsonArray<ArrayShortPropList>.this[int index]
    {
        get
        {
    ...
    public static implicit operator ArrayShortPropList(ImmutableList<JsonAny> value)
    {
        return new(value);
    }
    ...
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator ImmutableList<JsonAny>(ArrayShortPropList value)
    {
        return
    ...
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator ArrayShortPropList(JsonArray value)
    {
    ...
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator JsonArray(ArrayShortPropList value)
    {
        return
            value.AsArray;
    }
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ArrayShortPropList"/> struct.
    /// </summary>
    ...
    public static ArrayShortPropList From(ImmutableList<JsonAny> items)
    {
        return new(items);
    }

    /// <summary>
    /// Create an new instance of the <see cref="ArrayShortPropList"/>" struct from a span of items.
    /// </summary>
    ...
    /// <param name="items">The items from which to construct the instance.</param>
    /// <returns>An instance of the array constructed from the items .</returns>
    static ArrayShortPropList IJsonArray<ArrayShortPropList>.FromRange(IEnumerable<JsonAny> items)
    {
        return new([..items]);
    }
    ...
    /// <param name="items">The items from which to construct the instance.</param>
    /// <returns>An instance of the array constructed from the items.</returns>
    static ArrayShortPropList IJsonArray<ArrayShortPropList>.FromRange<T>(IEnumerable<T> items)
    {
    ...
    /// <inheritdoc/>
    JsonArrayEnumerator IJsonArray<ArrayShortPropList>.EnumerateArray()
    {
        if ((this.backing & Backing.JsonElement) != 0)
        {
            return new(this.jsonElementBacking);
    ...
    /// <inheritdoc/>
    JsonArrayEnumerator<TItem> IJsonArray<ArrayShortPropList>.EnumerateArray<TItem>()
    {
        if ((this.backing & Backing.JsonElement) != 0)
        {
            return new(this.jsonElementBacking);
    ...
    /// <inheritdoc/>
    ArrayShortPropList IJsonArray<ArrayShortPropList>.Add(in JsonAny item1)
    {
    ...
    /// <inheritdoc/>
    ArrayShortPropList IJsonArray<ArrayShortPropList>.Add(params JsonAny[] items)
    {
        ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
    ...
    /// <inheritdoc/>
    ArrayShortPropList IJsonArray<ArrayShortPropList>.AddRange<TArray>(in TArray items)
    {
        ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
    ...
    /// <inheritdoc/>
    ArrayShortPropList IJsonArray<ArrayShortPropList>.AddRange<TItem>(IEnumerable<TItem> items)
    {
        ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
    ...
    /// <inheritdoc/>
    ArrayShortPropList IJsonArray<ArrayShortPropList>.AddRange(IEnumerable<JsonAny> items)
    {
        ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
    ...
    /// <inheritdoc/>
    ArrayShortPropList IJsonArray<ArrayShortPropList>.Insert(int index, in JsonAny item1)
    {
        return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, item1));
    }

    /// <inheritdoc/>
    ArrayShortPropList IJsonArray<ArrayShortPropList>.InsertRange<TArray>(int index, in TArray items)
    {
        return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.EnumerateArray()));
    }

    /// <inheritdoc/>
    ArrayShortPropList IJsonArray<ArrayShortPropList>.InsertRange<TItem>(int index, IEnumerable<TItem> items)
    {
        return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.Select(item => item.AsAny)));
    }

    /// <inheritdoc/>
    ArrayShortPropList IJsonArray<ArrayShortPropList>.InsertRange(int index, IEnumerable<JsonAny> items)
    {
        return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items));
    }

    /// <inheritdoc/>
    ArrayShortPropList IJsonArray<ArrayShortPropList>.Replace(in JsonAny oldValue, in JsonAny newValue)
    {
        return new(__CorvusArrayHelpers.GetImmutableListReplacing(this, oldValue, newValue));
    }

    /// <inheritdoc/>
    ArrayShortPropList IJsonArray<ArrayShortPropList>.SetItem(int index, in JsonAny value)
    {
    ...
    /// <inheritdoc/>
    ArrayShortPropList IJsonArray<ArrayShortPropList>.Remove(in JsonAny oldValue)
    {
        return new(__CorvusArrayHelpers.GetImmutableListWithout(this, oldValue));
    }

    /// <inheritdoc/>
    ArrayShortPropList IJsonArray<ArrayShortPropList>.RemoveAt(int index)
    {
        return new(__CorvusArrayHelpers.GetImmutableListWithoutRange(this, index, 1));
    }

    /// <inheritdoc/>
    ArrayShortPropList IJsonArray<ArrayShortPropList>.RemoveRange(int index, int count)
    {
    ...
    private static class __CorvusArrayHelpers
    {
        ...
        /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
        public static ImmutableList<JsonAny> GetImmutableList(in ArrayShortPropList arrayInstance)
        {
        ...
        /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
        public static ImmutableList<JsonAny>.Builder GetImmutableListBuilder(in ArrayShortPropList arrayInstance)
        {
        ...
        public static ImmutableList<JsonAny> GetImmutableListSetting(in ArrayShortPropList arrayInstance, int index, in JsonAny value)
        {
            if ((arrayInstance.backing & Backing.JsonElement) != 0)
            {
                if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
        ...
        /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
        public static ImmutableList<JsonAny> GetImmutableListReplacing(in ArrayShortPropList arrayInstance, in JsonAny oldItem, in JsonAny newItem)
        {
            if ((arrayInstance.backing & Backing.JsonElement) != 0)
            {
                if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
        ...
        /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
        public static ImmutableList<JsonAny> GetImmutableListWithout(in ArrayShortPropList arrayInstance, in JsonAny item)
        {
            if ((arrayInstance.backing & Backing.JsonElement) != 0)
            {
                if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
        ...
        /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
        /// <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
        public static ImmutableList<JsonAny> GetImmutableListWithoutRange(in ArrayShortPropList arrayInstance, int index, int count)
        {
            if ((arrayInstance.backing & Backing.JsonElement) != 0)
            {
                if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
        ...
        // <exception cref = "InvalidOperationException">The value is not an array.</exception>
        // <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
        public static ImmutableList<JsonAny> GetImmutableListWith(in ArrayShortPropList arrayInstance, int index, in JsonAny value)
        {
            if ((arrayInstance.backing & Backing.JsonElement) != 0)
            {
                if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
        ...
        /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
        /// <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
        public static ImmutableList<JsonAny> GetImmutableListWith<TEnumerable>(in ArrayShortPropList arrayInstance, int index, TEnumerable values)
