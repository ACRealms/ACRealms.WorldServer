        ...
        public readonly partial struct ItemsEntity
        {
            ...
            public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
            {
                ...
                if (level > ValidationLevel.Basic)
                {
                    ...
                    result = result.PushSchemaLocation("#/definitions/descriptionArray/items");
                }
            ...
            public static partial class CorvusValidation
            {
                ...
                /// </summary>
                public static readonly long MaxLength = 200;
                    ...
                    ValidationLevel level = ValidationLevel.Flag)
                {
                    ...
                    allOfResult0 = value.As<ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.DescriptionPattern>().Validate(allOfResult0, level);
