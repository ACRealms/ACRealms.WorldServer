                ...
                public readonly partial struct OneOf3Entity
                {
                    ...
                    public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
                    {
                        ...
                        if (level > ValidationLevel.Basic)
                        {
                            ...
                            result = result.PushSchemaLocation("realm-props/group.json#/definitions/groupPropSelection/allOf/0/allOf/0/oneOf/3");
                        }
                    ...
                    public static partial class CorvusValidation
                    {
                            ...
                            ValidationLevel level = ValidationLevel.Flag)
                        {
                            ...
                            ValidationContext ifResult = value.As<ACRealms.Roslyn.RealmProps.IntermediateModels.Float>().Validate(validationContext.CreateChildContext(), level);
                            ...
                            if (ifResult.IsValid)
                            {
                                ...
                                ValidationContext thenResult = value.As<ACRealms.Roslyn.RealmProps.IntermediateModels.Float>().Validate(validationContext.CreateChildContext(), level);
