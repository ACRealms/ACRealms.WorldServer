            ...
            public static partial class CorvusValidation
            {
                    ...
                    ValidationLevel level = ValidationLevel.Flag)
                {
                    ...
                    if (ifResult.IsValid)
                    {
                        ...
                        ValidationContext thenResult = value.As<ACRealms.Roslyn.RealmProps.IntermediateModels.Group.TypedPropDefs.FloatEntity>().Validate(validationContext.CreateChildContext(), level);
