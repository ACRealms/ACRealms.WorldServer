    ...
    : IJsonObject<ACRealms.Roslyn.RealmProps.IntermediateModels.String>
{
    ...
    /// </para>
    /// </remarks>
    public ACRealms.Roslyn.RealmProps.IntermediateModels.String.RepresentsARealmPropertyString Type
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            ...
            if ((this.backing & Backing.Object) != 0)
            {
                ...
                {
                    return result.As<ACRealms.Roslyn.RealmProps.IntermediateModels.String.RepresentsARealmPropertyString>();
                }
            }
    ...
    /// </summary>
    public static String Create(in ACRealms.Roslyn.RealmProps.IntermediateModels.String.RepresentsARealmPropertyString? type = null)
    {
    ...
    /// </para>
    /// </remarks>
    public String WithType(in ACRealms.Roslyn.RealmProps.IntermediateModels.String.RepresentsARealmPropertyString value)
    {
