...
public readonly partial struct Group
{
    ...
    public readonly partial struct TypedPropDefs
    {
        ...
        public readonly partial struct AllOf3Entity
            : IJsonValue<ACRealms.Roslyn.RealmProps.IntermediateModels.Group.TypedPropDefs.AllOf3Entity>
        {
            ...
            /// <summary>
            /// Gets the instance as a <see cref="ACRealms.Roslyn.RealmProps.IntermediateModels.Group.TypedPropDefs.FloatEntity" />.
            /// </summary>
            public ACRealms.Roslyn.RealmProps.IntermediateModels.Group.TypedPropDefs.FloatEntity AsFloatEntity
            {
                get
                {
                    return this.As<ACRealms.Roslyn.RealmProps.IntermediateModels.Group.TypedPropDefs.FloatEntity>();
                }
            }

            /// <summary>
            /// Gets a value indicating whether the instance is a <see cref="ACRealms.Roslyn.RealmProps.IntermediateModels.Group.TypedPropDefs.FloatEntity" />.
            /// </summary>
            public bool IsFloatEntity
            {
                get
                {
                    return this.As<ACRealms.Roslyn.RealmProps.IntermediateModels.Group.TypedPropDefs.FloatEntity>().IsValid();
                }
            }
            ...
            /// <param name="matchAcRealmsRoslynRealmPropsIntermediateModelsGroupTypedPropDefsFloatEntity">Match a <see cref="ACRealms.Roslyn.RealmProps.IntermediateModels.Group.TypedPropDefs.FloatEntity"/>.</param>
            /// <param name="defaultMatch">Default match if the 'if' schema did not match.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TOut Match<TIn, TOut>(
                in TIn context,
                Matcher<ACRealms.Roslyn.RealmProps.IntermediateModels.Group.TypedPropDefs.FloatEntity, TIn, TOut> matchAcRealmsRoslynRealmPropsIntermediateModelsGroupTypedPropDefsFloatEntity,
                Matcher<AllOf3Entity, TIn, TOut> defaultMatch)
            {
                ACRealms.Roslyn.RealmProps.IntermediateModels.Float ifValue = this.As<ACRealms.Roslyn.RealmProps.IntermediateModels.Float>();
                if (ifValue.IsValid())
                {
                    return matchAcRealmsRoslynRealmPropsIntermediateModelsGroupTypedPropDefsFloatEntity(this.As<ACRealms.Roslyn.RealmProps.IntermediateModels.Group.TypedPropDefs.FloatEntity>(), context);
                }
            ...
            public TOut Match<TOut>(
                Matcher<ACRealms.Roslyn.RealmProps.IntermediateModels.Group.TypedPropDefs.FloatEntity, TOut> matchAcRealmsRoslynRealmPropsIntermediateModelsGroupTypedPropDefsFloatEntity,
                Matcher<AllOf3Entity, TOut> defaultMatch)
            {
                ACRealms.Roslyn.RealmProps.IntermediateModels.Float ifValue = this.As<ACRealms.Roslyn.RealmProps.IntermediateModels.Float>();
                if (ifValue.IsValid())
                {
                    return matchAcRealmsRoslynRealmPropsIntermediateModelsGroupTypedPropDefsFloatEntity(this.As<ACRealms.Roslyn.RealmProps.IntermediateModels.Group.TypedPropDefs.FloatEntity>());
                }
            ...
            /// <summary>
            /// Gets the value as a <see cref="ACRealms.Roslyn.RealmProps.IntermediateModels.Group.TypedPropDefs.FloatEntity" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsFloatEntity(out ACRealms.Roslyn.RealmProps.IntermediateModels.Group.TypedPropDefs.FloatEntity result)
            {
                result = this.As<ACRealms.Roslyn.RealmProps.IntermediateModels.Group.TypedPropDefs.FloatEntity>();
                return result.IsValid();
            }
        }
    }
