...
public readonly partial struct PropMinmax
{
    ...
    public readonly partial struct RerollRestrictedToEntity
    {
        ...
        public readonly partial struct OneOf2Entity
            ...
            : IJsonString<ACRealms.Roslyn.RealmProps.IntermediateModels.PropMinmax.RerollRestrictedToEntity.OneOf2Entity>,
              ISpanFormattable
#else
            : IJsonString<ACRealms.Roslyn.RealmProps.IntermediateModels.PropMinmax.RerollRestrictedToEntity.OneOf2Entity>
#endif
        {
            ...
            public OneOf2Entity(in ReadOnlySpan<char> value)
            {
            ...
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            public OneOf2Entity(in ReadOnlySpan<byte> value)
            {
                this.backing = Backing.String;
                this.jsonElementBacking = default;
            ...
            public static implicit operator OneOf2Entity(string value)
            {
                return new(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator OneOf2Entity(JsonString value)
            {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator JsonString(OneOf2Entity value)
            {
                return
                    value.AsString;
            }
            ...
            public static explicit operator string(OneOf2Entity value)
            {
            ...
            /// <summary>
            /// Concatenate 2 JSON values, producing an instance of the string type OneOf2Entity.
            /// </summary>
            ...
            public static OneOf2Entity Concatenate<T1, T2>(Span<byte> buffer, in T1 value1, in T2 value2)
            ...
            /// <summary>
            /// Concatenate 3 JSON values, producing an instance of the string type OneOf2Entity.
            /// </summary>
            /// <typeparam name="T1">The type of the 1st value.</typeparam>
            /// <typeparam name="T2">The type of the 2nd value.</typeparam>
            ...
            /// <returns>An instance of this string type.</returns>
            public static OneOf2Entity Concatenate<T1, T2, T3>(Span<byte> buffer, in T1 value1, in T2 value2, in T3 value3)
                where T1 : struct, IJsonValue<T1>
                where T2 : struct, IJsonValue<T2>
            ...
            /// <summary>
            /// Concatenate 4 JSON values, producing an instance of the string type OneOf2Entity.
            /// </summary>
            /// <typeparam name="T1">The type of the 1st value.</typeparam>
            /// <typeparam name="T2">The type of the 2nd value.</typeparam>
            /// <typeparam name="T3">The type of the 3rd value.</typeparam>
            ...
            /// <returns>An instance of this string type.</returns>
            public static OneOf2Entity Concatenate<T1, T2, T3, T4>(Span<byte> buffer, in T1 value1, in T2 value2, in T3 value3, in T4 value4)
                where T1 : struct, IJsonValue<T1>
                where T2 : struct, IJsonValue<T2>
                where T3 : struct, IJsonValue<T3>
            ...
            /// <summary>
            /// Concatenate 5 JSON values, producing an instance of the string type OneOf2Entity.
            /// </summary>
            /// <typeparam name="T1">The type of the 1st value.</typeparam>
            /// <typeparam name="T2">The type of the 2nd value.</typeparam>
            /// <typeparam name="T3">The type of the 3rd value.</typeparam>
            ...
            /// <returns>An instance of this string type.</returns>
            public static OneOf2Entity Concatenate<T1, T2, T3, T4, T5>(Span<byte> buffer, in T1 value1, in T2 value2, in T3 value3, in T4 value4, in T5 value5)
                where T1 : struct, IJsonValue<T1>
                where T2 : struct, IJsonValue<T2>
                where T3 : struct, IJsonValue<T3>
                where T4 : struct, IJsonValue<T4>
            ...
            /// <summary>
            /// Concatenate 6 JSON values, producing an instance of the string type OneOf2Entity.
            /// </summary>
            /// <typeparam name="T1">The type of the 1st value.</typeparam>
            /// <typeparam name="T2">The type of the 2nd value.</typeparam>
            /// <typeparam name="T3">The type of the 3rd value.</typeparam>
            ...
            /// <returns>An instance of this string type.</returns>
            public static OneOf2Entity Concatenate<T1, T2, T3, T4, T5, T6>(Span<byte> buffer, in T1 value1, in T2 value2, in T3 value3, in T4 value4, in T5 value5, in T6 value6)
                where T1 : struct, IJsonValue<T1>
                where T2 : struct, IJsonValue<T2>
                where T3 : struct, IJsonValue<T3>
                where T4 : struct, IJsonValue<T4>
            ...
            /// <summary>
            /// Concatenate 7 JSON values, producing an instance of the string type OneOf2Entity.
            /// </summary>
            /// <typeparam name="T1">The type of the 1st value.</typeparam>
            /// <typeparam name="T2">The type of the 2nd value.</typeparam>
            /// <typeparam name="T3">The type of the 3rd value.</typeparam>
            ...
            /// <returns>An instance of this string type.</returns>
            public static OneOf2Entity Concatenate<T1, T2, T3, T4, T5, T6, T7>(Span<byte> buffer, in T1 value1, in T2 value2, in T3 value3, in T4 value4, in T5 value5, in T6 value6, in T7 value7)
                where T1 : struct, IJsonValue<T1>
                where T2 : struct, IJsonValue<T2>
                where T3 : struct, IJsonValue<T3>
                where T4 : struct, IJsonValue<T4>
            ...
            /// <summary>
            /// Concatenate 8 JSON values, producing an instance of the string type OneOf2Entity.
            /// </summary>
            /// <typeparam name="T1">The type of the 1st value.</typeparam>
            /// <typeparam name="T2">The type of the 2nd value.</typeparam>
            /// <typeparam name="T3">The type of the 3rd value.</typeparam>
            ...
            /// <returns>An instance of this string type.</returns>
            public static OneOf2Entity Concatenate<T1, T2, T3, T4, T5, T6, T7, T8>(Span<byte> buffer, in T1 value1, in T2 value2, in T3 value3, in T4 value4, in T5 value5, in T6 value6, in T7 value7, in T8 value8)
                where T1 : struct, IJsonValue<T1>
                where T2 : struct, IJsonValue<T2>
                where T3 : struct, IJsonValue<T3>
                where T4 : struct, IJsonValue<T4>
