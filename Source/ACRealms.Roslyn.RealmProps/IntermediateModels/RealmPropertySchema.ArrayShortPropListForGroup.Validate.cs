    ...
    public readonly partial struct ArrayShortPropListForGroup
    {
        ...
        public static partial class CorvusValidation
        {
            ...
            internal static ValidationContext ArrayValidationHandler(
                in ArrayShortPropListForGroup value,
                JsonValueKind valueKind,
                in ValidationContext validationContext,
                ValidationLevel level)
            {
                ...
                int length = 0;
                using JsonArrayEnumerator<ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.PropName> arrayEnumerator = value.EnumerateArray();
