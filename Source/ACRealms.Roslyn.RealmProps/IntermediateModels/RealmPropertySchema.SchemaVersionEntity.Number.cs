...
#if NET8_0_OR_GREATER
        : IJsonNumber<ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.SchemaVersionEntity>,
          IAdditionOperators<ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.SchemaVersionEntity, ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.SchemaVersionEntity, ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.SchemaVersionEntity>,
          ISubtractionOperators<ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.SchemaVersionEntity, ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.SchemaVersionEntity, ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.SchemaVersionEntity>,
          IMultiplyOperators<ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.SchemaVersionEntity, ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.SchemaVersionEntity, ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.SchemaVersionEntity>,
          IDivisionOperators<ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.SchemaVersionEntity, ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.SchemaVersionEntity, ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.SchemaVersionEntity>,
          IIncrementOperators<ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.SchemaVersionEntity>,
          IDecrementOperators<ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.SchemaVersionEntity>
#else
        : IJsonNumber<ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.SchemaVersionEntity>
#endif
    {
        ...
        public SchemaVersionEntity(long value)
        ...
        public static implicit operator SchemaVersionEntity(JsonNumber value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator JsonNumber(SchemaVersionEntity value)
        {
            return
                value.AsNumber;
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator JsonInteger(SchemaVersionEntity value)
        {
            return
        ...
        public static explicit operator byte(SchemaVersionEntity value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="SchemaVersionEntity"/>.</returns>
        public static explicit operator SchemaVersionEntity(byte value)
        {
        ...
        public static explicit operator decimal(SchemaVersionEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="SchemaVersionEntity"/>.</returns>
        public static explicit operator SchemaVersionEntity(decimal value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator double(SchemaVersionEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="SchemaVersionEntity"/>.</returns>
        public static explicit operator SchemaVersionEntity(double value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator short(SchemaVersionEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="SchemaVersionEntity"/>.</returns>
        public static explicit operator SchemaVersionEntity(short value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator int(SchemaVersionEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="SchemaVersionEntity"/>.</returns>
        public static explicit operator SchemaVersionEntity(int value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static implicit operator long(SchemaVersionEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="SchemaVersionEntity"/>.</returns>
        public static implicit operator SchemaVersionEntity(long value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator Int128(SchemaVersionEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="SchemaVersionEntity"/>.</returns>
        public static explicit operator SchemaVersionEntity(Int128 value)
        {
            return new(new BinaryJsonNumber(value));
        }
#endif
        ...
        public static explicit operator sbyte(SchemaVersionEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="SchemaVersionEntity"/>.</returns>
        public static explicit operator SchemaVersionEntity(sbyte value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator Half(SchemaVersionEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="SchemaVersionEntity"/>.</returns>
        public static explicit operator SchemaVersionEntity(Half value)
        {
            return new(new BinaryJsonNumber(value));
        }
#endif
        ...
        public static explicit operator float(SchemaVersionEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="SchemaVersionEntity"/>.</returns>
        public static explicit operator SchemaVersionEntity(float value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator ushort(SchemaVersionEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="SchemaVersionEntity"/>.</returns>
        public static explicit operator SchemaVersionEntity(ushort value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator uint(SchemaVersionEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="SchemaVersionEntity"/>.</returns>
        public static explicit operator SchemaVersionEntity(uint value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator ulong(SchemaVersionEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="SchemaVersionEntity"/>.</returns>
        public static explicit operator SchemaVersionEntity(ulong value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator UInt128(SchemaVersionEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="SchemaVersionEntity"/>.</returns>
        public static explicit operator SchemaVersionEntity(UInt128 value)
        {
            return new(new BinaryJsonNumber(value));
        }
#endif
        ...
        /// </returns>
        public static bool operator <(SchemaVersionEntity left, SchemaVersionEntity right)
        {
        ...
        public static SchemaVersionEntity operator +(SchemaVersionEntity left, SchemaVersionEntity right)
        {
        ...
        /// <returns>The result of the operation.</returns>
        public static SchemaVersionEntity operator ++(SchemaVersionEntity value)
        {
        ...
        /// </returns>
        public static int Compare(in SchemaVersionEntity lhs, in SchemaVersionEntity rhs)
        {
