...
public readonly partial struct ValInt
{
    ...
    public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
    {
        ...
        if (level > ValidationLevel.Basic)
        {
            ...
            result = result.PushSchemaLocation("components/primitives/val-int.json");
        }
    ...
    public static partial class CorvusValidation
    {
        ...
        /// </summary>
        public static readonly BinaryJsonNumber Maximum = new(2147483647);

        /// <summary>
        /// A constant for the <c>minimum</c> keyword.
        /// </summary>
        public static readonly BinaryJsonNumber Minimum = new(-2147483648);
