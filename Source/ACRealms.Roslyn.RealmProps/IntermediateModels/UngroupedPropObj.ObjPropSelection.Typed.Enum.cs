...
public readonly partial struct UngroupedPropObj
{
    ...
    public readonly partial struct ObjPropSelection
    {
        ...
        public readonly partial struct Typed
        {
            ...
            /// Generated from JSON Schema.
            /// </summary>
            [System.Text.Json.Serialization.JsonConverter(typeof(Corvus.Json.Internal.JsonValueConverter<Enum>))]
            public readonly partial struct Enum
                : IJsonValue<ACRealms.Roslyn.RealmProps.IntermediateModels.UngroupedPropObj.ObjPropSelection.Typed.Enum>
            {
                ...
                public Enum(in JsonElement value)
                {
                ...
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                public Enum(ImmutableList<JsonObjectProperty> value)
                {
                ...
                /// </summary>
                public static string SchemaLocation { get; } = "realm-props/props/prop.json#/definitions/objPropSelection/allOf/0/oneOf/0";

                /// <summary>
                /// Gets a Null instance.
                /// </summary>
                public static Enum Null { get; } = new(JsonValueHelpers.NullElement);

                /// <summary>
                /// Gets an Undefined instance.
                /// </summary>
                public static Enum Undefined { get; }
                ...
                public static implicit operator Enum(JsonAny value)
                {
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator JsonAny(Enum value)
                {
                    return value.AsAny;
                }
                ...
                /// </returns>
                public static bool operator ==(in Enum left, in Enum right)
                {
                ...
                public static Enum FromJson(in JsonElement value)
                {
                    return new(value);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static Enum FromAny(in JsonAny value)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                static Enum IJsonValue<Enum>.FromBoolean<TValue>(in TValue value)
                {
                    if (value.HasJsonElementBacking)
                    {
                        return new(value.AsJsonElement);
                ...
                /// <returns>An instance of this type, initialized from the provided value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                static Enum IJsonValue<Enum>.FromString<TValue>(in TValue value)
                {
                    if (value.HasJsonElementBacking)
                    {
                        return new(value.AsJsonElement);
                ...
                /// <returns>An instance of this type, initialized from the provided value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                static Enum IJsonValue<Enum>.FromNumber<TValue>(in TValue value)
                {
                    if (value.HasJsonElementBacking)
                    {
                        return new(value.AsJsonElement);
                ...
                /// <returns>An instance of this type, initialized from the provided value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static Enum FromObject<TValue>(in TValue value)
                ...
                /// <returns>An instance of this type, initialized from the provided value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                static Enum IJsonValue<Enum>.FromArray<TValue>(in TValue value)
                {
                    if (value.HasJsonElementBacking)
                    {
                        return new(value.AsJsonElement);
                ...
                public static Enum Parse(string source, JsonDocumentOptions options = default)
                {
                ...
                /// <param name="source">The source of the JSON string to parse.</param>
                /// <param name="options">The (optional) JsonDocumentOptions.</param>
                public static Enum Parse(Stream source, JsonDocumentOptions options = default)
                {
                    using var jsonDocument = JsonDocument.Parse(source, options);
                    return new(jsonDocument.RootElement.Clone());
                }
                ...
                /// <param name="source">The source of the JSON string to parse.</param>
                /// <param name="options">The (optional) JsonDocumentOptions.</param>
                public static Enum Parse(ReadOnlyMemory<byte> source, JsonDocumentOptions options = default)
                {
                    using var jsonDocument = JsonDocument.Parse(source, options);
                    return new(jsonDocument.RootElement.Clone());
                }
                ...
                /// <param name="source">The source of the JSON string to parse.</param>
                /// <param name="options">The (optional) JsonDocumentOptions.</param>
                public static Enum Parse(ReadOnlyMemory<char> source, JsonDocumentOptions options = default)
                {
                    using var jsonDocument = JsonDocument.Parse(source, options);
                    return new(jsonDocument.RootElement.Clone());
                }
                ...
                /// <param name="source">The source of the JSON string to parse.</param>
                /// <param name="options">The (optional) JsonDocumentOptions.</param>
                public static Enum Parse(ReadOnlySequence<byte> source, JsonDocumentOptions options = default)
                {
                    using var jsonDocument = JsonDocument.Parse(source, options);
                    return new(jsonDocument.RootElement.Clone());
                }
                ...
                /// </summary>
                /// <param name="source">The source of the JSON string to parse.</param>
                public static Enum ParseValue(string source)
                {
#if NET8_0_OR_GREATER
                    return IJsonValue<Enum>.ParseValue(source);
#else
                    return JsonValueHelpers.ParseValue<Enum>(source.AsSpan());
#endif
                }
                ...
                /// </summary>
                /// <param name="source">The source of the JSON string to parse.</param>
                public static Enum ParseValue(ReadOnlySpan<char> source)
                {
#if NET8_0_OR_GREATER
                    return IJsonValue<Enum>.ParseValue(source);
#else
                    return JsonValueHelpers.ParseValue<Enum>(source);
#endif
                }
                ...
                /// </summary>
                /// <param name="source">The source of the JSON string to parse.</param>
                public static Enum ParseValue(ReadOnlySpan<byte> source)
                {
#if NET8_0_OR_GREATER
                    return IJsonValue<Enum>.ParseValue(source);
#else
                ...
                /// </summary>
                /// <param name="source">The source of the JSON string to parse.</param>
                public static Enum ParseValue(ref Utf8JsonReader source)
                {
#if NET8_0_OR_GREATER
                    return IJsonValue<Enum>.ParseValue(ref source);
#else
                    return JsonValueHelpers.ParseValue<Enum>(ref source);
#endif
                }
                ...
                {
                    return
                        (obj is IJsonValue jv && this.Equals(jv.As<Enum>())) ||
                ...
                public bool Equals(in Enum other)
                {
