...
public readonly partial struct RealmPropertySchema
{
    ...
    public readonly partial struct ObjPropOrGroup
    {
...

        {
            ...
            /// <param name="matchManual">Match 2nd item.</param>
            /// <param name="matchLandblock">Match 3rd item.</param>
            /// <param name="matchAlways">Match 4th item.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TOut Match<TIn, TOut>(
                in TIn context,
                Func<TIn, TOut> matchNever,
                Func<TIn, TOut> matchManual,
                Func<TIn, TOut> matchLandblock,
            ...
            public TOut Match<TOut>(
                Func<TOut> matchNever,
                Func<TOut> matchManual,
                Func<TOut> matchLandblock,
