    ...
    public readonly partial struct ModulatorEntity
    {
        ...
        public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            if (level > ValidationLevel.Basic)
            {
                ...
                result = result.PushSchemaLocation("realm-props/group.json#/definitions/props/definitions/modulator");
            }
        ...
        public static partial class CorvusValidation
        {
                ...
                ValidationLevel level = ValidationLevel.Flag)
            {
                ...
                if (ifResult.IsValid)
                {
                    ...
                    ValidationContext thenResult = value.As<ACRealms.Roslyn.RealmProps.IntermediateModels.Group.ModulatorEntity.ThenEntity>().Validate(validationContext.CreateChildContext(), level);
