...
public readonly partial struct RealmPropertySchema
{
    ...
    /// </para>
    /// </remarks>
    public readonly partial struct ValFloat
#if NET8_0_OR_GREATER
        : IJsonNumber<ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.ValFloat>,
          IAdditionOperators<ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.ValFloat, ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.ValFloat, ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.ValFloat>,
          ISubtractionOperators<ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.ValFloat, ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.ValFloat, ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.ValFloat>,
          IMultiplyOperators<ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.ValFloat, ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.ValFloat, ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.ValFloat>,
          IDivisionOperators<ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.ValFloat, ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.ValFloat, ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.ValFloat>,
          IIncrementOperators<ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.ValFloat>,
          IDecrementOperators<ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.ValFloat>
#else
        : IJsonNumber<ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.ValFloat>
#endif
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "ValFloat"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        public ValFloat(double value)
        ...
        public static implicit operator ValFloat(JsonNumber value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator JsonNumber(ValFloat value)
        {
            return
                value.AsNumber;
        }
        ...
        public static explicit operator byte(ValFloat value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="ValFloat"/>.</returns>
        public static explicit operator ValFloat(byte value)
        {
        ...
        public static explicit operator decimal(ValFloat value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="ValFloat"/>.</returns>
        public static explicit operator ValFloat(decimal value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static implicit operator double(ValFloat value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="ValFloat"/>.</returns>
        public static implicit operator ValFloat(double value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator short(ValFloat value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="ValFloat"/>.</returns>
        public static explicit operator ValFloat(short value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator int(ValFloat value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="ValFloat"/>.</returns>
        public static explicit operator ValFloat(int value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator long(ValFloat value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="ValFloat"/>.</returns>
        public static explicit operator ValFloat(long value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator Int128(ValFloat value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="ValFloat"/>.</returns>
        public static explicit operator ValFloat(Int128 value)
        {
            return new(new BinaryJsonNumber(value));
        }
#endif
        ...
        public static explicit operator sbyte(ValFloat value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="ValFloat"/>.</returns>
        public static explicit operator ValFloat(sbyte value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator Half(ValFloat value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="ValFloat"/>.</returns>
        public static explicit operator ValFloat(Half value)
        {
            return new(new BinaryJsonNumber(value));
        }
#endif
        ...
        public static explicit operator float(ValFloat value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="ValFloat"/>.</returns>
        public static explicit operator ValFloat(float value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator ushort(ValFloat value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="ValFloat"/>.</returns>
        public static explicit operator ValFloat(ushort value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator uint(ValFloat value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="ValFloat"/>.</returns>
        public static explicit operator ValFloat(uint value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator ulong(ValFloat value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="ValFloat"/>.</returns>
        public static explicit operator ValFloat(ulong value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator UInt128(ValFloat value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="ValFloat"/>.</returns>
        public static explicit operator ValFloat(UInt128 value)
        {
            return new(new BinaryJsonNumber(value));
        }
#endif
        ...
        /// </returns>
        public static bool operator <(ValFloat left, ValFloat right)
        {
        ...
        public static ValFloat operator +(ValFloat left, ValFloat right)
        {
        ...
        /// <returns>The result of the operation.</returns>
        public static ValFloat operator ++(ValFloat value)
        {
        ...
        /// </returns>
        public static int Compare(in ValFloat lhs, in ValFloat rhs)
        {
