...
public readonly partial struct Contexts
{
        ...
        : IJsonObject<ACRealms.Roslyn.RealmProps.IntermediateModels.Contexts.ContextObj>
    {
        ...
        /// </para>
        /// </remarks>
        public ACRealms.Roslyn.RealmProps.IntermediateModels.Contexts.ContextVal Entity
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                ...
                if ((this.backing & Backing.Object) != 0)
                {
                    ...
                    {
                        return result.As<ACRealms.Roslyn.RealmProps.IntermediateModels.Contexts.ContextVal>();
                    }
                }
        ...
        public static ContextObj Create(
            in ACRealms.Roslyn.RealmProps.IntermediateModels.Contexts.ContextVal entity,
        ...
        /// <param name="value">The new property value</param>
        /// <returns>The instance with the property set.</returns>
        public ContextObj WithEntity(in ACRealms.Roslyn.RealmProps.IntermediateModels.Contexts.ContextVal value)
        {
