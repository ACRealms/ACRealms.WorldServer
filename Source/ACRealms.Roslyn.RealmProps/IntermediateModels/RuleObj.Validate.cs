...
public readonly partial struct RuleObj
{
    ...
    public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
    {
        ...
        if (level > ValidationLevel.Basic)
        {
            ...
            result = result.PushSchemaLocation("realm-props/group/rule-obj.json");
        }
    ...
    public static partial class CorvusValidation
    {
            ...
            ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            refResult = value.As<ACRealms.Roslyn.RealmProps.IntermediateModels.RuleBase>().Validate(refResult, level);
            ...
            allOfResult0 = value.As<ACRealms.Roslyn.RealmProps.IntermediateModels.RuleObj.ExtendedUntypedAttrs>().Validate(allOfResult0, level);
