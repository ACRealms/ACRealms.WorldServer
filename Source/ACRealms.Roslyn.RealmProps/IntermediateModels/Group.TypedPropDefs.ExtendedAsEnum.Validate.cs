        ...
        public readonly partial struct ExtendedAsEnum
        {
            ...
            public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
            {
                ...
                if (level > ValidationLevel.Basic)
                {
                    ...
                    result = result.PushSchemaLocation("realm-props/group.json#/definitions/typedPropDefs/definitions/enum");
                }
            ...
            public static partial class CorvusValidation
            {
                    ...
                    ValidationLevel level = ValidationLevel.Flag)
                {
                    ...
                    allOfResult0 = value.As<ACRealms.Roslyn.RealmProps.IntermediateModels.Group.TypedPropDefs.ExtendedAsEnum.AllOf0Entity>().Validate(allOfResult0, level);
