...
public readonly partial struct RealmPropertySchema
{
    ...
    /// </para>
    /// </remarks>
    public readonly partial struct ValLong
#if NET8_0_OR_GREATER
        : IJsonNumber<ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.ValLong>,
          IAdditionOperators<ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.ValLong, ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.ValLong, ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.ValLong>,
          ISubtractionOperators<ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.ValLong, ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.ValLong, ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.ValLong>,
          IMultiplyOperators<ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.ValLong, ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.ValLong, ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.ValLong>,
          IDivisionOperators<ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.ValLong, ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.ValLong, ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.ValLong>,
          IIncrementOperators<ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.ValLong>,
          IDecrementOperators<ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.ValLong>
#else
        : IJsonNumber<ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.ValLong>
#endif
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "ValLong"/> struct.
        /// </summary>
        ...
        public static implicit operator ValLong(JsonNumber value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator JsonNumber(ValLong value)
        {
            return
                value.AsNumber;
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator JsonInteger(ValLong value)
        {
            return
        ...
        public static explicit operator byte(ValLong value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="ValLong"/>.</returns>
        public static explicit operator ValLong(byte value)
        {
        ...
        public static explicit operator decimal(ValLong value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="ValLong"/>.</returns>
        public static explicit operator ValLong(decimal value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator double(ValLong value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="ValLong"/>.</returns>
        public static explicit operator ValLong(double value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator short(ValLong value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="ValLong"/>.</returns>
        public static explicit operator ValLong(short value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator int(ValLong value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="ValLong"/>.</returns>
        public static explicit operator ValLong(int value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static implicit operator long(ValLong value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="ValLong"/>.</returns>
        public static implicit operator ValLong(long value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator Int128(ValLong value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="ValLong"/>.</returns>
        public static explicit operator ValLong(Int128 value)
        {
            return new(new BinaryJsonNumber(value));
        }
#endif
        ...
        public static explicit operator sbyte(ValLong value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="ValLong"/>.</returns>
        public static explicit operator ValLong(sbyte value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator Half(ValLong value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="ValLong"/>.</returns>
        public static explicit operator ValLong(Half value)
        {
            return new(new BinaryJsonNumber(value));
        }
#endif
        ...
        public static explicit operator float(ValLong value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="ValLong"/>.</returns>
        public static explicit operator ValLong(float value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator ushort(ValLong value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="ValLong"/>.</returns>
        public static explicit operator ValLong(ushort value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator uint(ValLong value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="ValLong"/>.</returns>
        public static explicit operator ValLong(uint value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator ulong(ValLong value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="ValLong"/>.</returns>
        public static explicit operator ValLong(ulong value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator UInt128(ValLong value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="ValLong"/>.</returns>
        public static explicit operator ValLong(UInt128 value)
        {
            return new(new BinaryJsonNumber(value));
        }
#endif
        ...
        /// </returns>
        public static bool operator <(ValLong left, ValLong right)
        {
        ...
        public static ValLong operator +(ValLong left, ValLong right)
        {
        ...
        /// <returns>The result of the operation.</returns>
        public static ValLong operator ++(ValLong value)
        {
        ...
        /// </returns>
        public static int Compare(in ValLong lhs, in ValLong rhs)
        {
