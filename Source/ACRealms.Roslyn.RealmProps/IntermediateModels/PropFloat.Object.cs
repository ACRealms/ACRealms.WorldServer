...
public readonly partial struct PropFloat
    : IJsonObject<ACRealms.Roslyn.RealmProps.IntermediateModels.PropFloat>
{
    /// <summary>
    /// Conversion from <see cref="ImmutableList{JsonObjectProperty}"/>.
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator PropFloat(ImmutableList<JsonObjectProperty> value)
    {
        return new(value);
    }
    ...
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator ImmutableList<JsonObjectProperty>(PropFloat value)
    {
        return
    ...
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator PropFloat(JsonObject value)
    {
    ...
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator JsonObject(PropFloat value)
    {
        return
            value.AsObject;
    }
    ...
    /// <inheritdoc/>
    public static PropFloat FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
    {
        return new(source.Select(kvp => new JsonObjectProperty(kvp.Key, kvp.Value)).ToImmutableList());
    }

    /// <inheritdoc/>
    public static PropFloat FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
    {
    ...
    public static PropFloat FromProperties(ImmutableList<JsonObjectProperty> source)
    {
        return new(source);
    }

    /// <summary>
    /// Creates an instance of a <see cref="PropFloat"/>.
    /// </summary>
    public static PropFloat Create(
        in ACRealms.Roslyn.RealmProps.IntermediateModels.Contexts? contexts = null,
        in ACRealms.Roslyn.RealmProps.IntermediateModels.ValFloat? defaultValue = null,
        in ACRealms.Roslyn.RealmProps.IntermediateModels.PropBase.DefaultFromServerPropertyEntity? defaultFromServerProperty = null,
        in ACRealms.Roslyn.RealmProps.IntermediateModels.ValFloat? maxValue = null,
        in ACRealms.Roslyn.RealmProps.IntermediateModels.ValFloat? minValue = null,
    ...
    /// </para>
    /// </remarks>
    public PropFloat WithContexts(in ACRealms.Roslyn.RealmProps.IntermediateModels.Contexts? value)
    {
    ...
    /// <param name="value">The new property value</param>
    /// <returns>The instance with the property set.</returns>
    public PropFloat WithDefault(in ACRealms.Roslyn.RealmProps.IntermediateModels.ValFloat? value)
    {
    ...
    /// </para>
    /// </remarks>
    public PropFloat WithDefaultFromServerProperty(in ACRealms.Roslyn.RealmProps.IntermediateModels.PropBase.DefaultFromServerPropertyEntity? value)
    {
    ...
    /// <param name="value">The new property value</param>
    /// <returns>The instance with the property set.</returns>
    public PropFloat WithMaxValue(in ACRealms.Roslyn.RealmProps.IntermediateModels.ValFloat? value)
    {
    ...
    /// <param name="value">The new property value</param>
    /// <returns>The instance with the property set.</returns>
    public PropFloat WithMinValue(in ACRealms.Roslyn.RealmProps.IntermediateModels.ValFloat? value)
    {
    ...
    /// </para>
    /// </remarks>
    public PropFloat WithObsolete(in ACRealms.Roslyn.RealmProps.IntermediateModels.RuleBase.ObsoleteEntity? value)
    {
    ...
    /// </para>
    /// </remarks>
    public PropFloat WithRerollRestrictedTo(in ACRealms.Roslyn.RealmProps.IntermediateModels.PropDefExtensionMinMax.RerollRestrictedToEntity? value)
    {
    ...
    /// <inheritdoc />
    public PropFloat SetProperty<TValue>(in JsonPropertyName name, TValue value)
    ...
    /// <inheritdoc />
    public PropFloat RemoveProperty(in JsonPropertyName name)
    {
        return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
    }

    /// <inheritdoc />
    public PropFloat RemoveProperty(string name)
    {
        return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
    }

    /// <inheritdoc />
    public PropFloat RemoveProperty(ReadOnlySpan<char> name)
    {
        return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
    }

    /// <inheritdoc />
    public PropFloat RemoveProperty(ReadOnlySpan<byte> name)
    {
        return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
    }
    ...
    private static class __CorvusObjectHelpers
    {
        ...
        /// <exception cref="InvalidOperationException">The value is not an object.</exception>
        public static ImmutableList<JsonObjectProperty> GetPropertyBacking(in PropFloat that)
        {
        ...
        /// <exception cref="InvalidOperationException">The value is not an object.</exception>
        public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in PropFloat that, in JsonPropertyName name)
        {
            if ((that.backing & Backing.Object) != 0)
            {
        ...
        /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
        /// <exception cref="InvalidOperationException">The value is not an object.</exception>
        public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in PropFloat that, ReadOnlySpan<char> name)
        {
            if ((that.backing & Backing.Object) != 0)
            {
                return that.objectBacking.Remove(name);
        ...
        /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
        /// <exception cref="InvalidOperationException">The value is not an object.</exception>
        public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in PropFloat that, ReadOnlySpan<byte> name)
        {
            if ((that.backing & Backing.Object) != 0)
            {
                return that.objectBacking.Remove(name);
        ...
        /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
        /// <exception cref="InvalidOperationException">The value is not an object.</exception>
        public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in PropFloat that, string name)
        {
            if ((that.backing & Backing.Object) != 0)
            {
                return that.objectBacking.Remove(name);
        ...
        /// <exception cref="InvalidOperationException">The value is not an object.</exception>
        public static ImmutableList<JsonObjectProperty> GetPropertyBackingWith(in PropFloat that, in JsonPropertyName name, in JsonAny value)
        {
            if ((that.backing & Backing.Object) != 0)
            {
