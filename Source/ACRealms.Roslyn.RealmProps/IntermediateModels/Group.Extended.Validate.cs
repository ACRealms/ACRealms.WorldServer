    ...
    public readonly partial struct Extended
    {
        ...
        public static partial class CorvusValidation
        {
                ...
                ValidationLevel level = ValidationLevel.Flag)
            {
                ...
                allOfResult0 = value.As<ACRealms.Roslyn.RealmProps.IntermediateModels.Group.Extended.GroupAttrs>().Validate(allOfResult0, level);
                ...
                allOfResult1 = value.As<ACRealms.Roslyn.RealmProps.IntermediateModels.Group.Extended.PropAttrs>().Validate(allOfResult1, level);
                ...
                ValidationLevel level = ValidationLevel.Flag)
            {
                ...
                foreach (JsonObjectProperty property in value.EnumerateObject())
                {
                    ...
                    else if (property.NameEquals(JsonPropertyNames.KeyPrefixUtf8, JsonPropertyNames.KeyPrefix))
                    {
                        ...
                        ValidationContext propertyResult = property.Value.As<ACRealms.Roslyn.RealmProps.IntermediateModels.PropDefKeyPart>().Validate(result.CreateChildContext(), level);
                        if (level == ValidationLevel.Flag && !propertyResult.IsValid)
                        {
                            return propertyResult;
                        }
                    ...
                    else if (property.NameEquals(JsonPropertyNames.PropertiesUtf8, JsonPropertyNames.Properties))
                    {
                        ...
                        ValidationContext propertyResult = property.Value.As<ACRealms.Roslyn.RealmProps.IntermediateModels.Group.Extended.PropertiesEntity>().Validate(result.CreateChildContext(), level);
                        if (level == ValidationLevel.Flag && !propertyResult.IsValid)
                        {
                            return propertyResult;
                        }
