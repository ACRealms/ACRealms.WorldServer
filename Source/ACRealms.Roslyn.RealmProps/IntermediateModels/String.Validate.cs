...
public readonly partial struct String
{
    ...
    public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
    {
        ...
        if (level > ValidationLevel.Basic)
        {
            ...
            result = result.PushSchemaLocation("realm-props/common/is-type.json#/definitions/string");
        }
            ...
            ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            foreach (JsonObjectProperty property in value.EnumerateObject())
            {
                if (property.NameEquals(JsonPropertyNames.TypeUtf8, JsonPropertyNames.Type))
                {
                    ...
                    ValidationContext propertyResult = property.Value.As<ACRealms.Roslyn.RealmProps.IntermediateModels.String.RepresentsARealmPropertyString>().Validate(result.CreateChildContext(), level);
