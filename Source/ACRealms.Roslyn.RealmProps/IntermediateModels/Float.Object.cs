    ...
    : IJsonObject<ACRealms.Roslyn.RealmProps.IntermediateModels.Float>
{
    ...
    /// </para>
    /// </remarks>
    public ACRealms.Roslyn.RealmProps.IntermediateModels.Float.RepresentsARealmPropertyFloatDouble Type
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            ...
            if ((this.backing & Backing.Object) != 0)
            {
                ...
                {
                    return result.As<ACRealms.Roslyn.RealmProps.IntermediateModels.Float.RepresentsARealmPropertyFloatDouble>();
                }
            }
    ...
    /// </summary>
    public static Float Create(in ACRealms.Roslyn.RealmProps.IntermediateModels.Float.RepresentsARealmPropertyFloatDouble? type = null)
    {
    ...
    /// </para>
    /// </remarks>
    public Float WithType(in ACRealms.Roslyn.RealmProps.IntermediateModels.Float.RepresentsARealmPropertyFloatDouble value)
    {
