        ...
        public readonly partial struct ThenEntity
        {
            ...
            public readonly partial struct AdditionalPropertiesEntity
            {
...

                {
                    ...
                    /// </summary>
                    public static string SchemaLocation { get; } = "realm-props/group.json#/definitions/props/definitions/long/then/additionalProperties/then";
                    ...
                    /// <summary>
                    /// Conversion to <see cref="ACRealms.Roslyn.RealmProps.IntermediateModels.PropLong"/>.
                    /// </summary>
                    /// <param name="value">The value from which to convert.</param>
                    public static implicit operator ACRealms.Roslyn.RealmProps.IntermediateModels.PropLong(ThenEntity value)
                    {
                        return value.As<ACRealms.Roslyn.RealmProps.IntermediateModels.PropLong>();
                    }

                    /// <summary>
                    /// Conversion from <see cref="ACRealms.Roslyn.RealmProps.IntermediateModels.PropLong"/>.
                    /// </summary>
                    /// <param name="value">The value from which to convert.</param>
                    public static explicit operator ThenEntity(ACRealms.Roslyn.RealmProps.IntermediateModels.PropLong value)
                    {
                        return value.As<ThenEntity>();
                    }
                    ...
                    /// <param name="matchPropLong">Match a <see cref="ACRealms.Roslyn.RealmProps.IntermediateModels.PropLong"/>.</param>
                    ...
                    public TOut Match<TIn, TOut>(
                        in TIn context,
                        Matcher<ACRealms.Roslyn.RealmProps.IntermediateModels.PropLong, TIn, TOut> matchPropLong,
                        Matcher<ACRealms.Roslyn.RealmProps.IntermediateModels.PropObj, TIn, TOut> matchPropObj,
                        Matcher<ACRealms.Roslyn.RealmProps.IntermediateModels.Group.LongEntity.ThenEntity.AdditionalPropertiesEntity.ThenEntity, TIn, TOut> defaultMatch)
                    {
                        ACRealms.Roslyn.RealmProps.IntermediateModels.PropLong matchPropLongValue = this.As<ACRealms.Roslyn.RealmProps.IntermediateModels.PropLong>();
                        if (matchPropLongValue.IsValid())
                        {
                            return matchPropLong(matchPropLongValue, context);
                        }
                    ...
                    public TOut Match<TOut>(
                        Matcher<ACRealms.Roslyn.RealmProps.IntermediateModels.PropLong, TOut> matchPropLong,
                        Matcher<ACRealms.Roslyn.RealmProps.IntermediateModels.PropObj, TOut> matchPropObj,
                        Matcher<ACRealms.Roslyn.RealmProps.IntermediateModels.Group.LongEntity.ThenEntity.AdditionalPropertiesEntity.ThenEntity, TOut> defaultMatch)
                    {
                        ACRealms.Roslyn.RealmProps.IntermediateModels.PropLong matchPropLongValue = this.As<ACRealms.Roslyn.RealmProps.IntermediateModels.PropLong>();
                        if (matchPropLongValue.IsValid())
                        {
                            return matchPropLong(matchPropLongValue);
                        }
