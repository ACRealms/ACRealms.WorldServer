...
public readonly partial struct RealmPropertySchema
{
    ...
    /// </summary>
#if NET8_0_OR_GREATER
    [CollectionBuilder(typeof(PropDef), "Create")]
#endif
    public readonly partial struct PropDef
        : IJsonArray<ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.PropDef>,
          IReadOnlyCollection<Corvus.Json.JsonAny>
    {
        /// <summary>
        /// Gets an empty array.
        /// </summary>
        public static PropDef EmptyArray { get; } = From(ImmutableList<JsonAny>.Empty);
        ...
        public static implicit operator PropDef(ImmutableList<JsonAny> value)
        {
            return new(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator ImmutableList<JsonAny>(PropDef value)
        {
            return
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator PropDef(JsonArray value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator JsonArray(PropDef value)
        {
            return
                value.AsArray;
        }
        ...
        public static PropDef From(ImmutableList<JsonAny> items)
        {
            return new(items);
        }

        /// <summary>
        /// Create an new instance of the <see cref="PropDef"/>" struct from a span of items.
        /// </summary>
        ...
        public static PropDef Create(ReadOnlySpan<Corvus.Json.JsonAny> items)
        {
            return new([..items]);
        }
        ...
        public static PropDef FromItems(params Corvus.Json.JsonAny[] items)
        {
            return new([..items]);
        }
        ...
        /// <param name="items">The value from which to construct the instance.</param>
        /// <returns>An instance of the array constructed from the value.</returns>
        public static PropDef FromItems<TItem>(params TItem[] items)
        ...
        public static PropDef FromItems<TItem1>(in TItem1 item1)
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static PropDef FromItems<TItem1, TItem2>(in TItem1 item1, in TItem2 item2)
            where TItem1 : struct, IJsonValue<TItem1>
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static PropDef FromItems<TItem1, TItem2, TItem3>(in TItem1 item1, in TItem2 item2, in TItem3 item3)
            where TItem1 : struct, IJsonValue<TItem1>
            where TItem2 : struct, IJsonValue<TItem2>
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static PropDef FromItems<TItem1, TItem2, TItem3, TItem4>(in TItem1 item1, in TItem2 item2, in TItem3 item3, in TItem4 item4)
            where TItem1 : struct, IJsonValue<TItem1>
            where TItem2 : struct, IJsonValue<TItem2>
            where TItem3 : struct, IJsonValue<TItem3>
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static PropDef FromItems<TItem1, TItem2, TItem3, TItem4, TItem5>(in TItem1 item1, in TItem2 item2, in TItem3 item3, in TItem4 item4, in TItem5 item5)
            where TItem1 : struct, IJsonValue<TItem1>
            where TItem2 : struct, IJsonValue<TItem2>
            where TItem3 : struct, IJsonValue<TItem3>
            where TItem4 : struct, IJsonValue<TItem4>
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static PropDef FromItems<TItem1, TItem2, TItem3, TItem4, TItem5, TItem6>(in TItem1 item1, in TItem2 item2, in TItem3 item3, in TItem4 item4, in TItem5 item5, in TItem6 item6)
            where TItem1 : struct, IJsonValue<TItem1>
            where TItem2 : struct, IJsonValue<TItem2>
            where TItem3 : struct, IJsonValue<TItem3>
            where TItem4 : struct, IJsonValue<TItem4>
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static PropDef FromItems<TItem1, TItem2, TItem3, TItem4, TItem5, TItem6, TItem7>(in TItem1 item1, in TItem2 item2, in TItem3 item3, in TItem4 item4, in TItem5 item5, in TItem6 item6, in TItem7 item7)
            where TItem1 : struct, IJsonValue<TItem1>
            where TItem2 : struct, IJsonValue<TItem2>
            where TItem3 : struct, IJsonValue<TItem3>
            where TItem4 : struct, IJsonValue<TItem4>
        ...
        public static PropDef FromRange(IEnumerable<Corvus.Json.JsonAny> items)
        {
            return new([..items]);
        }
        ...
        /// <param name="items">The items from which to construct the instance.</param>
        /// <returns>An instance of the array constructed from the items.</returns>
        public static PropDef FromRange<TItem>(IEnumerable<TItem> items)
            where TItem : struct, IJsonValue<TItem>
        {
            return new([..items.Select(item => item.AsAny)]);
        }
        ...
        public static PropDef FromRange(IEnumerable<string> items)
        {
            return new([..items]);
        }
        ...
        /// <param name="items">The items from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static PropDef FromRange(IEnumerable<double> items)
        {
            return new([..items]);
        }
        ...
        /// <param name="items">The items from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static PropDef FromRange(IEnumerable<float> items)
        {
            return new([..items]);
        }
        ...
        /// <param name="items">The items from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static PropDef FromRange(IEnumerable<int> items)
        {
            return new([..items]);
        }
        ...
        /// <param name="items">The items from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static PropDef FromRange(IEnumerable<long> items)
        {
            return new([..items]);
        }
        ...
        /// <param name="items">The items from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static PropDef FromRange(IEnumerable<bool> items)
        {
            return new([..items]);
        }
        ...
        /// </remarks>
        public static PropDef From<T>(IEnumerable<T> items)
        {
        ...
        /// <inheritdoc/>
        public PropDef Add(in JsonAny item1)
        {
        ...
        /// <inheritdoc/>
        public PropDef Add(params JsonAny[] items)
        {
            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
        ...
        /// <inheritdoc/>
        public PropDef AddRange<TArray>(in TArray items)
        ...
        /// <inheritdoc/>
        public PropDef AddRange<TItem>(IEnumerable<TItem> items)
            where TItem : struct, IJsonValue<TItem>
        {
            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
        ...
        /// <inheritdoc/>
        public PropDef AddRange(IEnumerable<JsonAny> items)
        {
            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
        ...
        /// <inheritdoc/>
        public PropDef Insert(int index, in JsonAny item1)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, item1));
        }

        /// <inheritdoc/>
        public PropDef InsertRange<TArray>(int index, in TArray items)
            where TArray : struct, IJsonArray<TArray>
        {
        ...
        /// <inheritdoc/>
        public PropDef InsertRange<TItem>(int index, IEnumerable<TItem> items)
            where TItem : struct, IJsonValue<TItem>
        {
        ...
        private static class __CorvusArrayHelpers
        {
            ...
            public static ImmutableList<JsonAny> GetImmutableList(in PropDef arrayInstance)
            {
            ...
            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
            public static ImmutableList<JsonAny>.Builder GetImmutableListBuilder(in PropDef arrayInstance)
            {
            ...
            public static ImmutableList<JsonAny> GetImmutableListSetting(in PropDef arrayInstance, int index, in JsonAny value)
            {
                if ((arrayInstance.backing & Backing.JsonElement) != 0)
                {
                    if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
            ...
            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
            public static ImmutableList<JsonAny> GetImmutableListReplacing(in PropDef arrayInstance, in JsonAny oldItem, in JsonAny newItem)
            {
                if ((arrayInstance.backing & Backing.JsonElement) != 0)
                {
                    if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
            ...
            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
            public static ImmutableList<JsonAny> GetImmutableListWithout(in PropDef arrayInstance, in JsonAny item)
            {
                if ((arrayInstance.backing & Backing.JsonElement) != 0)
                {
                    if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
            ...
            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
            /// <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
            public static ImmutableList<JsonAny> GetImmutableListWithoutRange(in PropDef arrayInstance, int index, int count)
            {
                if ((arrayInstance.backing & Backing.JsonElement) != 0)
                {
                    if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
            ...
            // <exception cref = "InvalidOperationException">The value is not an array.</exception>
            // <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
            public static ImmutableList<JsonAny> GetImmutableListWith(in PropDef arrayInstance, int index, in JsonAny value)
            {
                if ((arrayInstance.backing & Backing.JsonElement) != 0)
                {
                    if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
            ...
            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
            /// <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
            public static ImmutableList<JsonAny> GetImmutableListWith<TEnumerable>(in PropDef arrayInstance, int index, TEnumerable values)
