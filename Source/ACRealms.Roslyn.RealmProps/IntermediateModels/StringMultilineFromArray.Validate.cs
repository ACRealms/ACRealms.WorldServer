...
public readonly partial struct StringMultilineFromArray
{
    ...
    public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
    {
        ...
        if (level > ValidationLevel.Basic)
        {
            ...
            result = result.PushSchemaLocation("components/string-multiline-from-array.json");
        }
    ...
    public static partial class CorvusValidation
    {
        ...
        internal static ValidationContext CompositionOneOfValidationHandler(
            in StringMultilineFromArray value,
            ...
            ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            ValidationContext oneOfResult0 = value.As<ACRealms.Roslyn.RealmProps.IntermediateModels.ValStringSimple>().Validate(oneOfChildContext0, level);
            ...
            ValidationContext oneOfResult1 = value.As<ACRealms.Roslyn.RealmProps.IntermediateModels.StringSplitArray>().Validate(oneOfChildContext1, level);
