...
public readonly partial struct TypeIsFloat
{
    ...
    public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
    {
        ...
        if (level > ValidationLevel.Basic)
        {
            ...
            result = result.PushSchemaLocation("realm-props/common/is-type.json#/definitions/typeIsFloat");
        }
            ...
            ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            foreach (JsonObjectProperty property in value.EnumerateObject())
            {
                if (property.NameEquals(JsonPropertyNames.TypeUtf8, JsonPropertyNames.Type))
                {
                    ...
                    ValidationContext propertyResult = property.Value.As<ACRealms.Roslyn.RealmProps.IntermediateModels.TypeIsFloat.TypeEntity>().Validate(result.CreateChildContext(), level);
