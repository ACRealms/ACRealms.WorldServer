...
/// </para>
/// </remarks>
[System.Text.Json.Serialization.JsonConverter(typeof(Corvus.Json.Internal.JsonValueConverter<PropObj>))]
public readonly partial struct PropObj
    : IJsonValue<ACRealms.Roslyn.RealmProps.IntermediateModels.PropObj>
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="PropObj"/> struct.
    /// </summary>
    public PropObj()
    {
    ...
    public PropObj(in JsonElement value)
    {
    ...
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    public PropObj(ImmutableList<JsonObjectProperty> value)
    {
    ...
    /// </summary>
    public static string SchemaLocation { get; } = "realm-props/group/prop-obj.json";

    /// <summary>
    /// Gets a Null instance.
    /// </summary>
    public static PropObj Null { get; } = new(JsonValueHelpers.NullElement);

    /// <summary>
    /// Gets an Undefined instance.
    /// </summary>
    public static PropObj Undefined { get; }

    /// <summary>
    /// Gets the default instance.
    /// </summary>
    public static PropObj DefaultInstance { get; }
    ...
    public static implicit operator PropObj(JsonAny value)
    {
    ...
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator JsonAny(PropObj value)
    {
        return value.AsAny;
    }
    ...
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator ACRealms.Roslyn.RealmProps.IntermediateModels.PropBase(PropObj value)
    {
    ...
    /// </returns>
    public static bool operator ==(in PropObj left, in PropObj right)
    {
    ...
    public static PropObj FromJson(in JsonElement value)
    {
        return new(value);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PropObj FromAny(in JsonAny value)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    static PropObj IJsonValue<PropObj>.FromBoolean<TValue>(in TValue value)
    {
        if (value.HasJsonElementBacking)
        {
            return new(value.AsJsonElement);
    ...
    /// <returns>An instance of this type, initialized from the provided value.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    static PropObj IJsonValue<PropObj>.FromString<TValue>(in TValue value)
    {
        if (value.HasJsonElementBacking)
        {
            return new(value.AsJsonElement);
    ...
    /// <returns>An instance of this type, initialized from the provided value.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    static PropObj IJsonValue<PropObj>.FromNumber<TValue>(in TValue value)
    {
        if (value.HasJsonElementBacking)
        {
            return new(value.AsJsonElement);
    ...
    /// <returns>An instance of this type, initialized from the provided value.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PropObj FromObject<TValue>(in TValue value)
    ...
    /// <returns>An instance of this type, initialized from the provided value.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    static PropObj IJsonValue<PropObj>.FromArray<TValue>(in TValue value)
    {
        if (value.HasJsonElementBacking)
        {
            return new(value.AsJsonElement);
    ...
    public static PropObj Parse(string source, JsonDocumentOptions options = default)
    {
    ...
    /// <param name="source">The source of the JSON string to parse.</param>
    /// <param name="options">The (optional) JsonDocumentOptions.</param>
    public static PropObj Parse(Stream source, JsonDocumentOptions options = default)
    {
        using var jsonDocument = JsonDocument.Parse(source, options);
        return new(jsonDocument.RootElement.Clone());
    }
    ...
    /// <param name="source">The source of the JSON string to parse.</param>
    /// <param name="options">The (optional) JsonDocumentOptions.</param>
    public static PropObj Parse(ReadOnlyMemory<byte> source, JsonDocumentOptions options = default)
    {
        using var jsonDocument = JsonDocument.Parse(source, options);
        return new(jsonDocument.RootElement.Clone());
    }
    ...
    /// <param name="source">The source of the JSON string to parse.</param>
    /// <param name="options">The (optional) JsonDocumentOptions.</param>
    public static PropObj Parse(ReadOnlyMemory<char> source, JsonDocumentOptions options = default)
    {
        using var jsonDocument = JsonDocument.Parse(source, options);
        return new(jsonDocument.RootElement.Clone());
    }
    ...
    /// <param name="source">The source of the JSON string to parse.</param>
    /// <param name="options">The (optional) JsonDocumentOptions.</param>
    public static PropObj Parse(ReadOnlySequence<byte> source, JsonDocumentOptions options = default)
    {
        using var jsonDocument = JsonDocument.Parse(source, options);
        return new(jsonDocument.RootElement.Clone());
    }
    ...
    /// </summary>
    /// <param name="source">The source of the JSON string to parse.</param>
    public static PropObj ParseValue(string source)
    {
#if NET8_0_OR_GREATER
        return IJsonValue<PropObj>.ParseValue(source);
#else
        return JsonValueHelpers.ParseValue<PropObj>(source.AsSpan());
#endif
    }
    ...
    /// </summary>
    /// <param name="source">The source of the JSON string to parse.</param>
    public static PropObj ParseValue(ReadOnlySpan<char> source)
    {
#if NET8_0_OR_GREATER
        return IJsonValue<PropObj>.ParseValue(source);
#else
        return JsonValueHelpers.ParseValue<PropObj>(source);
#endif
    }
    ...
    /// </summary>
    /// <param name="source">The source of the JSON string to parse.</param>
    public static PropObj ParseValue(ReadOnlySpan<byte> source)
    {
#if NET8_0_OR_GREATER
        return IJsonValue<PropObj>.ParseValue(source);
#else
    ...
    /// </summary>
    /// <param name="source">The source of the JSON string to parse.</param>
    public static PropObj ParseValue(ref Utf8JsonReader source)
    {
#if NET8_0_OR_GREATER
        return IJsonValue<PropObj>.ParseValue(ref source);
#else
        return JsonValueHelpers.ParseValue<PropObj>(ref source);
#endif
    }
...
#else
        return this.As<PropObj, TTarget>();
#endif
    }
    ...
    {
        return
            (obj is IJsonValue jv && this.Equals(jv.As<PropObj>())) ||
    ...
    {
        return this.Equals(other.As<PropObj>());
    }
    ...
    public bool Equals(in PropObj other)
    {
