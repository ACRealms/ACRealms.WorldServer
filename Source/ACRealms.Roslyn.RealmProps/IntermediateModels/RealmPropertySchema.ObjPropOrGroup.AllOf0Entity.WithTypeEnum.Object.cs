    ...
    public readonly partial struct ObjPropOrGroup
    {
        ...
        public readonly partial struct AllOf0Entity
        {
            ...
            public readonly partial struct WithTypeEnum
                : IJsonObject<ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.ObjPropOrGroup.AllOf0Entity.WithTypeEnum>
            {
                /// <summary>
                /// Conversion from <see cref="ImmutableList{JsonObjectProperty}"/>.
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator WithTypeEnum(ImmutableList<JsonObjectProperty> value)
                {
                    return new(value);
                }
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator ImmutableList<JsonObjectProperty>(WithTypeEnum value)
                {
                    return
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator WithTypeEnum(JsonObject value)
                {
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator JsonObject(WithTypeEnum value)
                {
                    return
                        value.AsObject;
                }
                ...
                /// </summary>
                public ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.ObjPropOrGroup.AllOf0Entity.WithTypeEnum.TypeEntity Type
                {
                    get
                    {
                        if ((this.backing & Backing.JsonElement) != 0)
                        ...
                        if ((this.backing & Backing.Object) != 0)
                        {
                            ...
                            {
                                return result.As<ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.ObjPropOrGroup.AllOf0Entity.WithTypeEnum.TypeEntity>();
                            }
                        }
                ...
                /// <inheritdoc/>
                public static WithTypeEnum FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
                {
                    return new(source.Select(kvp => new JsonObjectProperty(kvp.Key, kvp.Value)).ToImmutableList());
                }

                /// <inheritdoc/>
                public static WithTypeEnum FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
                {
                ...
                public static WithTypeEnum FromProperties(ImmutableList<JsonObjectProperty> source)
                {
                    return new(source);
                }

                /// <summary>
                /// Creates an instance of a <see cref="WithTypeEnum"/>.
                /// </summary>
                public static WithTypeEnum Create(in ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.ObjPropOrGroup.AllOf0Entity.WithTypeEnum.TypeEntity? type = null)
                {
                ...
                public WithTypeEnum WithType(in ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.ObjPropOrGroup.AllOf0Entity.WithTypeEnum.TypeEntity value)
                {
                ...
                /// <inheritdoc />
                public WithTypeEnum SetProperty<TValue>(in JsonPropertyName name, TValue value)
                ...
                /// <inheritdoc />
                public WithTypeEnum RemoveProperty(in JsonPropertyName name)
                {
                    return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
                }

                /// <inheritdoc />
                public WithTypeEnum RemoveProperty(string name)
                {
                    return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
                }

                /// <inheritdoc />
                public WithTypeEnum RemoveProperty(ReadOnlySpan<char> name)
                {
                    return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
                }

                /// <inheritdoc />
                public WithTypeEnum RemoveProperty(ReadOnlySpan<byte> name)
                {
                    return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
                }
                ...
                private static class __CorvusObjectHelpers
                {
                    ...
                    /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                    public static ImmutableList<JsonObjectProperty> GetPropertyBacking(in WithTypeEnum that)
                    {
                    ...
                    /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                    public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in WithTypeEnum that, in JsonPropertyName name)
                    {
                        if ((that.backing & Backing.Object) != 0)
                        {
                    ...
                    /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
                    /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                    public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in WithTypeEnum that, ReadOnlySpan<char> name)
                    {
                        if ((that.backing & Backing.Object) != 0)
                        {
                            return that.objectBacking.Remove(name);
                    ...
                    /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
                    /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                    public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in WithTypeEnum that, ReadOnlySpan<byte> name)
                    {
                        if ((that.backing & Backing.Object) != 0)
                        {
                            return that.objectBacking.Remove(name);
                    ...
                    /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
                    /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                    public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in WithTypeEnum that, string name)
                    {
                        if ((that.backing & Backing.Object) != 0)
                        {
                            return that.objectBacking.Remove(name);
                    ...
                    /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                    public static ImmutableList<JsonObjectProperty> GetPropertyBackingWith(in WithTypeEnum that, in JsonPropertyName name, in JsonAny value)
                    {
                        if ((that.backing & Backing.Object) != 0)
                        {
