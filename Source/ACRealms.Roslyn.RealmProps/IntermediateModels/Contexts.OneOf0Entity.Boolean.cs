...
public readonly partial struct Contexts
{
    ...
    public readonly partial struct OneOf0Entity
        : IJsonBoolean<ACRealms.Roslyn.RealmProps.IntermediateModels.Contexts.OneOf0Entity>
    {
        /// <summary>
        /// Conversion from <see cref="bool"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator OneOf0Entity(bool value)
        {
            return new(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator OneOf0Entity(JsonBoolean value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator JsonBoolean(OneOf0Entity value)
        {
            return
                value.AsBoolean;
        }
