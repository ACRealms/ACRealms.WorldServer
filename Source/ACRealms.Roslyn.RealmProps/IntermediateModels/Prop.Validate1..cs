            ...
            ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            foreach (JsonObjectProperty property in value.EnumerateObject())
            {
                if (property.NameEquals("type"u8, "type"))
                {
                    ...
                    ValidationContext dependenciesResult0 = value.As<ACRealms.Roslyn.RealmProps.IntermediateModels.Prop.ObjPropSelection>().Validate(result.CreateChildContext(), level);
