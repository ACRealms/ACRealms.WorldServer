...
public readonly partial struct PropDefs
{
    ...
    public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
    {
        ...
        if (level > ValidationLevel.Basic)
        {
            ...
            result = result.PushSchemaLocation("propdefs.json");
        }
            ...
            ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            foreach (JsonObjectProperty property in value.EnumerateObject())
            {
                if (property.NameEquals(JsonPropertyNames.SchemaVersionUtf8, JsonPropertyNames.SchemaVersion))
                {
                    ...
                    ValidationContext propertyResult = property.Value.As<ACRealms.Roslyn.RealmProps.IntermediateModels.PropDefs.SchemaVersionEntity>().Validate(result.CreateChildContext(), level);
                ...
                else if (property.NameEquals(JsonPropertyNames.GroupsUtf8, JsonPropertyNames.Groups))
                {
                    ...
                    ValidationContext propertyResult = property.Value.As<ACRealms.Roslyn.RealmProps.IntermediateModels.PropDefs.GroupArray>().Validate(result.CreateChildContext(), level);
                    if (level == ValidationLevel.Flag && !propertyResult.IsValid)
                    {
                        return propertyResult;
                    }
                ...
                else if (property.NameEquals(JsonPropertyNames.NamespaceUtf8, JsonPropertyNames.Namespace))
                {
                    ...
                    ValidationContext propertyResult = property.Value.As<ACRealms.Roslyn.RealmProps.IntermediateModels.PropDefs.NamespaceEntity>().Validate(result.CreateChildContext(), level);
                    if (level == ValidationLevel.Flag && !propertyResult.IsValid)
                    {
                        return propertyResult;
                    }
