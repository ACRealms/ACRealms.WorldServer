...
public readonly partial struct PropFloat
{
    ...
    public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
    {
        ...
        if (level > ValidationLevel.Basic)
        {
            ...
            result = result.PushSchemaLocation("realm-props/common/prop-typed.json#/definitions/propFloat");
        }
    ...
    public static partial class CorvusValidation
    {
            ...
            ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            allOfResult0 = value.As<ACRealms.Roslyn.RealmProps.IntermediateModels.PropDefExtensionMinMax>().Validate(allOfResult0, level);
            ...
            ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            foreach (JsonObjectProperty property in value.EnumerateObject())
            {
                if (property.NameEquals(JsonPropertyNames.DefaultUtf8, JsonPropertyNames.Default))
                {
                    ...
                    ValidationContext propertyResult = property.Value.As<ACRealms.Roslyn.RealmProps.IntermediateModels.ValFloat>().Validate(result.CreateChildContext(), level);
