        ...
        public readonly partial struct MaybeModulator
        {
            ...
            public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
            {
                ...
                if (level > ValidationLevel.Basic)
                {
                    ...
                    result = result.PushSchemaLocation("realm-props/group.json#/definitions/typedPropDefs/allOf/6");
                }
            ...
            public static partial class CorvusValidation
            {
                    ...
                    ValidationLevel level = ValidationLevel.Flag)
                {
                    ...
                    ValidationContext ifResult = value.As<ACRealms.Roslyn.RealmProps.IntermediateModels.TypeIsModulator>().Validate(validationContext.CreateChildContext(), level);
                    ...
                    if (ifResult.IsValid)
                    {
                        ...
                        ValidationContext thenResult = value.As<ACRealms.Roslyn.RealmProps.IntermediateModels.Group.TypedPropDefs.ExtendedAsModulator>().Validate(validationContext.CreateChildContext(), level);
