    ...
    public readonly partial struct FloatEntity
    {
        ...
        public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            if (level > ValidationLevel.Basic)
            {
                ...
                result = result.PushSchemaLocation("realm-props/group.json#/definitions/props/definitions/float");
            }
        ...
        public static partial class CorvusValidation
        {
                ...
                ValidationLevel level = ValidationLevel.Flag)
            {
                ...
                if (ifResult.IsValid)
                {
                    ...
                    ValidationContext thenResult = value.As<ACRealms.Roslyn.RealmProps.IntermediateModels.Group.FloatEntity.ThenEntity>().Validate(validationContext.CreateChildContext(), level);
