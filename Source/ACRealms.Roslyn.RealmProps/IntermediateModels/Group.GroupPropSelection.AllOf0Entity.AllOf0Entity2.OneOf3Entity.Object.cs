        ...
        public readonly partial struct AllOf0Entity
        {
            ...
            public readonly partial struct AllOf0Entity2
            {
                ...
                public readonly partial struct OneOf3Entity
                    : IJsonObject<ACRealms.Roslyn.RealmProps.IntermediateModels.Group.GroupPropSelection.AllOf0Entity.AllOf0Entity2.OneOf3Entity>
                {
                    /// <summary>
                    /// Conversion from <see cref="ImmutableList{JsonObjectProperty}"/>.
                    /// </summary>
                    /// <param name="value">The value from which to convert.</param>
                    public static implicit operator OneOf3Entity(ImmutableList<JsonObjectProperty> value)
                    {
                        return new(value);
                    }
                    ...
                    /// </summary>
                    /// <param name="value">The value from which to convert.</param>
                    public static implicit operator ImmutableList<JsonObjectProperty>(OneOf3Entity value)
                    {
                        return
                    ...
                    public OneOf3Entity WithContexts(in ACRealms.Roslyn.RealmProps.IntermediateModels.Contexts value)
                    {
                    ...
                    /// <param name="value">The new property value</param>
                    /// <returns>The instance with the property set.</returns>
                    public OneOf3Entity WithDefault(in ACRealms.Roslyn.RealmProps.IntermediateModels.ValFloat value)
                    {
                    ...
                    /// </para>
                    /// </remarks>
                    public OneOf3Entity WithDefaultFromServerProperty(in Corvus.Json.JsonString value)
                    {
                    ...
                    /// <param name="value">The new property value</param>
                    /// <returns>The instance with the property set.</returns>
                    public OneOf3Entity WithMaxValue(in ACRealms.Roslyn.RealmProps.IntermediateModels.ValFloat value)
                    {
                    ...
                    /// <param name="value">The new property value</param>
                    /// <returns>The instance with the property set.</returns>
                    public OneOf3Entity WithMinValue(in ACRealms.Roslyn.RealmProps.IntermediateModels.ValFloat value)
                    {
                    ...
                    /// </para>
                    /// </remarks>
                    public OneOf3Entity WithObsolete(in Corvus.Json.JsonString value)
                    {
                    ...
                    /// </para>
                    /// </remarks>
                    public OneOf3Entity WithRerollRestrictedTo(in ACRealms.Roslyn.RealmProps.IntermediateModels.PropMinmax.RerollRestrictedToEntity value)
                    {
                    ...
                    /// <inheritdoc />
                    public OneOf3Entity RemoveProperty(ReadOnlySpan<byte> name)
                    {
                        return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
                    }
                    ...
                    private static class __CorvusObjectHelpers
                    {
                        ...
                        /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                        public static ImmutableList<JsonObjectProperty> GetPropertyBacking(in OneOf3Entity that)
                        {
                        ...
                        /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                        public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in OneOf3Entity that, in JsonPropertyName name)
                        {
                            if ((that.backing & Backing.Object) != 0)
                            {
                        ...
                        /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
                        /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                        public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in OneOf3Entity that, ReadOnlySpan<char> name)
                        {
                            if ((that.backing & Backing.Object) != 0)
                            {
                                return that.objectBacking.Remove(name);
                        ...
                        /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
                        /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                        public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in OneOf3Entity that, ReadOnlySpan<byte> name)
                        {
                            if ((that.backing & Backing.Object) != 0)
                            {
                                return that.objectBacking.Remove(name);
                        ...
                        /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
                        /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                        public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in OneOf3Entity that, string name)
                        {
                            if ((that.backing & Backing.Object) != 0)
                            {
                                return that.objectBacking.Remove(name);
                        ...
                        /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                        public static ImmutableList<JsonObjectProperty> GetPropertyBackingWith(in OneOf3Entity that, in JsonPropertyName name, in JsonAny value)
                        {
                            if ((that.backing & Backing.Object) != 0)
                            {
