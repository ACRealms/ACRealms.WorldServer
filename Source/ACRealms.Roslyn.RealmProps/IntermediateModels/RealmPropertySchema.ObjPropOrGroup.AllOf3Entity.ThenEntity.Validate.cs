            ...
            public readonly partial struct ThenEntity
            {
                ...
                public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
                {
                    ...
                    if (level > ValidationLevel.Basic)
                    {
                        ...
                        result = result.PushSchemaLocation("https://realm.ac/schema/v1/realm-property-schema.json#/definitions/objPropOrGroup/allOf/3/then");
                    }
                        ...
                        ValidationLevel level = ValidationLevel.Flag)
                    {
                        ...
                        foreach (JsonObjectProperty property in value.EnumerateObject())
                        {
                            if (property.NameEquals(JsonPropertyNames.DefaultUtf8, JsonPropertyNames.Default))
                            {
                                ...
                                ValidationContext propertyResult = property.Value.As<ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.ValLong>().Validate(result.CreateChildContext(), level);
