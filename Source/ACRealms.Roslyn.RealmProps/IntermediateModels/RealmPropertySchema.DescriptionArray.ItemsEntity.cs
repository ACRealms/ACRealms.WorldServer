...
public readonly partial struct RealmPropertySchema
{
    ...
    public readonly partial struct DescriptionArray
    {
...

        {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.DescriptionPattern(ItemsEntity value)
            {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator ItemsEntity(ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.DescriptionPattern value)
            {
                return value.As<ItemsEntity>();
            }
