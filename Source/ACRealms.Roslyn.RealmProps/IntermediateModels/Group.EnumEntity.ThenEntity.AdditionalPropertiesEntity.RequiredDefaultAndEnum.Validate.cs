                ...
                public readonly partial struct RequiredDefaultAndEnum
                {
                    ...
                    public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
                    {
                        ...
                        if (level > ValidationLevel.Basic)
                        {
                            ...
                            result = result.PushSchemaLocation("realm-props/group.json#/definitions/props/definitions/enum/then/additionalProperties/then");
                        }
                    ...
                    public static partial class CorvusValidation
                    {
                        ...
                        internal static ValidationContext CompositionAllOfValidationHandler(
                            in RequiredDefaultAndEnum value,
                            ...
                            ValidationLevel level = ValidationLevel.Flag)
                        {
                            ...
                            if (level > ValidationLevel.Basic)
                            {
                                allOfResult0 = allOfResult0.PushValidationLocationReducedPathModifier(new("#/allOf/0/$ref/$ref"));
                            }

                            allOfResult0 = value.As<ACRealms.Roslyn.RealmProps.IntermediateModels.PropDefExtensionEnum>().Validate(allOfResult0, level);
                            ...
                            allOfResult1 = value.As<ACRealms.Roslyn.RealmProps.IntermediateModels.PropObj>().Validate(allOfResult1, level);
