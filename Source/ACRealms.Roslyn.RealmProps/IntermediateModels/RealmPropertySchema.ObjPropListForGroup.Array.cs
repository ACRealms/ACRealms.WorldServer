...
public readonly partial struct RealmPropertySchema
{
    ...
    /// </summary>
#if NET8_0_OR_GREATER
    [CollectionBuilder(typeof(ObjPropListForGroup), "Create")]
#endif
    public readonly partial struct ObjPropListForGroup
        : IJsonArray<ACRealms.Roslyn.RealmProps.IntermediateModels.RealmPropertySchema.ObjPropListForGroup>,
          IReadOnlyCollection<Corvus.Json.JsonAny>
    {
        /// <summary>
        /// Gets an empty array.
        /// </summary>
        public static ObjPropListForGroup EmptyArray { get; } = From(ImmutableList<JsonAny>.Empty);
        ...
        public static implicit operator ObjPropListForGroup(ImmutableList<JsonAny> value)
        {
            return new(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator ImmutableList<JsonAny>(ObjPropListForGroup value)
        {
            return
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator ObjPropListForGroup(JsonArray value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator JsonArray(ObjPropListForGroup value)
        {
            return
                value.AsArray;
        }
        ...
        public static ObjPropListForGroup From(ImmutableList<JsonAny> items)
        {
            return new(items);
        }

        /// <summary>
        /// Create an new instance of the <see cref="ObjPropListForGroup"/>" struct from a span of items.
        /// </summary>
        ...
        public static ObjPropListForGroup Create(ReadOnlySpan<Corvus.Json.JsonAny> items)
        {
            return new([..items]);
        }
        ...
        public static ObjPropListForGroup FromItems(params Corvus.Json.JsonAny[] items)
        {
            return new([..items]);
        }
        ...
        /// <param name="items">The value from which to construct the instance.</param>
        /// <returns>An instance of the array constructed from the value.</returns>
        public static ObjPropListForGroup FromItems<TItem>(params TItem[] items)
        ...
        public static ObjPropListForGroup FromItems<TItem1>(in TItem1 item1)
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static ObjPropListForGroup FromItems<TItem1, TItem2>(in TItem1 item1, in TItem2 item2)
            where TItem1 : struct, IJsonValue<TItem1>
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static ObjPropListForGroup FromItems<TItem1, TItem2, TItem3>(in TItem1 item1, in TItem2 item2, in TItem3 item3)
            where TItem1 : struct, IJsonValue<TItem1>
            where TItem2 : struct, IJsonValue<TItem2>
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static ObjPropListForGroup FromItems<TItem1, TItem2, TItem3, TItem4>(in TItem1 item1, in TItem2 item2, in TItem3 item3, in TItem4 item4)
            where TItem1 : struct, IJsonValue<TItem1>
            where TItem2 : struct, IJsonValue<TItem2>
            where TItem3 : struct, IJsonValue<TItem3>
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static ObjPropListForGroup FromItems<TItem1, TItem2, TItem3, TItem4, TItem5>(in TItem1 item1, in TItem2 item2, in TItem3 item3, in TItem4 item4, in TItem5 item5)
            where TItem1 : struct, IJsonValue<TItem1>
            where TItem2 : struct, IJsonValue<TItem2>
            where TItem3 : struct, IJsonValue<TItem3>
            where TItem4 : struct, IJsonValue<TItem4>
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static ObjPropListForGroup FromItems<TItem1, TItem2, TItem3, TItem4, TItem5, TItem6>(in TItem1 item1, in TItem2 item2, in TItem3 item3, in TItem4 item4, in TItem5 item5, in TItem6 item6)
            where TItem1 : struct, IJsonValue<TItem1>
            where TItem2 : struct, IJsonValue<TItem2>
            where TItem3 : struct, IJsonValue<TItem3>
            where TItem4 : struct, IJsonValue<TItem4>
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static ObjPropListForGroup FromItems<TItem1, TItem2, TItem3, TItem4, TItem5, TItem6, TItem7>(in TItem1 item1, in TItem2 item2, in TItem3 item3, in TItem4 item4, in TItem5 item5, in TItem6 item6, in TItem7 item7)
            where TItem1 : struct, IJsonValue<TItem1>
            where TItem2 : struct, IJsonValue<TItem2>
            where TItem3 : struct, IJsonValue<TItem3>
            where TItem4 : struct, IJsonValue<TItem4>
        ...
        public static ObjPropListForGroup FromRange(IEnumerable<Corvus.Json.JsonAny> items)
        {
            return new([..items]);
        }
        ...
        /// <param name="items">The items from which to construct the instance.</param>
        /// <returns>An instance of the array constructed from the items.</returns>
        public static ObjPropListForGroup FromRange<TItem>(IEnumerable<TItem> items)
            where TItem : struct, IJsonValue<TItem>
        {
            return new([..items.Select(item => item.AsAny)]);
        }
        ...
        public static ObjPropListForGroup FromRange(IEnumerable<string> items)
        {
            return new([..items]);
        }
        ...
        /// <param name="items">The items from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static ObjPropListForGroup FromRange(IEnumerable<double> items)
        {
            return new([..items]);
        }
        ...
        /// <param name="items">The items from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static ObjPropListForGroup FromRange(IEnumerable<float> items)
        {
            return new([..items]);
        }
        ...
        /// <param name="items">The items from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static ObjPropListForGroup FromRange(IEnumerable<int> items)
        {
            return new([..items]);
        }
        ...
        /// <param name="items">The items from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static ObjPropListForGroup FromRange(IEnumerable<long> items)
        {
            return new([..items]);
        }
        ...
        /// <param name="items">The items from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static ObjPropListForGroup FromRange(IEnumerable<bool> items)
        {
            return new([..items]);
        }
        ...
        /// </remarks>
        public static ObjPropListForGroup From<T>(IEnumerable<T> items)
        {
        ...
        /// <inheritdoc/>
        public ObjPropListForGroup Add(in JsonAny item1)
        {
        ...
        /// <inheritdoc/>
        public ObjPropListForGroup Add(params JsonAny[] items)
        {
            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
        ...
        /// <inheritdoc/>
        public ObjPropListForGroup AddRange<TArray>(in TArray items)
        ...
        /// <inheritdoc/>
        public ObjPropListForGroup AddRange<TItem>(IEnumerable<TItem> items)
            where TItem : struct, IJsonValue<TItem>
        {
            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
        ...
        /// <inheritdoc/>
        public ObjPropListForGroup AddRange(IEnumerable<JsonAny> items)
        {
            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
        ...
        /// <inheritdoc/>
        public ObjPropListForGroup Insert(int index, in JsonAny item1)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, item1));
        }

        /// <inheritdoc/>
        public ObjPropListForGroup InsertRange<TArray>(int index, in TArray items)
            where TArray : struct, IJsonArray<TArray>
        {
        ...
        /// <inheritdoc/>
        public ObjPropListForGroup InsertRange<TItem>(int index, IEnumerable<TItem> items)
            where TItem : struct, IJsonValue<TItem>
        {
        ...
        /// <inheritdoc/>
        public ObjPropListForGroup InsertRange(int index, IEnumerable<JsonAny> items)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items));
        }

        /// <inheritdoc/>
        public ObjPropListForGroup Replace(in JsonAny oldValue, in JsonAny newValue)
        {
            return new(__CorvusArrayHelpers.GetImmutableListReplacing(this, oldValue, newValue));
        }

        /// <inheritdoc/>
        public ObjPropListForGroup SetItem(int index, in JsonAny value)
        {
            return new(__CorvusArrayHelpers.GetImmutableListSetting(this, index, value));
        }

        /// <inheritdoc/>
        public ObjPropListForGroup Remove(in JsonAny oldValue)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWithout(this, oldValue));
        }

        /// <inheritdoc/>
        public ObjPropListForGroup RemoveAt(int index)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWithoutRange(this, index, 1));
        }

        /// <inheritdoc/>
        public ObjPropListForGroup RemoveRange(int index, int count)
        {
        ...
        private static class __CorvusArrayHelpers
        {
            ...
            public static ImmutableList<JsonAny> GetImmutableList(in ObjPropListForGroup arrayInstance)
            {
            ...
            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
            public static ImmutableList<JsonAny>.Builder GetImmutableListBuilder(in ObjPropListForGroup arrayInstance)
            {
            ...
            public static ImmutableList<JsonAny> GetImmutableListSetting(in ObjPropListForGroup arrayInstance, int index, in JsonAny value)
            {
                if ((arrayInstance.backing & Backing.JsonElement) != 0)
                {
                    if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
            ...
            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
            public static ImmutableList<JsonAny> GetImmutableListReplacing(in ObjPropListForGroup arrayInstance, in JsonAny oldItem, in JsonAny newItem)
            {
                if ((arrayInstance.backing & Backing.JsonElement) != 0)
                {
                    if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
            ...
            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
            public static ImmutableList<JsonAny> GetImmutableListWithout(in ObjPropListForGroup arrayInstance, in JsonAny item)
            {
                if ((arrayInstance.backing & Backing.JsonElement) != 0)
                {
                    if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
            ...
            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
            /// <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
            public static ImmutableList<JsonAny> GetImmutableListWithoutRange(in ObjPropListForGroup arrayInstance, int index, int count)
            {
                if ((arrayInstance.backing & Backing.JsonElement) != 0)
                {
                    if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
            ...
            // <exception cref = "InvalidOperationException">The value is not an array.</exception>
            // <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
            public static ImmutableList<JsonAny> GetImmutableListWith(in ObjPropListForGroup arrayInstance, int index, in JsonAny value)
            {
                if ((arrayInstance.backing & Backing.JsonElement) != 0)
                {
                    if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
            ...
            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
            /// <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
            public static ImmutableList<JsonAny> GetImmutableListWith<TEnumerable>(in ObjPropListForGroup arrayInstance, int index, TEnumerable values)
