    ...
    public readonly partial struct GroupPropSelection
    {
        ...
        public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            if (level > ValidationLevel.Basic)
            {
                ...
                result = result.PushSchemaLocation("realm-props/group.json#/definitions/groupPropSelection");
            }
        ...
        public static partial class CorvusValidation
        {
                ...
                ValidationLevel level = ValidationLevel.Flag)
            {
                ...
                allOfResult0 = value.As<ACRealms.Roslyn.RealmProps.IntermediateModels.Group.GroupPropSelection.AllOf0Entity>().Validate(allOfResult0, level);
                ...
                allOfResult1 = value.As<ACRealms.Roslyn.RealmProps.IntermediateModels.Group.GroupPropSelection.AllOf1Entity>().Validate(allOfResult1, level);
                ...
                ValidationLevel level = ValidationLevel.Flag)
            {
                ...
                foreach (JsonObjectProperty property in value.EnumerateObject())
                {
                    ...
                    else if (property.NameEquals(JsonPropertyNames.KeyPrefixUtf8, JsonPropertyNames.KeyPrefix))
                    {
                        ...
                        if (level > ValidationLevel.Basic)
                        {
                            result = result.PushValidationLocationReducedPathModifierAndProperty(new("#/properties/key_prefix/$ref"), JsonPropertyNames.KeyPrefix);
                        }

                        ValidationContext propertyResult = property.Value.As<ACRealms.Roslyn.RealmProps.IntermediateModels.ShortKey>().Validate(result.CreateChildContext(), level);
                        if (level == ValidationLevel.Flag && !propertyResult.IsValid)
                        {
                            return propertyResult;
                        }
                    ...
                    else if (property.NameEquals(JsonPropertyNames.KeySuffixUtf8, JsonPropertyNames.KeySuffix))
                    {
                        ...
                        if (level > ValidationLevel.Basic)
                        {
                            result = result.PushValidationLocationReducedPathModifierAndProperty(new("#/properties/key_suffix/$ref"), JsonPropertyNames.KeySuffix);
                        }
                    ...
                    else if (property.NameEquals(JsonPropertyNames.PropertiesUtf8, JsonPropertyNames.Properties))
                    {
                        ...
                        ValidationContext propertyResult = property.Value.As<ACRealms.Roslyn.RealmProps.IntermediateModels.Group.GroupPropSelection.PropertiesEntity>().Validate(result.CreateChildContext(), level);
                        if (level == ValidationLevel.Flag && !propertyResult.IsValid)
                        {
                            return propertyResult;
                        }
