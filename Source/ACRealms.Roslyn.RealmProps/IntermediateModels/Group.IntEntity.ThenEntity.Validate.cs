        ...
        public readonly partial struct ThenEntity
        {
            ...
            public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
            {
                ...
                if (level > ValidationLevel.Basic)
                {
                    ...
                    result = result.PushSchemaLocation("realm-props/group.json#/definitions/props/definitions/int/then");
                }
            ...
            public static partial class CorvusValidation
            {
                    ...
                    ValidationLevel level = ValidationLevel.Flag)
                {
                    ...
                    int propertyCount = 0;
                    foreach (JsonObjectProperty<ACRealms.Roslyn.RealmProps.IntermediateModels.Group.IntEntity.ThenEntity.AdditionalPropertiesEntity> property in value.EnumerateObject())
                    {
