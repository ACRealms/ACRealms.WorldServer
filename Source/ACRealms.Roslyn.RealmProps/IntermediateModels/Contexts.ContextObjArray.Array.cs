...
public readonly partial struct Contexts
{
    ...
    /// </summary>
#if NET8_0_OR_GREATER
    [CollectionBuilder(typeof(ContextObjArray), "Create")]
#endif
    public readonly partial struct ContextObjArray
        : IJsonArray<ACRealms.Roslyn.RealmProps.IntermediateModels.Contexts.ContextObjArray>,
          IReadOnlyCollection<ACRealms.Roslyn.RealmProps.IntermediateModels.Contexts.ContextObj>
    {
        /// <summary>
        /// Gets an empty array.
        /// </summary>
        public static ContextObjArray EmptyArray { get; } = From(ImmutableList<JsonAny>.Empty);
        ...
        /// <inheritdoc/>
        Corvus.Json.JsonAny IJsonArray<ContextObjArray>.this[int index]
        {
            get
            {
        ...
        public ACRealms.Roslyn.RealmProps.IntermediateModels.Contexts.ContextObj this[int index]
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                ...
                if ((this.backing & Backing.Array) != 0)
                {
                    try
                    {
                        return this.arrayBacking[index].As<ACRealms.Roslyn.RealmProps.IntermediateModels.Contexts.ContextObj>();
                    }
                    catch (ArgumentOutOfRangeException ex)
                    {
                        throw new IndexOutOfRangeException(ex.Message, ex);
        ...
        public static implicit operator ContextObjArray(ImmutableList<JsonAny> value)
        {
            return new(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator ImmutableList<JsonAny>(ContextObjArray value)
        {
            return
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator ContextObjArray(JsonArray value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator JsonArray(ContextObjArray value)
        {
            return
                value.AsArray;
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ContextObjArray"/> struct.
        /// </summary>
        ...
        public static ContextObjArray From(ImmutableList<JsonAny> items)
        {
            return new(items);
        }

        /// <summary>
        /// Create an new instance of the <see cref="ContextObjArray"/>" struct from a span of items.
        /// </summary>
        ...
        public static ContextObjArray Create(ReadOnlySpan<ACRealms.Roslyn.RealmProps.IntermediateModels.Contexts.ContextObj> items)
        {
            return new([..items]);
        }
        ...
        public static ContextObjArray FromItems(params ACRealms.Roslyn.RealmProps.IntermediateModels.Contexts.ContextObj[] items)
        {
            return new([..items]);
        }
        ...
        public static ContextObjArray FromItems(in ACRealms.Roslyn.RealmProps.IntermediateModels.Contexts.ContextObj item1)
        {
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static ContextObjArray FromItems(in ACRealms.Roslyn.RealmProps.IntermediateModels.Contexts.ContextObj item1, in ACRealms.Roslyn.RealmProps.IntermediateModels.Contexts.ContextObj item2)
        {
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static ContextObjArray FromItems(in ACRealms.Roslyn.RealmProps.IntermediateModels.Contexts.ContextObj item1, in ACRealms.Roslyn.RealmProps.IntermediateModels.Contexts.ContextObj item2, in ACRealms.Roslyn.RealmProps.IntermediateModels.Contexts.ContextObj item3)
        {
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static ContextObjArray FromItems(in ACRealms.Roslyn.RealmProps.IntermediateModels.Contexts.ContextObj item1, in ACRealms.Roslyn.RealmProps.IntermediateModels.Contexts.ContextObj item2, in ACRealms.Roslyn.RealmProps.IntermediateModels.Contexts.ContextObj item3, in ACRealms.Roslyn.RealmProps.IntermediateModels.Contexts.ContextObj item4)
        {
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static ContextObjArray FromItems(in ACRealms.Roslyn.RealmProps.IntermediateModels.Contexts.ContextObj item1, in ACRealms.Roslyn.RealmProps.IntermediateModels.Contexts.ContextObj item2, in ACRealms.Roslyn.RealmProps.IntermediateModels.Contexts.ContextObj item3, in ACRealms.Roslyn.RealmProps.IntermediateModels.Contexts.ContextObj item4, in ACRealms.Roslyn.RealmProps.IntermediateModels.Contexts.ContextObj item5)
        {
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static ContextObjArray FromItems(in ACRealms.Roslyn.RealmProps.IntermediateModels.Contexts.ContextObj item1, in ACRealms.Roslyn.RealmProps.IntermediateModels.Contexts.ContextObj item2, in ACRealms.Roslyn.RealmProps.IntermediateModels.Contexts.ContextObj item3, in ACRealms.Roslyn.RealmProps.IntermediateModels.Contexts.ContextObj item4, in ACRealms.Roslyn.RealmProps.IntermediateModels.Contexts.ContextObj item5, in ACRealms.Roslyn.RealmProps.IntermediateModels.Contexts.ContextObj item6)
        {
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static ContextObjArray FromItems(in ACRealms.Roslyn.RealmProps.IntermediateModels.Contexts.ContextObj item1, in ACRealms.Roslyn.RealmProps.IntermediateModels.Contexts.ContextObj item2, in ACRealms.Roslyn.RealmProps.IntermediateModels.Contexts.ContextObj item3, in ACRealms.Roslyn.RealmProps.IntermediateModels.Contexts.ContextObj item4, in ACRealms.Roslyn.RealmProps.IntermediateModels.Contexts.ContextObj item5, in ACRealms.Roslyn.RealmProps.IntermediateModels.Contexts.ContextObj item6, in ACRealms.Roslyn.RealmProps.IntermediateModels.Contexts.ContextObj item7)
        {
        ...
        public static ContextObjArray FromRange(IEnumerable<ACRealms.Roslyn.RealmProps.IntermediateModels.Contexts.ContextObj> items)
        {
            return new([..items]);
        }
        ...
        /// <param name="items">The items from which to construct the instance.</param>
        /// <returns>An instance of the array constructed from the items .</returns>
        static ContextObjArray IJsonArray<ContextObjArray>.FromRange(IEnumerable<JsonAny> items)
        {
            return new([..items]);
        }
        ...
        /// <param name="items">The items from which to construct the instance.</param>
        /// <returns>An instance of the array constructed from the items.</returns>
        static ContextObjArray IJsonArray<ContextObjArray>.FromRange<T>(IEnumerable<T> items)
        {
        ...
        /// <inheritdoc/>
        IEnumerator<ACRealms.Roslyn.RealmProps.IntermediateModels.Contexts.ContextObj> IEnumerable<ACRealms.Roslyn.RealmProps.IntermediateModels.Contexts.ContextObj>.GetEnumerator() => this.EnumerateArray();

        /// <inheritdoc/>
        IEnumerator IEnumerable.GetEnumerator() => this.EnumerateArray();

        /// <inheritdoc/>
        int IReadOnlyCollection<ACRealms.Roslyn.RealmProps.IntermediateModels.Contexts.ContextObj>.Count => this.GetArrayLength();
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<ACRealms.Roslyn.RealmProps.IntermediateModels.Contexts.ContextObj> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator IJsonArray<ContextObjArray>.EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new(this.jsonElementBacking);
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator<TItem> IJsonArray<ContextObjArray>.EnumerateArray<TItem>()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new(this.jsonElementBacking);
        ...
        /// <inheritdoc/>
        ContextObjArray IJsonArray<ContextObjArray>.Add(in JsonAny item1)
        {
        ...
        /// <inheritdoc/>
        ContextObjArray IJsonArray<ContextObjArray>.Add(params JsonAny[] items)
        {
            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
        ...
        /// <inheritdoc/>
        ContextObjArray IJsonArray<ContextObjArray>.AddRange<TArray>(in TArray items)
        {
            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
        ...
        /// <inheritdoc/>
        ContextObjArray IJsonArray<ContextObjArray>.AddRange<TItem>(IEnumerable<TItem> items)
        {
            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
        ...
        /// <inheritdoc/>
        ContextObjArray IJsonArray<ContextObjArray>.AddRange(IEnumerable<JsonAny> items)
        {
            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
        ...
        /// <inheritdoc/>
        ContextObjArray IJsonArray<ContextObjArray>.Insert(int index, in JsonAny item1)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, item1));
        }

        /// <inheritdoc/>
        ContextObjArray IJsonArray<ContextObjArray>.InsertRange<TArray>(int index, in TArray items)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.EnumerateArray()));
        }

        /// <inheritdoc/>
        ContextObjArray IJsonArray<ContextObjArray>.InsertRange<TItem>(int index, IEnumerable<TItem> items)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.Select(item => item.AsAny)));
        }

        /// <inheritdoc/>
        ContextObjArray IJsonArray<ContextObjArray>.InsertRange(int index, IEnumerable<JsonAny> items)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items));
        }

        /// <inheritdoc/>
        ContextObjArray IJsonArray<ContextObjArray>.Replace(in JsonAny oldValue, in JsonAny newValue)
        {
            return new(__CorvusArrayHelpers.GetImmutableListReplacing(this, oldValue, newValue));
        }

        /// <inheritdoc/>
        ContextObjArray IJsonArray<ContextObjArray>.SetItem(int index, in JsonAny value)
        {
            return new(__CorvusArrayHelpers.GetImmutableListSetting(this, index, value));
        }

        /// <inheritdoc/>
        public ContextObjArray Add(in ACRealms.Roslyn.RealmProps.IntermediateModels.Contexts.ContextObj item1)
        {
            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
        ...
        /// <inheritdoc/>
        public ContextObjArray Add(params ACRealms.Roslyn.RealmProps.IntermediateModels.Contexts.ContextObj[] items)
        {
            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
            foreach (ACRealms.Roslyn.RealmProps.IntermediateModels.Contexts.ContextObj item in items)
            {
                builder.Add(item.AsAny);
            }
        ...
        /// <inheritdoc/>
        public ContextObjArray AddRange(IEnumerable<ACRealms.Roslyn.RealmProps.IntermediateModels.Contexts.ContextObj> items)
        {
            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
            foreach (ACRealms.Roslyn.RealmProps.IntermediateModels.Contexts.ContextObj item in items)
            {
        ...
        /// <inheritdoc/>
        public ContextObjArray Insert(int index, in ACRealms.Roslyn.RealmProps.IntermediateModels.Contexts.ContextObj item1)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, item1));
        }

        /// <inheritdoc/>
        public ContextObjArray InsertRange(int index, IEnumerable<ACRealms.Roslyn.RealmProps.IntermediateModels.Contexts.ContextObj> items)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.Select(item => item.AsAny)));
        }

        /// <inheritdoc/>
        public ContextObjArray Replace(in ACRealms.Roslyn.RealmProps.IntermediateModels.Contexts.ContextObj oldValue, in ACRealms.Roslyn.RealmProps.IntermediateModels.Contexts.ContextObj newValue)
        {
            return new(__CorvusArrayHelpers.GetImmutableListReplacing(this, oldValue, newValue));
        }

        /// <inheritdoc/>
        public ContextObjArray SetItem(int index, in ACRealms.Roslyn.RealmProps.IntermediateModels.Contexts.ContextObj value)
        {
            return new(__CorvusArrayHelpers.GetImmutableListSetting(this, index, value));
        }

        /// <inheritdoc/>
        ContextObjArray IJsonArray<ContextObjArray>.Remove(in JsonAny oldValue)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWithout(this, oldValue));
        }

        /// <inheritdoc/>
        ContextObjArray IJsonArray<ContextObjArray>.RemoveAt(int index)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWithoutRange(this, index, 1));
        }

        /// <inheritdoc/>
        ContextObjArray IJsonArray<ContextObjArray>.RemoveRange(int index, int count)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWithoutRange(this, index, count));
        }

        /// <inheritdoc/>
        public ContextObjArray Remove(in ACRealms.Roslyn.RealmProps.IntermediateModels.Contexts.ContextObj oldValue)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWithout(this, oldValue));
        }
        ...
        private static class __CorvusArrayHelpers
        {
            ...
            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
            public static ImmutableList<JsonAny> GetImmutableList(in ContextObjArray arrayInstance)
            {
            ...
            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
            public static ImmutableList<JsonAny>.Builder GetImmutableListBuilder(in ContextObjArray arrayInstance)
            {
            ...
            public static ImmutableList<JsonAny> GetImmutableListSetting(in ContextObjArray arrayInstance, int index, in JsonAny value)
            {
                if ((arrayInstance.backing & Backing.JsonElement) != 0)
                {
                    if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
            ...
            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
            public static ImmutableList<JsonAny> GetImmutableListReplacing(in ContextObjArray arrayInstance, in JsonAny oldItem, in JsonAny newItem)
            {
                if ((arrayInstance.backing & Backing.JsonElement) != 0)
                {
                    if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
            ...
            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
            public static ImmutableList<JsonAny> GetImmutableListWithout(in ContextObjArray arrayInstance, in JsonAny item)
            {
                if ((arrayInstance.backing & Backing.JsonElement) != 0)
                {
                    if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
            ...
            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
            /// <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
            public static ImmutableList<JsonAny> GetImmutableListWithoutRange(in ContextObjArray arrayInstance, int index, int count)
            {
                if ((arrayInstance.backing & Backing.JsonElement) != 0)
                {
                    if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
            ...
            // <exception cref = "InvalidOperationException">The value is not an array.</exception>
            // <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
            public static ImmutableList<JsonAny> GetImmutableListWith(in ContextObjArray arrayInstance, int index, in JsonAny value)
            {
                if ((arrayInstance.backing & Backing.JsonElement) != 0)
                {
                    if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
            ...
            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
            /// <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
            public static ImmutableList<JsonAny> GetImmutableListWith<TEnumerable>(in ContextObjArray arrayInstance, int index, TEnumerable values)
