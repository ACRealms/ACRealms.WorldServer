...
public readonly partial struct RealmPropertySchema
{
    ...
    public readonly partial struct ObjPropEntity
    {
        private ValidationContext ValidateAllOf(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext allOfResult0 = this.As<ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.ObjPropOrGroupEntity>().Validate(childContext0.CreateChildContext(), level);
