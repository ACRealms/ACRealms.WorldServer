...
public readonly partial struct RealmPropertySchema
{
    ...
    public readonly partial struct ObjPropListForGroupEntity
    {
        private ValidationContext ValidateOneOf(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext oneOfResult0 = this.As<ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.ObjPropListEntity>().Validate(childContext0.CreateChildContext(), level);
            ...
            ValidationContext oneOfResult1 = this.As<ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.PropNameEntityArray>().Validate(childContext1.CreateChildContext(), level);
