...
public readonly partial struct RealmPropertySchema
{
    ...
    {
        /// <inheritdoc/>
        public PropDefEntity Add(in JsonAny item1)
        {
        ...
        /// <inheritdoc/>
        public PropDefEntity Add(params JsonAny[] items)
        {
            ImmutableList<JsonAny>.Builder builder = this.GetImmutableListBuilder();
        ...
        /// <inheritdoc/>
        public PropDefEntity AddRange<TArray>(in TArray items)
        ...
        /// <inheritdoc/>
        public PropDefEntity AddRange<TItem>(IEnumerable<TItem> items)
        ...
        /// <inheritdoc/>
        public PropDefEntity AddRange(IEnumerable<JsonAny> items)
        {
            ImmutableList<JsonAny>.Builder builder = this.GetImmutableListBuilder();
            builder.AddRange(items);
            return new(builder.ToImmutable());
        ...
        /// <inheritdoc/>
        public PropDefEntity Insert(int index, in JsonAny item1)
        {
            return new(this.GetImmutableListWith(index, item1));
        }

        /// <inheritdoc/>
        public PropDefEntity InsertRange<TArray>(int index, in TArray items)
            where TArray : struct, IJsonArray<TArray>
        {
        ...
        /// <inheritdoc/>
        public PropDefEntity InsertRange<TItem>(int index, IEnumerable<TItem> items)
            where TItem : struct, IJsonValue<TItem>
        {
        ...
        /// <inheritdoc/>
        public PropDefEntity InsertRange(int index, IEnumerable<JsonAny> items)
        {
            return new(this.GetImmutableListWith(index, items));
        }

        /// <inheritdoc/>
        public PropDefEntity Replace(in JsonAny oldValue, in JsonAny newValue)
        {
            return new(this.GetImmutableListReplacing(oldValue.AsAny, newValue.AsAny));
        }

        /// <inheritdoc/>
        public PropDefEntity SetItem(int index, in JsonAny value)
        {
