...
[CollectionBuilder(typeof(GroupEntityArray), "Create")]
public readonly partial struct GroupEntityArray : IJsonArray<GroupEntityArray>, IReadOnlyCollection<ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.GroupEntity>
#else
    public readonly partial struct GroupEntityArray : IJsonArray<GroupEntityArray>, IReadOnlyCollection<ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.GroupEntity>
#endif
    {
        ...
        /// Gets an empty array.
        /// </summary>
        public static readonly GroupEntityArray EmptyArray = From(ImmutableList<JsonAny>.Empty);
        /// <summary>
        /// Initializes a new instance of the <see cref = "GroupEntityArray"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public GroupEntityArray(ImmutableList<JsonAny> value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public GroupEntityArray(IEnumerable<JsonAny> value)
        {
            this.jsonElementBacking = default;
            this.backing = Backing.Array;
        ...
        /// <inheritdoc/>
        JsonAny IJsonArray<GroupEntityArray>.this[int index]
        {
            get
            {
        ...
        public ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.GroupEntity this[int index]
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    return new ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.GroupEntity(this.jsonElementBacking[index]);
                }
                ...
                if ((this.backing & Backing.Array) != 0)
                {
                    try
                    {
                        return this.arrayBacking[index].As<ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.GroupEntity>();
                    }
                    catch (ArgumentOutOfRangeException ex)
                    {
                        throw new IndexOutOfRangeException(ex.Message, ex);
        ...
        public static implicit operator ImmutableList<JsonAny>(GroupEntityArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator GroupEntityArray(ImmutableList<JsonAny> value)
        {
            return new(value);
        }
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator GroupEntityArray(JsonArray value)
        {
        ...
        public static GroupEntityArray From(ImmutableList<JsonAny> items)
        {
            return new(items);
        }
        ...
        public static GroupEntityArray Create(ReadOnlySpan<ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.GroupEntity> items)
        {
            return new([..items]);
        }
        ...
        /// <returns>A GroupEntityArray instantiated from the given items.</returns>
        public static GroupEntityArray FromItems(in ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.GroupEntity value1)
        {
        ...
        /// <returns>A GroupEntityArray instantiated from the given items.</returns>
        public static GroupEntityArray FromItems(in ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.GroupEntity value1, in ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.GroupEntity value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A GroupEntityArray instantiated from the given items.</returns>
        public static GroupEntityArray FromItems(in ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.GroupEntity value1, in ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.GroupEntity value2, in ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.GroupEntity value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static GroupEntityArray FromItems(params ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.GroupEntity[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.GroupEntity item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static GroupEntityArray FromRange(IEnumerable<ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.GroupEntity> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.GroupEntity item in value)
            {
        ...
        /// </remarks>
        public static GroupEntityArray From<T>(IEnumerable<T> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            return new GroupEntityArray(builder.ToImmutable());
        }
        ...
        /// <param name = "items">The items from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static GroupEntityArray FromRange(IEnumerable<JsonAny> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// <param name = "items">The items from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static GroupEntityArray FromRange<T>(IEnumerable<T> items)
        ...
        /// <inheritdoc/>
        IEnumerator<ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.GroupEntity> IEnumerable<ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.GroupEntity>.GetEnumerator()
        {
        ...
        /// <inheritdoc/>
        int IReadOnlyCollection<ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.GroupEntity>.Count => this.GetArrayLength();
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.GroupEntity> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.GroupEntity>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.GroupEntity>(this.arrayBacking);
            }
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator IJsonArray<GroupEntityArray>.EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator<TItem> IJsonArray<GroupEntityArray>.EnumerateArray<TItem>()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
