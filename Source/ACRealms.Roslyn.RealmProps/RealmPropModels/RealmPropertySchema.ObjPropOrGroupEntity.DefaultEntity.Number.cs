...
: IJsonNumber<DefaultEntity>,
  IAdditionOperators<DefaultEntity, DefaultEntity, DefaultEntity>,
  ISubtractionOperators<DefaultEntity, DefaultEntity, DefaultEntity>,
  IMultiplyOperators<DefaultEntity, DefaultEntity, DefaultEntity>,
  IDivisionOperators<DefaultEntity, DefaultEntity, DefaultEntity>,
  IIncrementOperators<DefaultEntity>,
  IDecrementOperators<DefaultEntity>
#else
        : IJsonNumber<DefaultEntity>
#endif
        {
            ...
            public DefaultEntity(in BinaryJsonNumber value)
            {
            ...
            public DefaultEntity(double value) : this(new BinaryJsonNumber(value))
            {
            }
            ...
            public static implicit operator DefaultEntity(JsonNumber value)
            {
            ...
            public static explicit operator byte (DefaultEntity value)
            {
            ...
            public static explicit operator decimal (DefaultEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            public static explicit operator double (DefaultEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            public static explicit operator short (DefaultEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            public static explicit operator int (DefaultEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            public static explicit operator long (DefaultEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
    ...
    /// <exception cref="InvalidOperationException">The value was not a number.</exception>
    /// <exception cref="FormatException">The value was not formatted as an Int64.</exception>
    public static explicit operator Int128(DefaultEntity value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
        ...
        throw new InvalidOperationException();
            ...
            public static explicit operator sbyte (DefaultEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
    ...
    public static explicit operator Half(DefaultEntity value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
        ...
        throw new InvalidOperationException();
            ...
            /// <exception cref = "InvalidOperationException">The value was not a number.</exception>
            /// <exception cref = "FormatException">The value was not formatted as a Single.</exception>
            public static explicit operator float (DefaultEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            public static explicit operator ushort (DefaultEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            public static explicit operator uint (DefaultEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            public static explicit operator ulong (DefaultEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
    ...
    /// <exception cref="InvalidOperationException">The value was not a number.</exception>
    /// <exception cref="FormatException">The value was not formatted as an UInt64.</exception>
    public static explicit operator UInt128(DefaultEntity value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
        ...
        throw new InvalidOperationException();
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static explicit operator DefaultEntity(decimal value)
            {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static explicit operator DefaultEntity(double value)
            {
                return new(new BinaryJsonNumber(value));
            }
    ...
    /// </summary>
    /// <param name="value">The value to convert.</param>
    public static explicit operator DefaultEntity(Half value)
    {
        return new(new BinaryJsonNumber(value));
    }
#endif
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static explicit operator DefaultEntity(float value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static explicit operator DefaultEntity(byte value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static explicit operator DefaultEntity(short value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static explicit operator DefaultEntity(int value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static explicit operator DefaultEntity(long value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static explicit operator DefaultEntity(sbyte value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static explicit operator DefaultEntity(ushort value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static explicit operator DefaultEntity(uint value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static explicit operator DefaultEntity(ulong value)
            {
                return new(new BinaryJsonNumber(value));
            }
    ...
    /// </summary>
    /// <param name="value">The value to convert.</param>
    public static explicit operator DefaultEntity(Int128 value)
    {
        return new(new BinaryJsonNumber(value));
    }
    ...
    /// </summary>
    /// <param name="value">The value to convert.</param>
    public static explicit operator DefaultEntity(UInt128 value)
    {
        return new(new BinaryJsonNumber(value));
    }
#endif
            ...
            public static DefaultEntity operator +(DefaultEntity left, DefaultEntity right)
            {
            ...
            /// <returns>The resulting value.</returns>
            public static DefaultEntity operator ++(DefaultEntity value)
            {
            ...
            public static int Compare(in DefaultEntity lhs, in DefaultEntity rhs)
            {
