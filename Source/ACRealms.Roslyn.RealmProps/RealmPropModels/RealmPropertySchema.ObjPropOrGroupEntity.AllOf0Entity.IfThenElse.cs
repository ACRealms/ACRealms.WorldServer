...
public readonly partial struct RealmPropertySchema
{
    public readonly partial struct ObjPropOrGroupEntity
    {
        ...
        public readonly partial struct AllOf0Entity
        {
            ...
            public bool MatchIfRequiredEnum(out ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.ObjPropOrGroupEntity.AllOf0Entity.WithTypeEnum result)
            {
                if (this.As<ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.ObjPropOrGroupEntity.AllOf0Entity.RequiredEnum>().IsValid())
                {
                    result = this.As<ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.ObjPropOrGroupEntity.AllOf0Entity.WithTypeEnum>();
                    return true;
                }

                result = ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.ObjPropOrGroupEntity.AllOf0Entity.WithTypeEnum.Undefined;
                return false;
            }
        }
    }
