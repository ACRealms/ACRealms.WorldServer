...
public readonly partial struct RealmPropertySchema
{
    public readonly partial struct ObjPropOrGroupEntity
    {
        ...
        public readonly partial struct AllOf2Entity
        {
            ...
            public bool MatchIfWithTypeInteger(out ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.ObjPropOrGroupEntity.AllOf2Entity.ThenEntity result)
            {
                if (this.As<ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.ObjPropOrGroupEntity.AllOf2Entity.WithTypeInteger>().IsValid())
                {
                    result = this.As<ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.ObjPropOrGroupEntity.AllOf2Entity.ThenEntity>();
                    return true;
                }

                result = ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.ObjPropOrGroupEntity.AllOf2Entity.ThenEntity.Undefined;
                return false;
            }
        }
    }
