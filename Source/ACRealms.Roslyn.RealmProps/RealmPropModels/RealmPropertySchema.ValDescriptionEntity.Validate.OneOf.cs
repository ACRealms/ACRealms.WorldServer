...
public readonly partial struct RealmPropertySchema
{
    ...
    public readonly partial struct ValDescriptionEntity
    {
        private ValidationContext ValidateOneOf(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext oneOfResult0 = this.As<ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.ValDescriptionEntity.OneOf0Entity>().Validate(childContext0.CreateChildContext(), level);
            ...
            ValidationContext oneOfResult1 = this.As<ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.DescriptionArrayEntity>().Validate(childContext1.CreateChildContext(), level);
