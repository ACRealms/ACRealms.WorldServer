    ...
    public readonly partial struct ObjPropOrGroupEntity
    {
        ...
        public readonly partial struct AllOf2Entity
        {
            ...
            private static ImmutableList<JsonObjectProperty> BuildDefaults()
            {
                ...
                builder.Add(JsonPropertyNames.Default, ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.ValIntEntity.DefaultInstance);
                builder.Add(JsonPropertyNames.MaxValue, ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.ValIntEntity.DefaultInstance);
                builder.Add(JsonPropertyNames.MinValue, ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.ValIntEntity.DefaultInstance);
