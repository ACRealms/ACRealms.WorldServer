...
public readonly partial struct RealmPropertySchema
{
    ...
    public readonly partial struct GroupEntity
    {
        private ValidationContext ValidateNot(ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext notResult = this.As<ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.GroupEntity.RequiredDefaultFromServerProperty>().Validate(validationContext.CreateChildContext(), level);
