...
public readonly partial struct RealmPropertySchema
{
    public readonly partial struct GroupEntity
    {
        public readonly partial struct AllOf1Entity
        {
            ...
            /// </summary>
            public readonly partial struct RequiredDefaultFromServerProperty : IJsonObject<RequiredDefaultFromServerProperty>
            {
                /// <summary>
                /// Initializes a new instance of the <see cref = "RequiredDefaultFromServerProperty"/> struct.
                /// </summary>
                /// <param name = "value">The value from which to construct the instance.</param>
                public RequiredDefaultFromServerProperty(ImmutableList<JsonObjectProperty> value)
                {
                ...
                public static implicit operator RequiredDefaultFromServerProperty(JsonObject value)
                {
                ...
                public static RequiredDefaultFromServerProperty FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
                {
                ...
                /// <param name = "source">The dictionary of properties.</param>
                /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
                public static RequiredDefaultFromServerProperty FromProperties(ImmutableList<JsonObjectProperty> source)
                {
                    return new(source);
                }
                ...
                /// <param name = "source">The dictionary of properties.</param>
                /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
                public static RequiredDefaultFromServerProperty FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
                {
                ...
                /// <inheritdoc/>
                public RequiredDefaultFromServerProperty SetProperty<TValue>(in JsonPropertyName name, TValue value)
                ...
                /// <inheritdoc/>
                public RequiredDefaultFromServerProperty RemoveProperty(in JsonPropertyName name)
                {
                    return new(this.GetPropertyBackingWithout(name));
                }

                /// <inheritdoc/>
                public RequiredDefaultFromServerProperty RemoveProperty(string name)
                {
                    return new(this.GetPropertyBackingWithout(name));
                }

                /// <inheritdoc/>
                public RequiredDefaultFromServerProperty RemoveProperty(ReadOnlySpan<char> name)
                {
                    return new(this.GetPropertyBackingWithout(name));
                }

                /// <inheritdoc/>
                public RequiredDefaultFromServerProperty RemoveProperty(ReadOnlySpan<byte> utf8Name)
                {
