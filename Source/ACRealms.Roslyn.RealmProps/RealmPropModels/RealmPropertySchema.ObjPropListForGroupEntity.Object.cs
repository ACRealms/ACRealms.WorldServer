...
public readonly partial struct RealmPropertySchema
{
    ...
    /// </summary>
    public readonly partial struct ObjPropListForGroupEntity : IJsonObject<ObjPropListForGroupEntity>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "ObjPropListForGroupEntity"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ObjPropListForGroupEntity(ImmutableList<JsonObjectProperty> value)
        {
        ...
        public static implicit operator ObjPropListForGroupEntity(JsonObject value)
        {
        ...
        public static ObjPropListForGroupEntity FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
        {
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static ObjPropListForGroupEntity FromProperties(ImmutableList<JsonObjectProperty> source)
        {
            return new(source);
        }
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static ObjPropListForGroupEntity FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
        {
        ...
        /// <inheritdoc/>
        public ObjPropListForGroupEntity SetProperty<TValue>(in JsonPropertyName name, TValue value)
        ...
        /// <inheritdoc/>
        public ObjPropListForGroupEntity RemoveProperty(in JsonPropertyName name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public ObjPropListForGroupEntity RemoveProperty(string name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public ObjPropListForGroupEntity RemoveProperty(ReadOnlySpan<char> name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public ObjPropListForGroupEntity RemoveProperty(ReadOnlySpan<byte> utf8Name)
        {
