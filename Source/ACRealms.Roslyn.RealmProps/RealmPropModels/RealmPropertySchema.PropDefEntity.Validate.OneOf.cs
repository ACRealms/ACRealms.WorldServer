...
public readonly partial struct RealmPropertySchema
{
    ...
    public readonly partial struct PropDefEntity
    {
        private ValidationContext ValidateOneOf(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext oneOfResult0 = this.As<ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.ObjPropEntity>().Validate(childContext0.CreateChildContext(), level);
