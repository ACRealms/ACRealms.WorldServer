...
[CollectionBuilder(typeof(DescriptionArrayEntity), "Create")]
public readonly partial struct DescriptionArrayEntity : IJsonArray<DescriptionArrayEntity>, IReadOnlyCollection<ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.DescriptionArrayEntity.DescriptionArrayDescriptionArrayEntity>
#else
    public readonly partial struct DescriptionArrayEntity : IJsonArray<DescriptionArrayEntity>, IReadOnlyCollection<ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.DescriptionArrayEntity.DescriptionArrayDescriptionArrayEntity>
#endif
    {
        ...
        /// Gets an empty array.
        /// </summary>
        public static readonly DescriptionArrayEntity EmptyArray = From(ImmutableList<JsonAny>.Empty);
        /// <summary>
        /// Initializes a new instance of the <see cref = "DescriptionArrayEntity"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public DescriptionArrayEntity(ImmutableList<JsonAny> value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public DescriptionArrayEntity(IEnumerable<JsonAny> value)
        {
            this.jsonElementBacking = default;
            this.backing = Backing.Array;
        ...
        /// <inheritdoc/>
        JsonAny IJsonArray<DescriptionArrayEntity>.this[int index]
        {
            get
            {
        ...
        public ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.DescriptionArrayEntity.DescriptionArrayDescriptionArrayEntity this[int index]
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    return new ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.DescriptionArrayEntity.DescriptionArrayDescriptionArrayEntity(this.jsonElementBacking[index]);
                }
                ...
                if ((this.backing & Backing.Array) != 0)
                {
                    try
                    {
                        return this.arrayBacking[index].As<ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.DescriptionArrayEntity.DescriptionArrayDescriptionArrayEntity>();
                    }
                    catch (ArgumentOutOfRangeException ex)
                    {
                        throw new IndexOutOfRangeException(ex.Message, ex);
        ...
        public static implicit operator ImmutableList<JsonAny>(DescriptionArrayEntity value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator DescriptionArrayEntity(ImmutableList<JsonAny> value)
        {
            return new(value);
        }
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator DescriptionArrayEntity(JsonArray value)
        {
        ...
        public static DescriptionArrayEntity From(ImmutableList<JsonAny> items)
        {
            return new(items);
        }
        ...
        public static DescriptionArrayEntity Create(ReadOnlySpan<ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.DescriptionArrayEntity.DescriptionArrayDescriptionArrayEntity> items)
        {
            return new([..items]);
        }
        ...
        /// <returns>A DescriptionArrayEntity instantiated from the given items.</returns>
        public static DescriptionArrayEntity FromItems(in ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.DescriptionArrayEntity.DescriptionArrayDescriptionArrayEntity value1)
        {
        ...
        /// <returns>A DescriptionArrayEntity instantiated from the given items.</returns>
        public static DescriptionArrayEntity FromItems(in ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.DescriptionArrayEntity.DescriptionArrayDescriptionArrayEntity value1, in ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.DescriptionArrayEntity.DescriptionArrayDescriptionArrayEntity value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A DescriptionArrayEntity instantiated from the given items.</returns>
        public static DescriptionArrayEntity FromItems(in ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.DescriptionArrayEntity.DescriptionArrayDescriptionArrayEntity value1, in ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.DescriptionArrayEntity.DescriptionArrayDescriptionArrayEntity value2, in ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.DescriptionArrayEntity.DescriptionArrayDescriptionArrayEntity value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static DescriptionArrayEntity FromItems(params ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.DescriptionArrayEntity.DescriptionArrayDescriptionArrayEntity[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.DescriptionArrayEntity.DescriptionArrayDescriptionArrayEntity item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static DescriptionArrayEntity FromRange(IEnumerable<ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.DescriptionArrayEntity.DescriptionArrayDescriptionArrayEntity> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.DescriptionArrayEntity.DescriptionArrayDescriptionArrayEntity item in value)
            {
        ...
        /// </remarks>
        public static DescriptionArrayEntity From<T>(IEnumerable<T> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            return new DescriptionArrayEntity(builder.ToImmutable());
        }
        ...
        /// <param name = "items">The items from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static DescriptionArrayEntity FromRange(IEnumerable<JsonAny> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// <param name = "items">The items from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static DescriptionArrayEntity FromRange<T>(IEnumerable<T> items)
        ...
        /// <inheritdoc/>
        IEnumerator<ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.DescriptionArrayEntity.DescriptionArrayDescriptionArrayEntity> IEnumerable<ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.DescriptionArrayEntity.DescriptionArrayDescriptionArrayEntity>.GetEnumerator()
        {
        ...
        /// <inheritdoc/>
        int IReadOnlyCollection<ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.DescriptionArrayEntity.DescriptionArrayDescriptionArrayEntity>.Count => this.GetArrayLength();
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.DescriptionArrayEntity.DescriptionArrayDescriptionArrayEntity> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.DescriptionArrayEntity.DescriptionArrayDescriptionArrayEntity>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.DescriptionArrayEntity.DescriptionArrayDescriptionArrayEntity>(this.arrayBacking);
            }
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator IJsonArray<DescriptionArrayEntity>.EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator<TItem> IJsonArray<DescriptionArrayEntity>.EnumerateArray<TItem>()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
