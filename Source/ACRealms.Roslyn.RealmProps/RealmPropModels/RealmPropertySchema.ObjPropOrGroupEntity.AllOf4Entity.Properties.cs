...
public readonly partial struct RealmPropertySchema
{
    public readonly partial struct ObjPropOrGroupEntity
    {
        ...
        public readonly partial struct AllOf4Entity
        {
            ...
            /// </summary>
            public static AllOf4Entity Create(ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.ValFloatEntity? @default = null, ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.ValFloatEntity? maxValue = null, ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.ValFloatEntity? minValue = null)
            {
            ...
            public AllOf4Entity WithDefault(in ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.ValFloatEntity value)
            {
            ...
            /// <param name = "value">The value to set.</param>
            /// <returns>The entity with the updated property.</returns>
            public AllOf4Entity WithMaxValue(in ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.ValFloatEntity value)
            {
            ...
            /// <param name = "value">The value to set.</param>
            /// <returns>The entity with the updated property.</returns>
            public AllOf4Entity WithMinValue(in ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.ValFloatEntity value)
            {
