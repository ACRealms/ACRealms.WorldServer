...
public readonly partial struct RealmPropertySchema
{
    public readonly partial struct ObjPropOrGroupEntity
    {
        ...
        /// </para>
        /// </remarks>
        public readonly partial struct DefaultEntity : IJsonBoolean<DefaultEntity>
        {
            /// <summary>
            /// Initializes a new instance of the <see cref = "DefaultEntity"/> struct.
            /// </summary>
            /// <param name = "value">The value from which to construct the instance.</param>
            public DefaultEntity(bool value)
            {
            ...
            public static implicit operator DefaultEntity(JsonBoolean value)
            {
            ...
            /// </summary>
            /// <param name = "value">The value from which to convert.</param>
            public static implicit operator DefaultEntity(bool value)
            {
                return new(value);
            }
            ...
            public static implicit operator bool (DefaultEntity value)
            {
