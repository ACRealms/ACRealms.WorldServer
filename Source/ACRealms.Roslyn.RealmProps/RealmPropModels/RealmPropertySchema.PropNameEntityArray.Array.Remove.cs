...
public readonly partial struct RealmPropertySchema
{
    ...
    public readonly partial struct PropNameEntityArray
    {
        ...
        PropNameEntityArray IJsonArray<PropNameEntityArray>.Remove(in JsonAny item1)
        {
        ...
        public PropNameEntityArray Remove(in ACRealms.RealmProps.IntermediateModels.RealmPropertySchema.PropNameEntity item)
        {
        ...
        /// <inheritdoc/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public PropNameEntityArray RemoveAt(int index)
        {
        ...
        /// <inheritdoc/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public PropNameEntityArray RemoveRange(int index, int count)
        {
